...
#if defined(OS_ANDROID) || (defined(__LB_SHELL__) && !(defined(__LB_ANDROID__) || defined(__LB_LINUX__)))
...
#endif // !defined(OS_ANDROID) && !(defined(__LB_SHELL__) && !(defined(__LB_ANDROID__) || defined(__LB_LINUX__)))

#if !(defined(__LB_SHELL__) && !(defined(__LB_ANDROID__) || defined(__LB_LINUX__)))
...
namespace base {
#if defined(__LB_ANDROID__) || defined(__LB_LINUX__)
