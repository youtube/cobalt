...
#include "third_party/chromium/media/capture/video/chromeos/stream_buffer_manager.h"
...
#include "third_party/chromium/media/capture/video/chromeos/request_builder.h"
