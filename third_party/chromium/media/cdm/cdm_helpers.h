...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CDM_CDM_HELPERS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CDM_CDM_HELPERS_H_
...
class MEDIA_EXPORT VideoFrameImpl : public cdm::VideoFrame,
 ...
 public:
  ...
  media_m96::VideoColorSpace MediaColorSpace() const;

  // Create a media_m96::VideoFrame based on the data contained in this object.
  ...
  // Postconditions:
  // - |frame_buffer_| will be NULL (now owned by returned media_m96::VideoFrame).
  virtual scoped_refptr<media_m96::VideoFrame> TransformToVideoFrame(
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CDM_CDM_HELPERS_H_
