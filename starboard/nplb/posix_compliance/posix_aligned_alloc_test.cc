...
TEST(PosixAlignedAllocTests,
  ...
  if (ptr) {
    static_cast<unsigned char*>(ptr)[0] = 0xAA;
    static_cast<unsigned char*>(ptr)[kValidSize - 1] = 0x55;
  }
  free(ptr);
}
