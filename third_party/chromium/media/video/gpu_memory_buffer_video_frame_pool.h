...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_GPU_MEMORY_BUFFER_VIDEO_FRAME_POOL_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_GPU_MEMORY_BUFFER_VIDEO_FRAME_POOL_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_GPU_MEMORY_BUFFER_VIDEO_FRAME_POOL_H_
