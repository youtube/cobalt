...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_RENDERER_MIXER_POOL_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_RENDERER_MIXER_POOL_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_RENDERER_MIXER_POOL_H_
