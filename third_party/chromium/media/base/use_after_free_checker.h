...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_USE_AFTER_FREE_CHECKER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_USE_AFTER_FREE_CHECKER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_USE_AFTER_FREE_CHECKER_H_
