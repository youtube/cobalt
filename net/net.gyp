  ...
  'targets': [
    {
      ...
      'dependencies': [
        ...
        # certificate_transparency directory was deleted in m70 release and its
        # content(the log_list.json file) not found anywhere else. Leaving
        # this old target in comments just in case this need shows up in the
        # future.
      ...
      'sources': [
        ...
        # Disabled due to dependency on base::NativesLibrary.
