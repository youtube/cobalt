...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_CHROMEOS_PLATFORM_VIDEO_FRAME_UTILS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_CHROMEOS_PLATFORM_VIDEO_FRAME_UTILS_H_
...
// Create GpuMemoryBuffer-based media_m96::VideoFrame with |buffer_usage|.
...
// Create platform dependent media_m96::VideoFrame with |buffer_usage|.
// See //media/base/video_frame.h for other parameters.
// If |gpu_memory_buffer_factory| is not null, it's used to allocate the
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_CHROMEOS_PLATFORM_VIDEO_FRAME_UTILS_H_
