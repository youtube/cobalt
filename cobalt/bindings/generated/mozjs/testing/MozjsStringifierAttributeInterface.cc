...
InterfaceData* CreateCachedInterfaceData() {
  ...
  instance_class->name = "MozjsStringifierAttributeInterface";
  ...
  prototype_class->name = "MozjsStringifierAttributeInterfacePrototype";
  ...
  interface_object_class->name = "MozjsStringifierAttributeInterfaceConstructor";
...
JSBool get_theStringifierAttribute(
  ...
  StringifierAttributeInterface* impl =
      WrapperPrivate::GetWrappable<StringifierAttributeInterface>(object);
...
void InitializePrototypeAndInterfaceObject(
  ...
  const char name[] = "StringifierAttributeInterface";
...
// static
JSObject* MozjsStringifierAttributeInterface::CreateInstance(
