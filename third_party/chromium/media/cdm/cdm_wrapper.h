...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CDM_CDM_WRAPPER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CDM_CDM_WRAPPER_H_
...
#include "third_party/chromium/media/cdm/supported_cdm_versions.h"
...
class CdmWrapper {
 public:
  ...
  virtual cdm::Status DecryptAndDecodeFrame(
      ...
      media_m96::VideoFrameImpl* video_frame) = 0;
...
class CdmWrapperImpl : public CdmWrapper {
 public:
  ...
  cdm::Status DecryptAndDecodeFrame(
      const cdm::InputBuffer_2& encrypted_buffer,
      media_m96::VideoFrameImpl* video_frame) override {
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CDM_CDM_WRAPPER_H_
