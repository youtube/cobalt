...
TEST(PosixGmtimeTests, HandlesEpochTime) {
  ...
  EXPECT_TRUE(result_tm_ptr->tm_zone &&
              (strcmp(result_tm_ptr->tm_zone, "UTC") == 0 ||
...
TEST(PosixGmtimeTests, ReturnsPointerToStaticBufferAndOverwrites) {
  ...
  EXPECT_TRUE(tm_ptr_call2->tm_zone &&
              (strcmp(tm_ptr_call2->tm_zone, "UTC") == 0 ||
  ...
  EXPECT_TRUE(tm_val_call1.tm_zone &&
              (strcmp(tm_val_call1.tm_zone, "UTC") == 0 ||
