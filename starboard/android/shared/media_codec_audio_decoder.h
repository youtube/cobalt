...
#ifndef STARBOARD_ANDROID_SHARED_MEDIA_CODEC_AUDIO_DECODER_H_
#define STARBOARD_ANDROID_SHARED_MEDIA_CODEC_AUDIO_DECODER_H_
...
#endif  // STARBOARD_ANDROID_SHARED_MEDIA_CODEC_AUDIO_DECODER_H_
