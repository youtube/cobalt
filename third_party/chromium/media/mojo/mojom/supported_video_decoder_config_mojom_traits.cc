...
#include "third_party/chromium/media/mojo/mojom/supported_video_decoder_config_mojom_traits.h"

namespace mojo {

// static
bool StructTraits<media_m96::mojom::SupportedVideoDecoderConfigDataView,
                  media_m96::SupportedVideoDecoderConfig>::
    Read(media_m96::mojom::SupportedVideoDecoderConfigDataView input,
