...
#include "third_party/chromium/media/filters/video_cadence_estimator.h"
...
void VideoCadenceEstimator::Reset() {
  ...
  bm_.use_bresenham_cadence_ =
      base::FeatureList::IsEnabled(media_m96::kBresenhamCadence);
...
/* List of tests that are expected to fail when media_m96::kBresenhamCadence
   is enabled.
