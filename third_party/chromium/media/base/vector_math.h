...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_VECTOR_MATH_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_VECTOR_MATH_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_VECTOR_MATH_H_
