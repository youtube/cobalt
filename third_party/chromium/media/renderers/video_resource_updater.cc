...
#include "third_party/chromium/media/renderers/video_resource_updater.h"
...
#include "third_party/chromium/media/video/half_float_maker.h"
...
VideoResourceUpdater::VideoResourceUpdater(
  ...
  base::trace_event::MemoryDumpManager::GetInstance()->RegisterDumpProvider(
      this, "media_m96::VideoResourceUpdater", base::ThreadTaskRunnerHandle::Get());
}
    ...
    if (!plane_resource->Matches(video_frame->unique_id(), 0)) {
      ...
      if (software_compositor()) {
        ...
        video_renderer_->Paint(video_frame, &canvas,
                               ...
                               media_m96::kNoTransformation, nullptr);
      } else {
        HardwarePlaneResource* hardware_resource = plane_resource->AsHardware();
