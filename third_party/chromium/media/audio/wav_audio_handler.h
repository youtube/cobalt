...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_WAV_AUDIO_HANDLER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_WAV_AUDIO_HANDLER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_WAV_AUDIO_HANDLER_H_
