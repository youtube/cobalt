...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_STREAM_PARSER_BUFFER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_STREAM_PARSER_BUFFER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_STREAM_PARSER_BUFFER_H_
