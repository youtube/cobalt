...
TabLinkDropHandler::TabLinkDropHandler(TabStripModel& tab_strip_model)
    : tab_strip_model_(tab_strip_model) {}

TabLinkDropHandler::~TabLinkDropHandler() = default;

std::optional<BrowserRootView::DropIndex>
TabLinkDropHandler::GetDropIndexForNode(
...
std::optional<BrowserRootView::DropIndex>
TabLinkDropHandler::GetDropIndexForGroup(
    const TabCollectionNode& node,
    std::optional<DragPositionHint> position_hint) const {
...
std::optional<BrowserRootView::DropIndex>
TabLinkDropHandler::GetDropIndexForSplit(
    const TabCollectionNode& node,
    std::optional<DragPositionHint> position_hint) const {
...
std::optional<BrowserRootView::DropIndex>
TabLinkDropHandler::GetDropIndexForPinned() const {
  return BrowserRootView::DropIndex{
...
std::optional<BrowserRootView::DropIndex>
TabLinkDropHandler::GetDropIndexForUnpinned() const {
  return BrowserRootView::DropIndex{
