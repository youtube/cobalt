...
// Adapted from http/http_auth_gssapi_posix.h

#ifndef NET_HTTP_HTTP_AUTH_GSSAPI_STARBOARD_H_
#define NET_HTTP_HTTP_AUTH_GSSAPI_STARBOARD_H_
...
#endif  // NET_HTTP_HTTP_AUTH_GSSAPI_STARBOARD_H_
