...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_FAKE_GPU_MEMORY_BUFFER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_FAKE_GPU_MEMORY_BUFFER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_FAKE_GPU_MEMORY_BUFFER_H_
