...
VideoDecoder::VideoDecoder(const VideoStreamInfo& video_stream_info,
    ...
    : video_codec_(video_stream_info.codec),
      ...
      reset_delay_usec_(reset_delay_usec),
      flush_delay_usec_(!IsVersionSDKGreaterOrEqual(34) ? flush_delay_usec : 0),
...
bool VideoDecoder::IsVersionSDKGreaterOrEqual(int sdk_version) {
  return MediaCodecBridge::IsVersionSDKGreaterOrEqual(sdk_version) == JNI_TRUE;
}
