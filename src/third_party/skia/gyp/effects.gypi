...

{
  'sources': [
    ...
    "<(skia_src_path)/effects/SkOverdrawColorFilter.h",
    ...
    "<(skia_src_path)/shaders/gradients/SkClampRange.cpp",
    "<(skia_src_path)/shaders/gradients/SkClampRange.h",
    "<(skia_src_path)/shaders/gradients/SkGradientBitmapCache.cpp",
    "<(skia_src_path)/shaders/gradients/SkGradientBitmapCache.h",
    ...
    "<(skia_src_path)/shaders/gradients/SkTwoPointConicalGradient_gpu.cpp",
    "<(skia_src_path)/shaders/gradients/SkTwoPointConicalGradient_gpu.h",
