...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_VAAPI_TEST_UTILS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_VAAPI_TEST_UTILS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_VAAPI_TEST_UTILS_H_
