...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CDM_CENC_UTILS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CDM_CENC_UTILS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CDM_CENC_UTILS_H_
