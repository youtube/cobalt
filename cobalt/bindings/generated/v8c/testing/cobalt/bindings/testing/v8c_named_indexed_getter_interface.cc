...
void InitializeTemplate(
  ...
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "indexedGetter"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "indexedSetter"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "namedGetter"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "namedSetter"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "operationOnBaseClass"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
