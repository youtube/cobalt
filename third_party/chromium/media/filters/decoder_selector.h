...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_DECODER_SELECTOR_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_DECODER_SELECTOR_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_DECODER_SELECTOR_H_
