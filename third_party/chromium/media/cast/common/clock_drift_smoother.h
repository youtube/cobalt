...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_COMMON_CLOCK_DRIFT_SMOOTHER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_COMMON_CLOCK_DRIFT_SMOOTHER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_COMMON_CLOCK_DRIFT_SMOOTHER_H_
