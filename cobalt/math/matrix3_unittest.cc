...
TEST(Matrix3fTest, Determinant) {
  ...
  matrix.set(0.57f, 0.205f, 0.942f, 0.314f, 0.845f, 0.826f, 0.131f, 0.025f,
             0.962f);
...
TEST(Matrix3fTest, Inverse) {
  ...
  regular.set(0.57f, 0.205f, 0.942f, 0.314f, 0.845f, 0.826f, 0.131f, 0.025f,
              0.962f);
  Matrix3F inv_regular = regular.Inverse();
  regular.set(2.51540616f, -0.55138018f, -1.98968043f, -0.61552266f,
...
TEST(Matrix3fTest, EigenvectorsPositiveDefinite) {
  ...
  expected_eigenvectors.set(0.04926317f, -0.92135662f, -0.38558414f,
                            0.82134249f, 0.25703273f, -0.50924521f, 0.56830419f,
