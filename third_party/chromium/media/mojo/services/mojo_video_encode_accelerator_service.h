...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_MOJO_SERVICES_MOJO_VIDEO_ENCODE_ACCELERATOR_SERVICE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_MOJO_SERVICES_MOJO_VIDEO_ENCODE_ACCELERATOR_SERVICE_H_
...
class MEDIA_MOJO_EXPORT MojoVideoEncodeAcceleratorService
 ...
 public:
  ...
  using CreateAndInitializeVideoEncodeAcceleratorCallback =
      base::OnceCallback<std::unique_ptr<::media_m96::VideoEncodeAccelerator>(
  ...
  void RequestEncodingParametersChangeWithBitrate(
      const media_m96::Bitrate& bitrate_allocation,
 ...
 private:
  ...
  void NotifyError(::media_m96::VideoEncodeAccelerator::Error error) override;
  void NotifyEncoderInfoChange(const ::media_m96::VideoEncoderInfo& info) override;
  ...
  std::unique_ptr<::media_m96::VideoEncodeAccelerator> encoder_;
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_MOJO_SERVICES_MOJO_VIDEO_ENCODE_ACCELERATOR_SERVICE_H_
