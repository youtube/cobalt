...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_MIME_UTIL_INTERNAL_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_MIME_UTIL_INTERNAL_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_MIME_UTIL_INTERNAL_H_
