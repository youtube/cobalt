...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_TEST_RECEIVER_FRAME_BUFFER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_TEST_RECEIVER_FRAME_BUFFER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_TEST_RECEIVER_FRAME_BUFFER_H_
