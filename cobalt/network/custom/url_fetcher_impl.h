...
#ifndef COBALT_NETWORK_CUSTOM_URL_FETCHER_IMPL_H_
#define COBALT_NETWORK_CUSTOM_URL_FETCHER_IMPL_H_
...
class NET_EXPORT_PRIVATE URLFetcherImpl : public URLFetcher {
 public:
  ...
  URLFetcherImpl(const GURL& url, RequestType request_type,
  ...
  void SetURLRequestUserData(
      const void* key, const CreateDataCallback& create_data_callback) override;
  ...
  Error GetStatus() const override;
...
#endif  // COBALT_NETWORK_CUSTOM_URL_FETCHER_IMPL_H_
