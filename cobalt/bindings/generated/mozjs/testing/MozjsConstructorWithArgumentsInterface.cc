...
InterfaceData* CreateCachedInterfaceData() {
  ...
  instance_class->name = "MozjsConstructorWithArgumentsInterface";
  ...
  prototype_class->name = "MozjsConstructorWithArgumentsInterfacePrototype";
  ...
  interface_object_class->name = "MozjsConstructorWithArgumentsInterfaceConstructor";
...
JSBool get_longArg(
  ...
  ConstructorWithArgumentsInterface* impl =
      WrapperPrivate::GetWrappable<ConstructorWithArgumentsInterface>(object);
...
void InitializePrototypeAndInterfaceObject(
  ...
  const char name[] = "ConstructorWithArgumentsInterface";
...
// static
JSObject* MozjsConstructorWithArgumentsInterface::CreateInstance(
