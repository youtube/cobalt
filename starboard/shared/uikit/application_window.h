...
#ifndef INTERNAL_STARBOARD_SHARED_UIKIT_APPLICATION_WINDOW_H_
#define INTERNAL_STARBOARD_SHARED_UIKIT_APPLICATION_WINDOW_H_
...
#endif  // INTERNAL_STARBOARD_SHARED_UIKIT_APPLICATION_WINDOW_H_
