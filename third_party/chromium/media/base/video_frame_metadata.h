...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_VIDEO_FRAME_METADATA_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_VIDEO_FRAME_METADATA_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_VIDEO_FRAME_METADATA_H_
