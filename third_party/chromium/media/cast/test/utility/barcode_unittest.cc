...
#include "third_party/chromium/media/cast/test/utility/barcode.h"
...
TEST(BarcodeTest, Small) {
  scoped_refptr<media_m96::VideoFrame> frame =
      media_m96::VideoFrame::CreateBlackFrame(gfx::Size(320, 10));
...
TEST(BarcodeTest, Large) {
  scoped_refptr<media_m96::VideoFrame> frame =
      media_m96::VideoFrame::CreateBlackFrame(gfx::Size(10000, 10));
