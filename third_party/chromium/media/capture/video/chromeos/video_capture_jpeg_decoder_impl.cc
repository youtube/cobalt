...
#include "third_party/chromium/media/capture/video/chromeos/video_capture_jpeg_decoder_impl.h"
...
void VideoCaptureJpegDecoderImpl::DecodeCapturedData(
  ...
  media_m96::BitstreamBuffer in_buffer(task_id_, in_shared_region_.Duplicate(),
                                   in_buffer_size);
  ...
  scoped_refptr<media_m96::VideoFrame> out_frame =
      media_m96::VideoFrame::WrapExternalData(
          media_m96::PIXEL_FORMAT_I420,                       // format
  ...
  media_m96::mojom::VideoFrameInfoPtr out_frame_info =
      media_m96::mojom::VideoFrameInfo::New();
  out_frame_info->timestamp = timestamp;
  out_frame_info->pixel_format = media_m96::PIXEL_FORMAT_I420;
