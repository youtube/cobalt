...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_VIDEO_CODECS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_VIDEO_CODECS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_VIDEO_CODECS_H_
