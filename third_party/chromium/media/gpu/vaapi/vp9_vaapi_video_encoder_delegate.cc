...
#include "third_party/chromium/media/gpu/vaapi/vp9_vaapi_video_encoder_delegate.h"
...
#include "third_party/chromium/media/gpu/vaapi/vp9_rate_control.h"
#include "third_party/chromium/media/gpu/vaapi/vp9_svc_layers.h"
