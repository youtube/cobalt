...
InterfaceData* CreateCachedInterfaceData() {
  ...
  instance_class->name = "MozjsBaseInterface";
  ...
  prototype_class->name = "MozjsBaseInterfacePrototype";
  ...
  interface_object_class->name = "MozjsBaseInterfaceConstructor";
...
JSBool get_baseAttribute(
  ...
  BaseInterface* impl =
      WrapperPrivate::GetWrappable<BaseInterface>(object);
...
void InitializePrototypeAndInterfaceObject(
  ...
  const char name[] = "BaseInterface";
  name_value.setString(JS_NewStringCopyZ(context, "BaseInterface"));
  success =
...
// static
JSObject* MozjsBaseInterface::CreateInstance(
