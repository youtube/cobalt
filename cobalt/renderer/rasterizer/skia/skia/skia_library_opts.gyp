  ...
  'targets': [
    ...
    },
    {
      ...
      'sources': [
        ...
        '<(DEPTH)/third_party/skia/src/opts/SkBlurImage_opts_none.cpp',
        '<(DEPTH)/third_party/skia/src/opts/SkMorphology_opts_none.cpp',
        '<(DEPTH)/third_party/skia/src/opts/SkTextureCompression_opts_none.cpp',
        '<(DEPTH)/third_party/skia/src/opts/SkUtils_opts_none.cpp',
        '<(DEPTH)/third_party/skia/src/opts/SkXfermode_opts_none.cpp',
      ],
    },
  ],
}
