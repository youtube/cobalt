...
#include "third_party/chromium/media/cdm/cdm_adapter.h"
...
#include "third_party/chromium/media/base/cdm_initialized_promise.h"
...
#include "third_party/chromium/media/base/key_systems.h"
...
#include "third_party/chromium/media/cdm/cdm_helpers.h"
#include "third_party/chromium/media/cdm/cdm_type_conversion.h"
#include "third_party/chromium/media/cdm/cdm_wrapper.h"
...
void CdmAdapter::Initialize(std::unique_ptr<media_m96::SimpleCdmPromise> promise) {
  DVLOG(1) << __func__;
...
void CdmAdapter::OnQueryOutputProtectionStatusDone(bool success,
  ...
  // The bit mask definition must be consistent between media_m96::OutputProtection
...
bool CdmAdapter::AudioFramesDataToAudioFrames(
  ...
  do {
    ...
    scoped_refptr<media_m96::AudioBuffer> frame = media_m96::AudioBuffer::CopyFrom(
