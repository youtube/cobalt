...
#include "third_party/chromium/media/gpu/vaapi/vp8_vaapi_video_encoder_delegate.h"
...
VaapiVideoEncodeAccelerator::GetAvailableVASurfaceAsRefCounted(
  ...
  VASurface::ReleaseCB release_cb = base::BindPostTaskToCurrentDefault(base::BindOnce(
