...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_MOCK_VIDEO_FRAME_RECEIVER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_MOCK_VIDEO_FRAME_RECEIVER_H_

#include "third_party/chromium/media/capture/video/video_frame_receiver.h"
 ...
 public:
  ...
  MOCK_METHOD3(
      ...
      void(int buffer_id,
           ...
           const gfx::Size&));
  MOCK_METHOD1(OnError, void(media_m96::VideoCaptureError error));
  MOCK_METHOD1(OnFrameDropped, void(media_m96::VideoCaptureFrameDropReason reason));
  ...
  void OnNewBuffer(int buffer_id,
                   media_m96::mojom::VideoBufferHandlePtr buffer_handle) override {
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_MOCK_VIDEO_FRAME_RECEIVER_H_
