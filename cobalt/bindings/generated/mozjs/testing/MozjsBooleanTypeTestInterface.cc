...
InterfaceData* CreateCachedInterfaceData() {
  ...
  instance_class->name = "MozjsBooleanTypeTestInterface";
  ...
  prototype_class->name = "MozjsBooleanTypeTestInterfacePrototype";
  ...
  interface_object_class->name = "MozjsBooleanTypeTestInterfaceConstructor";
...
JSBool get_booleanProperty(
  ...
  BooleanTypeTestInterface* impl =
      WrapperPrivate::GetWrappable<BooleanTypeTestInterface>(object);
...
void InitializePrototypeAndInterfaceObject(
  ...
  const char name[] = "BooleanTypeTestInterface";
  name_value.setString(JS_NewStringCopyZ(context, "BooleanTypeTestInterface"));
  success =
...
// static
JSObject* MozjsBooleanTypeTestInterface::CreateInstance(
