...
class MediaCodecBridge {
  ...
  private static class ColorInfo {
    ...
    ColorInfo(
      ...
      final int finalMaxCll = maxCll > 0 ? maxCll : DEFAULT_MAX_CLL;
      final int finalMaxFall = maxFall > 0 ? maxFall : DEFAULT_MAX_FALL;
      ...
      hdrStaticInfo.putShort((short) finalMaxCll);
      hdrStaticInfo.putShort((short) finalMaxFall);
