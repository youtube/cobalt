...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_IPC_SERVICE_MEDIA_GPU_CHANNEL_MANAGER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_IPC_SERVICE_MEDIA_GPU_CHANNEL_MANAGER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_IPC_SERVICE_MEDIA_GPU_CHANNEL_MANAGER_H_
