...
#ifndef INTERNAL_STARBOARD_SHARED_UIKIT_PLAYER_MANAGER_H_
#define INTERNAL_STARBOARD_SHARED_UIKIT_PLAYER_MANAGER_H_
...
#endif  // INTERNAL_STARBOARD_SHARED_UIKIT_PLAYER_MANAGER_H_
