...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_COMMON_FEATURE_DICTIONARY_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_COMMON_FEATURE_DICTIONARY_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_COMMON_FEATURE_DICTIONARY_H_
