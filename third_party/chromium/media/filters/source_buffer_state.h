...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_SOURCE_BUFFER_STATE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_SOURCE_BUFFER_STATE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_SOURCE_BUFFER_STATE_H_
