...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_MOCK_GPU_VIDEO_ACCELERATOR_FACTORIES_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_MOCK_GPU_VIDEO_ACCELERATOR_FACTORIES_H_
...
class MockGpuVideoAcceleratorFactories : public GpuVideoAcceleratorFactories {
 public:
  ...
  MOCK_METHOD2(CreateVideoDecoder,
               std::unique_ptr<media_m96::VideoDecoder>(MediaLog*,
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_MOCK_GPU_VIDEO_ACCELERATOR_FACTORIES_H_
