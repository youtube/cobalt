...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_CONTAINER_NAMES_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_CONTAINER_NAMES_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_CONTAINER_NAMES_H_
