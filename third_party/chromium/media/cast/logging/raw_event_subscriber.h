...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_LOGGING_RAW_EVENT_SUBSCRIBER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_LOGGING_RAW_EVENT_SUBSCRIBER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_LOGGING_RAW_EVENT_SUBSCRIBER_H_
