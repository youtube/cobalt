...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_MOJO_CLIENTS_MOJO_DECRYPTOR_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_MOJO_CLIENTS_MOJO_DECRYPTOR_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_MOJO_CLIENTS_MOJO_DECRYPTOR_H_
