...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_WINDOWS_DXVA_PICTURE_BUFFER_WIN_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_WINDOWS_DXVA_PICTURE_BUFFER_WIN_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_WINDOWS_DXVA_PICTURE_BUFFER_WIN_H_
