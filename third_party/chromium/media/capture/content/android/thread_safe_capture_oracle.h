...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_CONTENT_ANDROID_THREAD_SAFE_CAPTURE_ORACLE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_CONTENT_ANDROID_THREAD_SAFE_CAPTURE_ORACLE_H_
...
#include "third_party/chromium/media/capture/content/video_capture_oracle.h"
...
class CAPTURE_EXPORT ThreadSafeCaptureOracle
 ...
 public:
  ...
  void ReportError(media_m96::VideoCaptureError error,
 ...
 private:
  ...
  void DidConsumeFrame(int frame_number,
                       const media_m96::VideoFrameMetadata* metadata);
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_CONTENT_ANDROID_THREAD_SAFE_CAPTURE_ORACLE_H_
