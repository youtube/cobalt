...
class DrmSessionIdMapper {
 public:
  ...
  // Gets the CDM session ID corresponding to the given |media_drm_session_id|.
  ...
  // Gets the MediaDrm session ID corresponding to the given |cdm_session_id|.
  ...
  // 2. If no mapping is found, it returns the input |cdm_session_id| itself.
