  ...
  'targets': [
    ...
    },
    {
      ...
      'dependencies': [
        ...
        '<(DEPTH)/build/tizen/system.gyp:capi-appfw-application',
        '<(DEPTH)/build/tizen/system.gyp:capi-media-audio-io',
        '<(DEPTH)/build/tizen/system.gyp:edbus',
        '<(DEPTH)/build/tizen/system.gyp:elementary',
        '<(DEPTH)/build/tizen/system.gyp:evas',
        '<(DEPTH)/build/tizen/system.gyp:gles20',
        '<(DEPTH)/build/tizen/system.gyp:tizen-extension-client',
        '<(DEPTH)/build/tizen/system.gyp:wayland-egl',
