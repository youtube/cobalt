...
InterfaceData* CreateCachedInterfaceData() {
  ...
  instance_class->name = "MozjsNestedPutForwardsInterface";
  ...
  prototype_class->name = "MozjsNestedPutForwardsInterfacePrototype";
  ...
  interface_object_class->name = "MozjsNestedPutForwardsInterfaceConstructor";
