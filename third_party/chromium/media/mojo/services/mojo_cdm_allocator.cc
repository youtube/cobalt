...
#include "third_party/chromium/media/mojo/services/mojo_cdm_allocator.h"
...
class MojoCdmVideoFrame final : public VideoFrameImpl {
 public:
  ...
  scoped_refptr<media_m96::VideoFrame> TransformToVideoFrame(
    ...
    scoped_refptr<MojoSharedBufferVideoFrame> frame =
        media_m96::MojoSharedBufferVideoFrame::Create(
