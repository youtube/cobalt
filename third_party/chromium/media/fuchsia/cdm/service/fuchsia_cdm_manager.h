...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_CDM_SERVICE_FUCHSIA_CDM_MANAGER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_CDM_SERVICE_FUCHSIA_CDM_MANAGER_H_
...
class FuchsiaCdmManager {
 public:
  using CreateKeySystemCallback = base::RepeatingCallback<
      fidl::InterfaceHandle<fuchsia::media_m96::drm::KeySystem>()>;
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_CDM_SERVICE_FUCHSIA_CDM_MANAGER_H_
