...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_CHROMEOS_FOURCC_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_CHROMEOS_FOURCC_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_CHROMEOS_FOURCC_H_
