...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_CODEC_BUFFER_WAIT_COORDINATOR_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_CODEC_BUFFER_WAIT_COORDINATOR_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_CODEC_BUFFER_WAIT_COORDINATOR_H_
