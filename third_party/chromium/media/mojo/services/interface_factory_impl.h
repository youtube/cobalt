...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_MOJO_SERVICES_INTERFACE_FACTORY_IMPL_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_MOJO_SERVICES_INTERFACE_FACTORY_IMPL_H_
...
#include "third_party/chromium/media/mojo/buildflags.h"
#include "third_party/chromium/media/mojo/mojom/audio_decoder.mojom.h"
#include "third_party/chromium/media/mojo/mojom/content_decryption_module.mojom.h"
#include "third_party/chromium/media/mojo/mojom/decryptor.mojom.h"
#include "third_party/chromium/media/mojo/mojom/frame_interface_factory.mojom.h"
#include "third_party/chromium/media/mojo/mojom/interface_factory.mojom.h"
#include "third_party/chromium/media/mojo/mojom/media_log.mojom.h"
#include "third_party/chromium/media/mojo/mojom/renderer.mojom.h"
#include "third_party/chromium/media/mojo/mojom/video_decoder.mojom.h"
#include "third_party/chromium/media/mojo/services/deferred_destroy_unique_receiver_set.h"
#include "third_party/chromium/media/mojo/services/mojo_cdm_service_context.h"
...
class InterfaceFactoryImpl final
 ...
 private:
  ...
  void AddRenderer(std::unique_ptr<media_m96::Renderer> renderer,
                   mojo::PendingReceiver<mojom::Renderer> receiver);
#endif
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_MOJO_SERVICES_INTERFACE_FACTORY_IMPL_H_
