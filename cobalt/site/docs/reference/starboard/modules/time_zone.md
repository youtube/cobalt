...
follow the `AREA/LOCATION` AREA/LOCATION format, where `AREA` AREA is a
continent or ocean, and `LOCATION` LOCATION is a specific location within that
area (for example, 'Africa/Cairo', 'America/New_York', or 'Pacific/Honolulu').
