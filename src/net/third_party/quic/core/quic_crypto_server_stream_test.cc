...
// Cobalt does not support TLSHandshaker and it is disabled right now.
// TLSHanshaker is enabled by FLAGS_quic_supports_tls_handshake.
// m74 TLSHandshaker depends on updated boringSSL(compared to m70) which has
// standard QUIC APIs.
