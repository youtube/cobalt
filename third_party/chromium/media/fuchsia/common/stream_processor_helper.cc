...
StreamProcessorHelper::StreamProcessorHelper(
    fuchsia::media_m96::StreamProcessorPtr processor,
    Client* client)
...
void StreamProcessorHelper::Process(IoPacket input) {
  ...
  fuchsia::media_m96::Packet packet;
...
void StreamProcessorHelper::OnStreamFailed(uint64_t stream_lifetime_ordinal,
                                           fuchsia::media_m96::StreamError error) {
  DCHECK_CALLED_ON_VALID_THREAD(thread_checker_);
  ...
  if (error == fuchsia::media_m96::StreamError::DECRYPTOR_NO_KEY) {
...
void StreamProcessorHelper::OnFreeInputPacket(
    fuchsia::media_m96::PacketHeader free_input_packet) {
  DCHECK_CALLED_ON_VALID_THREAD(thread_checker_);
...
void StreamProcessorHelper::OnOutputConstraints(
    fuchsia::media_m96::StreamOutputConstraints output_constraints) {
  DCHECK_CALLED_ON_VALID_THREAD(thread_checker_);
...
void StreamProcessorHelper::OnOutputPacket(fuchsia::media_m96::Packet output_packet,
...
void StreamProcessorHelper::SetInputBufferCollectionToken(
  ...
  fuchsia::media_m96::StreamBufferPartialSettings settings;
...
void StreamProcessorHelper::OnRecycleOutputBuffer(
  ...
  fuchsia::media_m96::PacketHeader header;
