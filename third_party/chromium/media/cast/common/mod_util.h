...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_COMMON_MOD_UTIL_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_COMMON_MOD_UTIL_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_COMMON_MOD_UTIL_H_
