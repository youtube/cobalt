...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_CONGESTION_CONTROL_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_CONGESTION_CONTROL_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_CONGESTION_CONTROL_H_
