...
InterfaceData* CreateCachedInterfaceData() {
  ...
  instance_class->name = "MozjsNoInterfaceObjectInterface";
  ...
  prototype_class->name = "MozjsNoInterfaceObjectInterfacePrototype";
  ...
  interface_object_class->name = "MozjsNoInterfaceObjectInterfaceConstructor";
...
// static
JSObject* MozjsNoInterfaceObjectInterface::CreateInstance(
