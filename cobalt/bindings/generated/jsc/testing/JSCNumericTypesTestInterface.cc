...
JSC::HashTable JSCNumericTypesTestInterface::InterfaceObject::property_table = {
...
};  // JSCNumericTypesTestInterface::InterfaceObject::property_table
...
JSC::HashTable JSCNumericTypesTestInterface::Prototype::property_table = {
    80,  // compactSize
    63,  // compactSizeMask
    property_table_values,
    NULL  // table allocated at runtime
};  // JSCNumericTypesTestInterface::Prototype::property_table
...
JSC::HashTable JSCNumericTypesTestInterface::property_table = {
    39,  // compactSize
    31,  // compactSizeMask
    property_table_values,
    NULL  // table allocated at runtime
};  // JSCNumericTypesTestInterface::property_table
...
JSC::EncodedJSValue functionJSbyteReturnOperation(
  ...
  int8_t return_value = impl->ByteReturnOperation();
...
JSC::EncodedJSValue functionJSdoubleReturnOperation(
  ...
  double return_value = impl->DoubleReturnOperation();
  return JSC::JSValue::encode(ToJSValue(global_object, return_value));
...
JSC::EncodedJSValue functionJSlongReturnOperation(
  ...
  int32_t return_value = impl->LongReturnOperation();
  return JSC::JSValue::encode(ToJSValue(global_object, return_value));
...
JSC::EncodedJSValue functionJSoctetReturnOperation(
  ...
  uint8_t return_value = impl->OctetReturnOperation();
  return JSC::JSValue::encode(ToJSValue(global_object, return_value));
...
JSC::EncodedJSValue functionJSshortReturnOperation(
  ...
  int16_t return_value = impl->ShortReturnOperation();
  return JSC::JSValue::encode(ToJSValue(global_object, return_value));
...
JSC::EncodedJSValue functionJSunrestrictedDoubleReturnOperation(
  ...
  double return_value = impl->UnrestrictedDoubleReturnOperation();
  return JSC::JSValue::encode(ToJSValue(global_object, return_value));
...
JSC::EncodedJSValue functionJSunsignedLongReturnOperation(
  ...
  uint32_t return_value = impl->UnsignedLongReturnOperation();
  return JSC::JSValue::encode(ToJSValue(global_object, return_value));
...
JSC::EncodedJSValue functionJSunsignedShortReturnOperation(
  ...
  uint16_t return_value = impl->UnsignedShortReturnOperation();
  return JSC::JSValue::encode(ToJSValue(global_object, return_value));
