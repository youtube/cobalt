...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_KEY_SYSTEM_NAMES_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_KEY_SYSTEM_NAMES_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_KEY_SYSTEM_NAMES_H_
