...
def main():
  ...
  subparsers = parser.add_subparsers(dest="action", help='On-Device tests commands', required=True)
  trigger_parser = subparsers.add_parser('trigger', help='Trigger On-Device tests')
