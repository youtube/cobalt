...
public final class CommandLineOverrideHelper {
  ...
  public static List<String> getDefaultCommandLineOverridesList() {
    ...
    paramOverrides.add("--enable-webgl-draft-extensions");
    // paramOverrides.add("--enable-features=WebGLDraftExtensions,WEBGL_webcodecs_video_frame");
  ...
  public static StringJoiner getDefaultEnableFeatureOverridesList() {
    ...
    // Enable AImageReader for hardware-backed frames.
  ...
  public static StringJoiner getDefaultBlinkEnableFeatureOverridesList() {
    ...
    // Enable WebCodecs for VideoDecoder.
    paramOverrides.add("WebCodecs");
