...
void InitializeTemplate(
  ...
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "longFunctionNoArgs"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "objectFunctionNoArgs"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "optionalArgumentWithDefault"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "optionalArguments"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "optionalNullableArgumentsWithDefaults"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "overloadedFunction"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "overloadedNullable"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "stringFunctionNoArgs"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "variadicPrimitiveArguments"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "variadicStringArgumentsAfterOptionalArgument"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "voidFunctionLongArg"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "voidFunctionNoArgs"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "voidFunctionObjectArg"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "voidFunctionStringArg"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
