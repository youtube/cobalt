...
class CobaltA11yHelper extends ExploreByTouchHelper {
    ...
    switch (currentFocusedViewId) {
      ...
      case UP_VIEW_ID:
        cobaltActivity.onKeyDown(
            KeyEvent.KEYCODE_DPAD_UP, new KeyEvent(KeyEvent.KEYCODE_DPAD_UP, KeyEvent.ACTION_DOWN));
        cobaltActivity.onKeyUp(
            KeyEvent.KEYCODE_DPAD_UP, new KeyEvent(KeyEvent.KEYCODE_DPAD_UP, KeyEvent.ACTION_UP));
        break;
      case LEFT_VIEW_ID:
        cobaltActivity.onKeyDown(
            KeyEvent.KEYCODE_DPAD_LEFT,
            new KeyEvent(KeyEvent.KEYCODE_DPAD_LEFT, KeyEvent.ACTION_DOWN));
        cobaltActivity.onKeyUp(
            KeyEvent.KEYCODE_DPAD_LEFT,
            new KeyEvent(KeyEvent.KEYCODE_DPAD_LEFT, KeyEvent.ACTION_UP));
        break;
      case RIGHT_VIEW_ID:
        cobaltActivity.onKeyDown(
            KeyEvent.KEYCODE_DPAD_RIGHT,
            new KeyEvent(KeyEvent.KEYCODE_DPAD_RIGHT, KeyEvent.ACTION_DOWN));
        cobaltActivity.onKeyUp(
            KeyEvent.KEYCODE_DPAD_RIGHT,
            new KeyEvent(KeyEvent.KEYCODE_DPAD_RIGHT, KeyEvent.ACTION_UP));
        break;
      case DOWN_VIEW_ID:
        cobaltActivity.onKeyDown(
            KeyEvent.KEYCODE_DPAD_DOWN,
            new KeyEvent(KeyEvent.KEYCODE_DPAD_DOWN, KeyEvent.ACTION_DOWN));
        cobaltActivity.onKeyUp(
            KeyEvent.KEYCODE_DPAD_DOWN,
            new KeyEvent(KeyEvent.KEYCODE_DPAD_DOWN, KeyEvent.ACTION_UP));
        break;
      default:
  ...
  /**
   * When the accessibility service is active, it can prevent the application from gaining focus
   * directly. This code is our best-effort attempt to return focus to the browser's web view.
   */
