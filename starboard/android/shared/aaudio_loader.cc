...
#define RESOLVE_SYMBOL(c_name, static_name)                            \
  ...
  RESOLVE_SYMBOL(AAudioStreamBuilder_setFramesPerDataCallback,
                 StreamBuilder_SetFramesPerDataCallback);
...
void (*AAudio::StreamBuilder_SetErrorCallback)(AAudioStreamBuilder*,
                                               ...
                                               void*) = nullptr;
void (*AAudio::StreamBuilder_SetFramesPerDataCallback)(AAudioStreamBuilder*,
                                                       int32_t) = nullptr;
