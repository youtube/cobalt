...
#include "third_party/chromium/media/audio/audio_manager.h"
...
#include "third_party/chromium/media/audio/audio_device_info_accessor_for_tests.h"
#include "third_party/chromium/media/audio/audio_device_name.h"
#include "third_party/chromium/media/audio/audio_output_proxy.h"
#include "third_party/chromium/media/audio/audio_unittest_util.h"
#include "third_party/chromium/media/audio/fake_audio_log_factory.h"
#include "third_party/chromium/media/audio/fake_audio_manager.h"
...
#if defined(USE_ALSA)
#include "third_party/chromium/media/audio/alsa/audio_manager_alsa.h"
#endif  // defined(USE_ALSA)

#if defined(OS_MAC)
#include "third_party/chromium/media/audio/mac/audio_manager_mac.h"
#include "third_party/chromium/media/base/mac/audio_latency_mac.h"
#endif

#if defined(OS_WIN)
#include "base/win/scoped_com_initializer.h"
#include "third_party/chromium/media/audio/win/audio_manager_win.h"
#endif

#if defined(USE_PULSEAUDIO)
#include "third_party/chromium/media/audio/pulse/audio_manager_pulse.h"
#include "third_party/chromium/media/audio/pulse/pulse_util.h"
...
#include "third_party/chromium/media/audio/cras/audio_manager_chromeos.h"
#elif defined(USE_CRAS) && (defined(OS_LINUX) || BUILDFLAG(IS_CHROMEOS_LACROS))
#include "third_party/chromium/media/audio/cras/audio_manager_cras.h"
#endif
...
class AudioManagerTest : public ::testing::Test {
 public:
  ...
  void GetDefaultOutputStreamParameters(media_m96::AudioParameters* params) {
...
TEST_F(AudioManagerTest, CheckMinMaxAudioBufferSizeCallbacks) {
  ...
  ASSERT_LT(default_params.frames_per_buffer(),
            media_m96::limits::kMaxAudioBufferSize);
  ...
  ASSERT_GT(default_params.frames_per_buffer(),
            GetMinAudioBufferSizeMacOS(media_m96::limits::kMinAudioBufferSize,
  ...
  ASSERT_GE(default_params.frames_per_buffer(),
            media_m96::limits::kMinAudioBufferSize);
#else
  NOTREACHED();
#endif
  ...
  min_params.set_frames_per_buffer(media_m96::limits::kMinAudioBufferSize);
  ...
  max_params.set_frames_per_buffer(media_m96::limits::kMaxAudioBufferSize);
