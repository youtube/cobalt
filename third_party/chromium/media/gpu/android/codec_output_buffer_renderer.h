...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_CODEC_OUTPUT_BUFFER_RENDERER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_CODEC_OUTPUT_BUFFER_RENDERER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_CODEC_OUTPUT_BUFFER_RENDERER_H_
