...
JSC::HashTable JSCBooleanTypeTestInterface::InterfaceObject::property_table = {
...
};  // JSCBooleanTypeTestInterface::InterfaceObject::property_table
...
JSC::HashTable JSCBooleanTypeTestInterface::Prototype::property_table = {
    10,  // compactSize
    7,  // compactSizeMask
    property_table_values,
    NULL  // table allocated at runtime
};  // JSCBooleanTypeTestInterface::Prototype::property_table
...
JSC::HashTable JSCBooleanTypeTestInterface::property_table = {
    4,  // compactSize
    3,  // compactSizeMask
    property_table_values,
    NULL  // table allocated at runtime
};  // JSCBooleanTypeTestInterface::property_table
...
JSC::EncodedJSValue functionJSbooleanReturnOperation(
  ...
  bool return_value = impl->BooleanReturnOperation();
