...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_REMOTING_COURIER_RENDERER_FACTORY_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_REMOTING_COURIER_RENDERER_FACTORY_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_REMOTING_COURIER_RENDERER_FACTORY_H_
