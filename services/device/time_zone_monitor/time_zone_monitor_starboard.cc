...
class TimeZoneMonitorStarboard : public TimeZoneMonitor {
 public:
  ...
  void OnTimeZoneChanged() {
    ...
    // Update TZ environment variable and call tzset() as suggested by review
    // comments. Overwriting TZ is necessary because it is set at app startup
    // and Cobalt's internal TimeZoneState will ignore system changes if TZ is
    // set to an old value.
 ...
 private:
  ...
  base::WeakPtr<TimeZoneMonitorStarboard> weak_ptr_;
