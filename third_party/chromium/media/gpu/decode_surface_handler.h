...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_DECODE_SURFACE_HANDLER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_DECODE_SURFACE_HANDLER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_DECODE_SURFACE_HANDLER_H_
