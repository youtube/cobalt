...
// Does not control whether Cobalt downloads and installs uncompressed updates
// but does allow the corresponding Cobalt switch with the same name, which does
