...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_FRAME_INFO_HELPER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_FRAME_INFO_HELPER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_FRAME_INFO_HELPER_H_
