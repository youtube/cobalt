...
#include "third_party/chromium/media/audio/audio_output_device_thread_callback.h"
...
AudioOutputDeviceThreadCallback::AudioOutputDeviceThreadCallback(
    ...
    : media_m96::AudioDeviceThread::Callback(
          audio_parameters,
...
void AudioOutputDeviceThreadCallback::MapSharedMemory() {
  ...
  media_m96::AudioOutputBuffer* buffer =
      reinterpret_cast<media_m96::AudioOutputBuffer*>(
          shared_memory_mapping_.memory());
  output_bus_ = media_m96::AudioBus::WrapMemory(audio_parameters_, buffer->audio);
