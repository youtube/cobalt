...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_DEFAULT_DECODER_FACTORY_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_DEFAULT_DECODER_FACTORY_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_DEFAULT_DECODER_FACTORY_H_
