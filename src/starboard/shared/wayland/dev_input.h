...
static void keyboard_handle_leave(void* data,
  ...
  ApplicationWayland* wayland_window_ = (ApplicationWayland*)data;
...
static void registry_add_object(void* data,
  ...
  if (strcmp(interface, "wl_compositor") == 0) {
    wayland_window_->SetCompositor((wl_compositor*)wl_registry_bind(
        registry, name, &wl_compositor_interface, 1));
  } else if (strcmp(interface, "wl_shell") == 0) {
    wayland_window_->SetShell(
        (wl_shell*)wl_registry_bind(registry, name, &wl_shell_interface, 1));
  } else if (strcmp(interface, "wl_seat") == 0) {
    wayland_window_->SetSeat(
    ...
    wayland_window_->SetPolicy((tizen_policy*)wl_registry_bind(
        registry, name, &tizen_policy_interface, 1));
  }
}
...
static void shell_surface_ping(void*,
...
static void window_cb_visibility_change(
    void* data,
    struct tizen_visibility* tizen_visibility EINA_UNUSED,
    uint32_t visibility) {
