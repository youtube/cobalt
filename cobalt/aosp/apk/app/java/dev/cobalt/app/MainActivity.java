...
public class MainActivity extends BaseCobaltActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (coldStart) {
      ...
      BaseStarboardBridge starboardBridge =
          createStarboardBridge(getArgsWithDeepLink(getArgs(), startDeepLink), startDeepLink);
   ...
   * non-empty, so Application::Run() can thread it to DeepLinkManager on startup. AOSP can't call
   * DeepLinkManager directly here (b/492704919), so this is the cold-start path instead.
   */
