...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_ENCRYPTION_SCHEME_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_ENCRYPTION_SCHEME_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_ENCRYPTION_SCHEME_H_
