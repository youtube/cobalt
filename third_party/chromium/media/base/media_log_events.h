...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_LOG_EVENTS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_LOG_EVENTS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_LOG_EVENTS_H_
