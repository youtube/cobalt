...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_SHARED_IMAGE_VIDEO_PROVIDER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_SHARED_IMAGE_VIDEO_PROVIDER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_SHARED_IMAGE_VIDEO_PROVIDER_H_
