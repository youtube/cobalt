...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_NET_CAST_TRANSPORT_DEFINES_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_NET_CAST_TRANSPORT_DEFINES_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_NET_CAST_TRANSPORT_DEFINES_H_
