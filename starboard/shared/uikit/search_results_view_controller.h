...
#ifndef INTERNAL_STARBOARD_SHARED_UIKIT_SEARCH_RESULTS_VIEW_CONTROLLER_H_
#define INTERNAL_STARBOARD_SHARED_UIKIT_SEARCH_RESULTS_VIEW_CONTROLLER_H_
...
#endif  // INTERNAL_STARBOARD_SHARED_UIKIT_SEARCH_RESULTS_VIEW_CONTROLLER_H_
