...
#ifndef STARBOARD_ANDROID_SHARED_MEDIA_CAPABILITIES_CACHE_SINGLETON_H_
#define STARBOARD_ANDROID_SHARED_MEDIA_CAPABILITIES_CACHE_SINGLETON_H_
...
class MediaCapabilitiesCacheSingleton : public MediaCapabilitiesCache {
 public:
  static MediaCapabilitiesCacheSingleton* GetInstance();
 ...
 private:
  MediaCapabilitiesCacheSingleton();
  ~MediaCapabilitiesCacheSingleton() {}

  MediaCapabilitiesCacheSingleton(const MediaCapabilitiesCacheSingleton&) =
      delete;
  MediaCapabilitiesCacheSingleton& operator=(
      const MediaCapabilitiesCacheSingleton&) = delete;
...
#endif  // STARBOARD_ANDROID_SHARED_MEDIA_CAPABILITIES_CACHE_SINGLETON_H_
