...
#ifndef CHROMEOS_ASH_COMPONENTS_MOJO_PROXY_MOJO_CORE_PUBLIC_CPP_SYSTEM_HANDLE_SIGNALS_STATE_H_
#define CHROMEOS_ASH_COMPONENTS_MOJO_PROXY_MOJO_CORE_PUBLIC_CPP_SYSTEM_HANDLE_SIGNALS_STATE_H_
...
struct MOJO_LEGACY_CPP_SYSTEM_EXPORT HandleSignalsState final
    : public MojoHandleSignalsState {
  HandleSignalsState() {
    satisfied_signals = MOJO_LEGACY_HANDLE_SIGNAL_NONE;
    satisfiable_signals = MOJO_LEGACY_HANDLE_SIGNAL_NONE;
  }
  ...
  bool never_peer_closed() const {
    return !can_satisfy_any(MOJO_LEGACY_HANDLE_SIGNAL_PEER_CLOSED);
  }

  // THe handle will never indicate |peer_remote()| again. True iff the peer is
  // known to be closed.
  bool never_peer_remote() const {
    return !can_satisfy_any(MOJO_LEGACY_HANDLE_SIGNAL_PEER_REMOTE);
  }
...
#endif  // CHROMEOS_ASH_COMPONENTS_MOJO_PROXY_MOJO_CORE_PUBLIC_CPP_SYSTEM_HANDLE_SIGNALS_STATE_H_
