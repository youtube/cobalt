...
#include "third_party/chromium/media/capabilities/video_decode_stats.pb.h"
#include "third_party/chromium/media/capabilities/video_decode_stats_db_impl.h"
...
TEST_F(VideoDecodeStatsDBImplTest, ConfigureMaxFramesPerBuffer) {
  ...
  scoped_feature_list.InitAndEnableFeatureWithParameters(
      media_m96::kMediaCapabilitiesWithParameters, params);
