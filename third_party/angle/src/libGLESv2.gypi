...

{
    'variables':
    {
        ...
        [
            ...
            '<(DEPTH)/third_party/angle/src/common/third_party/numerics/base_copy/logging.h',
            '<(DEPTH)/third_party/angle/src/common/third_party/numerics/base_copy/numerics/safe_conversions.h',
            '<(DEPTH)/third_party/angle/src/common/third_party/numerics/base_copy/numerics/safe_conversions_impl.h',
            '<(DEPTH)/third_party/angle/src/common/third_party/numerics/base_copy/numerics/safe_math.h',
            '<(DEPTH)/third_party/angle/src/common/third_party/numerics/base_copy/numerics/safe_math_impl.h',
