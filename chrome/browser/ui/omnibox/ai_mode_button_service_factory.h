...
#ifndef CHROME_BROWSER_UI_OMNIBOX_AI_MODE_BUTTON_SERVICE_FACTORY_H_
#define CHROME_BROWSER_UI_OMNIBOX_AI_MODE_BUTTON_SERVICE_FACTORY_H_
...
#endif  // CHROME_BROWSER_UI_OMNIBOX_AI_MODE_BUTTON_SERVICE_FACTORY_H_
