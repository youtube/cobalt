...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_ANDROID_OVERLAY_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_ANDROID_OVERLAY_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_ANDROID_OVERLAY_H_
