...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_TEST_VIDEO_ENCODER_VIDEO_ENCODER_CLIENT_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_TEST_VIDEO_ENCODER_VIDEO_ENCODER_CLIENT_H_
...
struct VideoEncoderClientConfig {
  ...
  VideoEncoderClientConfig(
      ...
      const std::vector<VideoEncodeAccelerator::Config::SpatialLayer>&
          spatial_layers,
      const media_m96::VideoBitrateAllocation& bitrate,
      bool reverse);
  ...
  media_m96::VideoBitrateAllocation bitrate;
...
class VideoEncoderClient : public VideoEncodeAccelerator::Client {
 ...
 private:
  ...
  std::unique_ptr<media_m96::test::AlignedDataHelper> aligned_data_helper_;
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_TEST_VIDEO_ENCODER_VIDEO_ENCODER_CLIENT_H_
