...
#include "third_party/chromium/media/base/scoped_async_trace.h"
...
MediaCodecVideoDecoder::MediaCodecVideoDecoder(
    ...
    : gpu::RefCountedLockHelperDrDc(std::move(drdc_lock)),
      ...
      surface_chooser_helper_(
          ...
          base::FeatureList::IsEnabled(media_m96::kUseAndroidOverlayForSecureOnly),
      ...
      allow_nonsecure_overlays_(
          base::FeatureList::IsEnabled(media_m96::kAllowNonSecureOverlays)) {
  DVLOG(2) << __func__;
