...
#include "third_party/chromium/media/device_monitors/device_monitor_mac.h"
...
class DeviceMonitorMacImpl {
 public:
  explicit DeviceMonitorMacImpl(media_m96::DeviceMonitorMac* monitor)
      : monitor_(monitor),
        cached_devices_(),
        device_arrival_(nil),
        device_removal_(nil) {
 ...
 protected:
  media_m96::DeviceMonitorMac* monitor_;
...
class AVFoundationMonitorImpl : public DeviceMonitorMacImpl {
 public:
  AVFoundationMonitorImpl(
      media_m96::DeviceMonitorMac* monitor,
