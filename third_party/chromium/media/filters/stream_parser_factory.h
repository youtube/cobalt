...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_STREAM_PARSER_FACTORY_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_STREAM_PARSER_FACTORY_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_STREAM_PARSER_FACTORY_H_
