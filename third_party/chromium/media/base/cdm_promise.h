...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_CDM_PROMISE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_CDM_PROMISE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_CDM_PROMISE_H_
