...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_STATUS_CODES_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_STATUS_CODES_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_STATUS_CODES_H_
