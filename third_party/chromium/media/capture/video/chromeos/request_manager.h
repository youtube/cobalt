...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_CHROMEOS_REQUEST_MANAGER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_CHROMEOS_REQUEST_MANAGER_H_
...
#include "third_party/chromium/media/capture/video/chromeos/camera_app_device_impl.h"
...
#include "third_party/chromium/media/capture/video/chromeos/mojom/camera_app.mojom.h"
...
class CAPTURE_EXPORT RequestManager final
 ...
 public:
  ...
  using TakePhotoCallback =
      base::OnceCallback<void(int status, media_m96::mojom::BlobPtr blob_result)>;
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_CHROMEOS_REQUEST_MANAGER_H_
