...
class MockMojoVideoEncodeAccelerator : public mojom::VideoEncodeAccelerator {
 public:
  ...
  MOCK_METHOD6(DoInitialize,
               void(media_m96::VideoPixelFormat,
                    const gfx::Size&,
                    media_m96::VideoCodecProfile,
                    media_m96::Bitrate,
  ...
  MOCK_METHOD2(RequestEncodingParametersChangeWithLayers,
               void(const media_m96::VideoBitrateAllocation&, uint32_t));
  MOCK_METHOD2(RequestEncodingParametersChangeWithBitrate,
               void(const media_m96::Bitrate&, uint32_t));
...
class MockVideoEncodeAcceleratorClient : public VideoEncodeAccelerator::Client {
 public:
  ...
  MOCK_METHOD1(NotifyEncoderInfoChange, void(const media_m96::VideoEncoderInfo&));
...
// media_m96::VideoEncodeAccelerator::Client.
class MojoVideoEncodeAcceleratorTest : public ::testing::Test {
 public:
  ...
  void SetUp() override {
    ...
    mojo_vea_ =
        base::WrapUnique<VideoEncodeAccelerator>(new MojoVideoEncodeAccelerator(
            std::move(mojo_vea),
            media_m96::VideoEncodeAccelerator::SupportedProfiles()));
  }
  ...
  MockMojoVideoEncodeAccelerator* mock_mojo_vea() {
    return static_cast<media_m96::MockMojoVideoEncodeAccelerator*>(
 ...
 private:
  ...
  // The class under test, as a generic media_m96::VideoEncodeAccelerator.
