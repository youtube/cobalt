...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_VIDEO_ENCODER_IMPL_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_VIDEO_ENCODER_IMPL_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_VIDEO_ENCODER_IMPL_H_
