...
SAMPLE_SMAPS_1 = """7f6d5c000000-7f6d5c021000 r-xp 00000000 08:01 12345 /lib/x86_64-linux-gnu/ld-2.27.so
Size:                132 kB
KernelPageSize:        4 kB
MMUPageSize:           4 kB
Rss:                  84 kB
...
7f6d5c021000-7f6d5c022000 rw-p 00021000 08:01 12345 /lib/x86_64-linux-gnu/ld-2.27.so
Size:                  4 kB
KernelPageSize:        4 kB
MMUPageSize:           4 kB
Rss:                   4 kB
...
class ReadSmapsTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with open(self.smaps_file_1, 'w') as f:
            f.write(SAMPLE_SMAPS_1)
        with open(self.smaps_file_2, 'w') as f:
