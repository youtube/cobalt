...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_CDM_CLIENT_MOJO_FUCHSIA_CDM_PROVIDER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_CDM_CLIENT_MOJO_FUCHSIA_CDM_PROVIDER_H_

#include "base/macros.h"
#include "third_party/chromium/media/fuchsia/cdm/fuchsia_cdm_provider.h"
#include "third_party/chromium/media/fuchsia/mojom/fuchsia_cdm_provider.mojom.h"
...
class MojoFuchsiaCdmProvider : public FuchsiaCdmProvider {
 ...
 private:
  ...
  mojo::Remote<media_m96::mojom::FuchsiaCdmProvider> cdm_provider_;
};

}  // namespace media_m96

#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_CDM_CLIENT_MOJO_FUCHSIA_CDM_PROVIDER_H_
