...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_DECRYPTOR_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_DECRYPTOR_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_DECRYPTOR_H_
