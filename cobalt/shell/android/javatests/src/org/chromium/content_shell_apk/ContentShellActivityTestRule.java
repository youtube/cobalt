...
/**
 * ActivityTestRule for CobaltActivity.
 *
 * Test can use this ActivityTestRule to launch or get CobaltActivity.
 */
public class CobaltActivityTestRule extends BaseActivityTestRule<CobaltShellActivity> {
    /** The maximum time the waitForActiveShellToBeDoneLoading method will wait. */
    private static final long WAIT_FOR_ACTIVE_SHELL_LOADING_TIMEOUT = 10000L;

    private static final String TAG = "CobaltATR";

    protected static final long WAIT_PAGE_LOADING_TIMEOUT_SECONDS = 15L;

    public CobaltActivityTestRule() {
        super(CobaltActivity.class);
    }
    ...
    /**
     * Starts the Cobalt activity and loads the given URL.
     * The URL can be null, in which case will default to CobaltActivity.DEFAULT_SHELL_URL.
     */
    public CobaltActivity launchContentShellWithUrl(String url) {
     ...
     */
    public CobaltActivity launchContentShellWithUrlSync(String url) {
        String isolatedTestFileUrl = UrlUtils.getIsolatedTestFileUrl(url);
        CobaltActivity activity = launchContentShellWithUrl(isolatedTestFileUrl);
