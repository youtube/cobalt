...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_PULSE_PULSE_UTIL_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_PULSE_PULSE_UTIL_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_PULSE_PULSE_UTIL_H_
