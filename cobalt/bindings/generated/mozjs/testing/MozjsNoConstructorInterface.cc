...
InterfaceData* CreateCachedInterfaceData() {
  ...
  instance_class->name = "MozjsNoConstructorInterface";
  ...
  prototype_class->name = "MozjsNoConstructorInterfacePrototype";
  ...
  interface_object_class->name = "MozjsNoConstructorInterfaceConstructor";
...
void InitializePrototypeAndInterfaceObject(
  ...
  const char name[] = "NoConstructorInterface";
  name_value.setString(JS_NewStringCopyZ(context, "NoConstructorInterface"));
  bool success =
...
// static
JSObject* MozjsNoConstructorInterface::CreateInstance(
