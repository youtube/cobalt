...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_VAAPI_TEST_SCOPED_VA_CONFIG_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_VAAPI_TEST_SCOPED_VA_CONFIG_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_VAAPI_TEST_SCOPED_VA_CONFIG_H_
