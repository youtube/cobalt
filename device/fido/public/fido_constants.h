...
#ifndef DEVICE_FIDO_PUBLIC_FIDO_CONSTANTS_H_
#define DEVICE_FIDO_PUBLIC_FIDO_CONSTANTS_H_
...
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kResidentKeyMapKey[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kUserVerificationMapKey[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kUserPresenceMapKey[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kClientPinMapKey[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kPlatformDeviceMapKey[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kEntityIdMapKey[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kEntityNameMapKey[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kDisplayNameMapKey[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kCredentialTypeMapKey[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kCredentialAlgorithmMapKey[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kCredentialManagementMapKey[];
COMPONENT_EXPORT(FIDO_PUBLIC)
extern const char kCredentialManagementPreviewMapKey[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kBioEnrollmentMapKey[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kBioEnrollmentPreviewMapKey[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kPinUvTokenMapKey[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kDefaultCredProtectKey[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kEnterpriseAttestationKey[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kLargeBlobsKey[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kAlwaysUvKey[];
...
COMPONENT_EXPORT(FIDO_PUBLIC) extern const base::TimeDelta kU2fRetryDelay;

// String key values for attestation object as a response to MakeCredential
// request.
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kFormatKey[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kAttestationStatementKey[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kAuthDataKey[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kNoneAttestationValue[];
...
// protocol.
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kCableHandshakeKeyInfo[];
COMPONENT_EXPORT(FIDO_PUBLIC)
extern const std::array<uint8_t, 24> kCableDeviceEncryptionKeyInfo;
COMPONENT_EXPORT(FIDO_PUBLIC)
extern const char kCableAuthenticatorHelloMessage[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kCableClientHelloMessage[];
...
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kCtap2Version[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kU2fVersion[];
...
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kExtensionCredBlob[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kExtensionMinPINLength[];
...
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kExtensionLargeBlobRead[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kExtensionLargeBlobSupport[];
COMPONENT_EXPORT(FIDO_PUBLIC)
extern const char kExtensionLargeBlobSupportPreferred[];
COMPONENT_EXPORT(FIDO_PUBLIC)
extern const char kExtensionLargeBlobSupportRequired[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kExtensionLargeBlobSupported[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kExtensionLargeBlobWrite[];
COMPONENT_EXPORT(FIDO_PUBLIC) extern const char kExtensionLargeBlobWritten[];

// The minimum and maximum timeouts for Get and Create requests.
COMPONENT_EXPORT(FIDO_PUBLIC) extern const base::TimeDelta kMinRequestTimeout;
COMPONENT_EXPORT(FIDO_PUBLIC) extern const base::TimeDelta kMaxRequestTimeout;
...
#endif  // DEVICE_FIDO_PUBLIC_FIDO_CONSTANTS_H_
