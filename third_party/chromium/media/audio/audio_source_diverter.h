...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_SOURCE_DIVERTER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_SOURCE_DIVERTER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_SOURCE_DIVERTER_H_
