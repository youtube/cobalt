...
SbKey AndroidKeyCodeToSbKey(int key_code) {
  switch (key_code) {
    ...
    case AKEYCODE_F11:
    case AKEYCODE_F12:
      return static_cast<SbKey>(kSbKeyF1 + (key_code - AKEYCODE_F1));
    ...
    case AKEYCODE_8:
    case AKEYCODE_9:
      return static_cast<SbKey>(kSbKey0 + (key_code - AKEYCODE_0));
    ...
    case AKEYCODE_NUMPAD_9:
      return static_cast<SbKey>(kSbKeyNumpad0 + (key_code - AKEYCODE_NUMPAD_0));
    ...
    case AKEYCODE_Y:
    case AKEYCODE_Z:
      return static_cast<SbKey>(kSbKeyA + (key_code - AKEYCODE_A));
