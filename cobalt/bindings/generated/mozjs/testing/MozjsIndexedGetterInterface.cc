...
InterfaceData* CreateCachedInterfaceData() {
  ...
  instance_class->name = "MozjsIndexedGetterInterface";
  ...
  prototype_class->name = "MozjsIndexedGetterInterfacePrototype";
  ...
  interface_object_class->name = "MozjsIndexedGetterInterfaceConstructor";
