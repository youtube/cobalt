...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_BIT_READER_CORE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_BIT_READER_CORE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_BIT_READER_CORE_H_
