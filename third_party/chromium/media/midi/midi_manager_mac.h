...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_MIDI_MIDI_MANAGER_MAC_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_MIDI_MIDI_MANAGER_MAC_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_MIDI_MIDI_MANAGER_MAC_H_
