...
TEST_F(ProtoUtilsTest, PipelineStatisticsConversion) {
  ...
  original.audio_pipeline_info = {false, false,
                                  media_m96::AudioDecoderType::kUnknown,
                                  media_m96::EncryptionType::kClear};
  original.video_pipeline_info = {false, false,
                                  media_m96::VideoDecoderType::kUnknown,
                                  media_m96::EncryptionType::kClear};
  ...
  // If this fails, did media_m96::PipelineStatistics add/change fields that are not
  // being set by media_m96::remoting::ConvertProtoToPipelineStatistics()?
