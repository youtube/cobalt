...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_RENDERER_CLIENT_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_RENDERER_CLIENT_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_RENDERER_CLIENT_H_
