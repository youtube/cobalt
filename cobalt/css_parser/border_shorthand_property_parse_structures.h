...
#ifndef CSS_PARSER_BORDER_SHORTHAND_PROPERTY_PARSE_STRUCTURES_H_
#define CSS_PARSER_BORDER_SHORTHAND_PROPERTY_PARSE_STRUCTURES_H_
...
#endif  // CSS_PARSER_BORDER_SHORTHAND_PROPERTY_PARSE_STRUCTURES_H_
