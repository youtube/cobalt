...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_VIDEO_THUMBNAIL_DECODER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_VIDEO_THUMBNAIL_DECODER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_VIDEO_THUMBNAIL_DECODER_H_
