...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_OUTPUT_IPC_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_OUTPUT_IPC_H_
...
class MEDIA_EXPORT AudioOutputIPCDelegate {
 public:
  ...
  virtual void OnDeviceAuthorized(OutputDeviceStatus device_status,
                                  const media_m96::AudioParameters& output_params,
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_OUTPUT_IPC_H_
