...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_TEST_VIDEO_PLAYER_VIDEO_DECODER_CLIENT_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_TEST_VIDEO_PLAYER_VIDEO_DECODER_CLIENT_H_
...
class VideoDecoderClient {
 ...
 private:
  ...
  void DecodeDoneTask(media_m96::Status status);
  ...
  void FlushDoneTask(media_m96::Status status);
  ...
  std::unique_ptr<media_m96::test::EncodedDataHelper> encoded_data_helper_;
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_TEST_VIDEO_PLAYER_VIDEO_DECODER_CLIENT_H_
