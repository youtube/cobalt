...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_VIDEO_CADENCE_ESTIMATOR_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_VIDEO_CADENCE_ESTIMATOR_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_VIDEO_CADENCE_ESTIMATOR_H_
