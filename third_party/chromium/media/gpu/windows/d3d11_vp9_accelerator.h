...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_WINDOWS_D3D11_VP9_ACCELERATOR_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_WINDOWS_D3D11_VP9_ACCELERATOR_H_
...
#include "third_party/chromium/media/gpu/windows/d3d11_vp9_picture.h"
...
class D3D11VP9Accelerator : public VP9Decoder::VP9Accelerator {
 ...
 private:
  ...
  void RecordFailure(const std::string& fail_type, media_m96::Status error);
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_WINDOWS_D3D11_VP9_ACCELERATOR_H_
