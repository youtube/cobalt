...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CDM_CBCS_DECRYPTOR_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CDM_CBCS_DECRYPTOR_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CDM_CBCS_DECRYPTOR_H_
