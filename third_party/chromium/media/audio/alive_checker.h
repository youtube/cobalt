...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_ALIVE_CHECKER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_ALIVE_CHECKER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_ALIVE_CHECKER_H_
