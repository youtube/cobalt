...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_WIN_SINK_INPUT_PIN_WIN_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_WIN_SINK_INPUT_PIN_WIN_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_WIN_SINK_INPUT_PIN_WIN_H_
