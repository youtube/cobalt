...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_SAMPLE_RATES_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_SAMPLE_RATES_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_SAMPLE_RATES_H_
