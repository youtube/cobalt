...
#include "third_party/chromium/media/gpu/android/direct_shared_image_video_provider.h"
...
void GpuSharedImageVideoFactory::CreateImage(
  ...
  auto release_cb = mojo::WrapCallbackWithDefaultInvokeIfNotRun(
      base::BindPostTaskToCurrentDefault(std::move(destroy_shared_image)), gpu::SyncToken());
