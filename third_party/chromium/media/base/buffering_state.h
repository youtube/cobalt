...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_BUFFERING_STATE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_BUFFERING_STATE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_BUFFERING_STATE_H_
