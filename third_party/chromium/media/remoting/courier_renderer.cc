...
#include "third_party/chromium/media/remoting/courier_renderer.h"
...
#include "third_party/chromium/media/remoting/demuxer_stream_adapter.h"
#include "third_party/chromium/media/remoting/proto_enum_utils.h"
#include "third_party/chromium/media/remoting/proto_utils.h"
#include "third_party/chromium/media/remoting/renderer_controller.h"
...
void CourierRenderer::Initialize(MediaResource* media_resource,
  ...
  ::media_m96::DemuxerStream* audio_demuxer_stream =
      media_resource_->GetFirstStream(DemuxerStream::AUDIO);
  ::media_m96::DemuxerStream* video_demuxer_stream =
