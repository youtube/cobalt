  ...
  'targets': [
    ...
    },
    {
      ...
      'sources': [
        ...
        '<(DEPTH)/starboard/shared/opensles/opensles_audio_sink_type.cc',
	...
	'<(DEPTH)/starboard/shared/pthread/condition_variable_wait_timed.cc',
        ...
        '<(DEPTH)/third_party/starboard/android/shared/drm_close_session.cc',
        '<(DEPTH)/third_party/starboard/android/shared/drm_create_system.cc',
        '<(DEPTH)/third_party/starboard/android/shared/drm_destroy_system.cc',
        '<(DEPTH)/third_party/starboard/android/shared/drm_generate_session_update_request.cc',
        '<(DEPTH)/third_party/starboard/android/shared/drm_system_internal.h',
        '<(DEPTH)/third_party/starboard/android/shared/drm_update_session.cc',
        ...
        '<(DEPTH)/third_party/starboard/android/shared/media_is_output_protected.cc',
        '<(DEPTH)/third_party/starboard/android/shared/media_is_supported.cc',
        '<(DEPTH)/third_party/starboard/android/shared/media_set_output_protection.cc',
	...
	'<(DEPTH)/starboard/shared/pthread/mutex_release.cc',
        ...
        '<(DEPTH)/third_party/starboard/android/shared/mediacodec/mediacodec_audio_decoder.cc',
        '<(DEPTH)/third_party/starboard/android/shared/mediacodec/mediacodec_audio_decoder.h',
        '<(DEPTH)/third_party/starboard/android/shared/mediacodec/mediacodec_common.cc',
        '<(DEPTH)/third_party/starboard/android/shared/mediacodec/mediacodec_common.h',
        '<(DEPTH)/third_party/starboard/android/shared/mediacodec/mediacodec_video_decoder.cc',
        '<(DEPTH)/third_party/starboard/android/shared/mediacodec/mediacodec_video_decoder.h',
	...
	'<(DEPTH)/starboard/shared/posix/set_non_blocking_internal.cc',
        ...
        '<(DEPTH)/third_party/starboard/android/shared/socket_get_local_interface_address.cc',
        '<(DEPTH)/third_party/starboard/android/shared/ifaddrs.c',
        '<(DEPTH)/third_party/starboard/android/shared/ifc_utils.c',
        ...
        '<(DEPTH)/third_party/starboard/android/shared/system_break_into_debugger.cc',
        '<(DEPTH)/starboard/shared/posix/system_clear_last_error.cc',
        '<(DEPTH)/third_party/starboard/android/shared/system_clear_platform_error.cc',
        '<(DEPTH)/third_party/starboard/android/shared/system_get_connection_type.cc',
        '<(DEPTH)/third_party/starboard/android/shared/system_get_device_type.cc',
        ...
        '<(DEPTH)/third_party/starboard/android/shared/system_get_path.cc',
        '<(DEPTH)/third_party/starboard/android/shared/system_get_property.cc',
        '<(DEPTH)/starboard/shared/linux/system_get_random_data.cc',
        '<(DEPTH)/starboard/shared/starboard/system_get_random_uint64.cc',
        '<(DEPTH)/third_party/starboard/android/shared/system_get_stack.cc',
        #'<(DEPTH)/starboard/shared/starboard/system_get_stack.cc',
        '<(DEPTH)/starboard/shared/linux/system_get_total_cpu_memory.cc',
        '<(DEPTH)/third_party/starboard/android/shared/system_get_total_gpu_memory.cc',
        '<(DEPTH)/starboard/shared/linux/system_get_used_cpu_memory.cc',
        '<(DEPTH)/third_party/starboard/android/shared/system_get_used_gpu_memory.cc',
        '<(DEPTH)/starboard/linux/shared/system_has_capability.cc',
        '<(DEPTH)/third_party/starboard/android/shared/system_hide_splash_screen.cc',
        '<(DEPTH)/starboard/shared/linux/system_is_debugger_attached.cc',
        '<(DEPTH)/third_party/starboard/android/shared/system_raise_platform_error.cc',
        '<(DEPTH)/third_party/starboard/android/shared/system_request_stop.cc',
	...
	# Not in <pthread.h>
        ...
        '<(DEPTH)/third_party/starboard/android/shared/thread_get_name.cc',
	...
	'<(DEPTH)/starboard/shared/pthread/thread_yield.cc',
        ...
        '<(DEPTH)/third_party/starboard/android/shared/get_home_directory.cc',

        '<(DEPTH)/third_party/starboard/android/shared/window_internal.cc',
        '<(DEPTH)/third_party/starboard/android/shared/window_create.cc',
        '<(DEPTH)/third_party/starboard/android/shared/window_destroy.cc',
        '<(DEPTH)/third_party/starboard/android/shared/window_get_platform_handle.cc',
        '<(DEPTH)/third_party/starboard/android/shared/window_get_size.cc',
        '<(DEPTH)/third_party/starboard/android/shared/window_set_default_options.cc',
        'atomic_public.h',
        '<(DEPTH)/third_party/starboard/android/shared/exports.h',
        '<(DEPTH)/third_party/starboard/android/shared/main.cc',
        '<(DEPTH)/third_party/starboard/android/shared/application_android.cc',
        '<(DEPTH)/third_party/starboard/android/shared/application_android.h',
