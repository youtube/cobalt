...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_IMPL_DISTRIBUTION_REPORTER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_IMPL_DISTRIBUTION_REPORTER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_IMPL_DISTRIBUTION_REPORTER_H_
