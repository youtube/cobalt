...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_MOJO_SERVICES_MOJO_RENDERER_SERVICE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_MOJO_SERVICES_MOJO_RENDERER_SERVICE_H_
...
// A mojom::Renderer implementation that use a media_m96::Renderer to render
// media streams.
class MEDIA_MOJO_EXPORT MojoRendererService final : public mojom::Renderer,
 ...
 private:
  ...
  // Must use "media_m96::" because "Renderer" is ambiguous.
  std::unique_ptr<media_m96::Renderer> renderer_;
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_MOJO_SERVICES_MOJO_RENDERER_SERVICE_H_
