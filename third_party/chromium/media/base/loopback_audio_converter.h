...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_LOOPBACK_AUDIO_CONVERTER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_LOOPBACK_AUDIO_CONVERTER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_LOOPBACK_AUDIO_CONVERTER_H_
