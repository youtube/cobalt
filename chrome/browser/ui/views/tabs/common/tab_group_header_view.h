...
#ifndef CHROME_BROWSER_UI_VIEWS_TABS_COMMON_TAB_GROUP_HEADER_VIEW_H_
#define CHROME_BROWSER_UI_VIEWS_TABS_COMMON_TAB_GROUP_HEADER_VIEW_H_
...
class TabGroupHeaderView : public views::FlexLayoutView,
                           public views::ContextMenuController,
                           public views::FocusChangeListener,
                           public HoverCardAnchorTarget {
  METADATA_HEADER(TabGroupHeaderView, views::FlexLayoutView)
 ...
 public:
  ...
  TabGroupHeaderView& operator=(const TabGroupHeaderView&) = delete;
 ...
 private:
  ...
  base::WeakPtrFactory<TabGroupHeaderView> weak_ptr_factory_{this};
};

#endif  // CHROME_BROWSER_UI_VIEWS_TABS_COMMON_TAB_GROUP_HEADER_VIEW_H_
