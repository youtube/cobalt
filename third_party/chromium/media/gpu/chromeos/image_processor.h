...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_CHROMEOS_IMAGE_PROCESSOR_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_CHROMEOS_IMAGE_PROCESSOR_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_CHROMEOS_IMAGE_PROCESSOR_H_
