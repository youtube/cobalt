...
MEDIA_EXPORT BASE_DECLARE_FEATURE(kCobaltVideoBufferSizeReductionPercent);
MEDIA_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kCobaltVideoBufferSizeReductionPercentValue);
