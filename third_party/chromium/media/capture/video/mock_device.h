...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_MOCK_DEVICE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_MOCK_DEVICE_H_
...
// StopAndDeAllocate().
class MockDevice : public media_m96::VideoCaptureDevice {
 public:
  MockDevice();
  ~MockDevice() override;

  void SendStubFrame(const media_m96::VideoCaptureFormat& format,
                     int rotation,
                     int frame_feedback_id);
  void SendOnStarted();

  // media_m96::VideoCaptureDevice implementation.
  MOCK_METHOD2(DoAllocateAndStart,
               void(const media_m96::VideoCaptureParams& params,
  ...
  MOCK_METHOD2(DoSetPhotoOptions,
               void(media_m96::mojom::PhotoSettingsPtr* settings,
                    SetPhotoOptionsCallback* callback));
  MOCK_METHOD1(DoTakePhoto, void(TakePhotoCallback* callback));
  MOCK_METHOD2(OnUtilizationReport,
               void(int frame_feedback_id, media_m96::VideoCaptureFeedback));
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_MOCK_DEVICE_H_
