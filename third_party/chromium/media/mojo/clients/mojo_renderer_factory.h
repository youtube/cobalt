...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_MOJO_CLIENTS_MOJO_RENDERER_FACTORY_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_MOJO_CLIENTS_MOJO_RENDERER_FACTORY_H_
...
// media_m96::Pipeline and a media_m96::Renderer in a different process.
//
// Implementors of new media_m96::Renderer types are encouraged to create small
...
class MojoRendererFactory final : public RendererFactory {
 ...
 private:
  ...
  // renderer.
  media_m96::mojom::InterfaceFactory* interface_factory_ = nullptr;
};

}  // namespace media_m96

#endif  // THIRD_PARTY_CHROMIUM_MEDIA_MOJO_CLIENTS_MOJO_RENDERER_FACTORY_H_
