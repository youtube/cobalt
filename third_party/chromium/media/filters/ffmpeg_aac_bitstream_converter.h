...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_FFMPEG_AAC_BITSTREAM_CONVERTER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_FFMPEG_AAC_BITSTREAM_CONVERTER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_FFMPEG_AAC_BITSTREAM_CONVERTER_H_
