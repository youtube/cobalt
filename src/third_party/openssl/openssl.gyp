      ...
      'conditions': [
        ...
        ['OS=="lb_shell" or OS=="starboard"', {
          ...
          'conditions': [
            ...
            ['OS=="starboard"', {
              'variables': {
                'openssl_config_path': 'config/starboard',
              },
              'dependencies': [
            ...
            ['OS=="lb_shell" or OS=="starboard"', {
              'defines': [
                ...
                'OPENSSL_NO_COMP',
                # TODO: Re-enable this.
                # OpenSSLInitSingleton() relies on CRYPTO_set_id_callback().
              ...
              'sources!': [
                ...
                'openssl/ssl/d1_pkt.c',
                'openssl/ssl/kssl.c',
                # 'openssl/ssl/d1_srtp.c',  # Used by t1
                'openssl/ssl/d1_srvr.c',
    
                # TODO: See if we can stop compiling: SSL2, SSL23, SSL3, MD5, SHA1
              ],
              'conditions': [
                ['target_arch=="ps3"', {
                  'defines': [
