...
#include "third_party/chromium/media/capture/video/mac/video_capture_device_avfoundation_utils_mac.h"
...
void MaybeWriteUma(int number_of_devices, int number_of_suspended_devices) {
  ...
  const int retry_count =
      media_m96::VideoCaptureDeviceFactoryMac::GetGetDevicesInfoRetryCount();
