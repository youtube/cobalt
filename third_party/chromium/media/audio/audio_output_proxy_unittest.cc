...
#include "third_party/chromium/media/audio/audio_output_resampler.h"
#include "third_party/chromium/media/audio/fake_audio_log_factory.h"
#include "third_party/chromium/media/audio/fake_audio_output_stream.h"
...
using media_m96::AudioBus;
using media_m96::AudioInputStream;
using media_m96::AudioManager;
using media_m96::AudioManagerBase;
using media_m96::AudioOutputDispatcher;
using media_m96::AudioOutputProxy;
using media_m96::AudioOutputStream;
using media_m96::AudioParameters;
using media_m96::FakeAudioOutputStream;
using media_m96::TestAudioThread;
...
// Dummy function.
std::unique_ptr<media_m96::AudioDebugRecorder> RegisterDebugRecording(
