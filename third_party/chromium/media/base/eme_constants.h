...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_EME_CONSTANTS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_EME_CONSTANTS_H_
...
constexpr SupportedCodecs GetMp4VideoCodecs() {
  ...
  // not be in "video/mp4" mime type, but that is enforced by media_m96::MimeUtil.
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_EME_CONSTANTS_H_
