...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_LOG_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_LOG_H_
...
#include "third_party/chromium/media/base/media_log_events.h"
#include "third_party/chromium/media/base/media_log_message_levels.h"
#include "third_party/chromium/media/base/media_log_properties.h"
...
public:  template <MediaLogProperty P, typename T>
  ...
  virtual void AddLogRecordLocked(
      std::unique_ptr<media_m96::MediaLogRecord> event) {
    NOTREACHED();
  }
...
// of memory on linux.
  ...
  // TODO(tmathmeyer) Use a media_m96::Status when that is ready.
...
#define MEDIA_LOG(level, media_log)                                      \
  media_m96::LogHelper((media_m96::MediaLogMessageLevel::k##level), (media_log)) \
      .stream()
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_LOG_H_
