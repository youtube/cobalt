 ...
 *
 * <p>Uses a lookup table for a path consisting of two Bezier curves from (0,0) to (1,1).
 *
 * <p>The first curve has control points: P0 (0, 0) P1 (0.05, 0) P2 (0.133333, 0.06) P3 (0.166666,
 * 0.4)
 *
 * <p>The second curve has control points: P0 (0.166666, 0.4) P1 (0.208333, 0.82) P2 (0.25, 1) P3
 * (1, 1)
 *
 * <p>Values were generated with the following Kotlin code: <code><pre>
...
public class FastOutExtraSlowInInterpolator implements Interpolator {
    ...
    /**
     * Lookup table values sampled with x at regular intervals between 0 and 1 for a total of 201
     * points.
     */
