...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_DEMUXER_STREAM_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_DEMUXER_STREAM_H_
...
#if defined(STARBOARD)
  typedef base::OnceCallback<void(Status, std::vector<scoped_refptr<DecoderBuffer>>)> ReadCB;
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_DEMUXER_STREAM_H_
