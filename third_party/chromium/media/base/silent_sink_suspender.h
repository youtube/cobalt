...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_SILENT_SINK_SUSPENDER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_SILENT_SINK_SUSPENDER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_SILENT_SINK_SUSPENDER_H_
