...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CDM_AES_CBC_CRYPTO_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CDM_AES_CBC_CRYPTO_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CDM_AES_CBC_CRYPTO_H_
