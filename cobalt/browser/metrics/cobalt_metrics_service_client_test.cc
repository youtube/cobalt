...
class TestProcessMemoryMetricsEmitter : public CobaltMemoryMetricsEmitter {
 public:
  ...
  void FetchAndEmitProcessMemoryMetrics() override {
    ...
    browser_dump->os_dump->extra_stats[kExtraStatPartitionAllocRss] =
        16384;                                                        // 16 MB
    ...
    browser_dump->os_dump->extra_stats[kExtraStatLibChrobaltRss] =
        10240;  // 10 MB
    browser_dump->os_dump->extra_stats[kExtraStatLibChrobaltPss] =
        8192;  // 8 MB
#endif
