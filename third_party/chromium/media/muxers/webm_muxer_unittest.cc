...
#include "third_party/chromium/media/muxers/webm_muxer.h"
...
TEST_P(WebmMuxerTest,
  ...
  media_m96::AudioParameters audio_params(
      media_m96::AudioParameters::Format::AUDIO_PCM_LOW_LATENCY,
      media_m96::CHANNEL_LAYOUT_MONO, /*sample_rate=*/48000,
...
TEST_P(WebmMuxerTest, OnEncodedAudioTwoFrames) {
  ...
  media_m96::AudioParameters audio_params(
      media_m96::AudioParameters::Format::AUDIO_PCM_LOW_LATENCY,
      media_m96::CHANNEL_LAYOUT_MONO, sample_rate, frames_per_buffer);
...
TEST_P(WebmMuxerTest, ColorSpaceREC709IsPropagatedToTrack) {
  WebmMuxer::VideoParameters params(gfx::Size(1, 1), 0, media_m96::VideoCodec::kVP9,
...
TEST_P(WebmMuxerTest, ColorSpaceExtendedSRGBIsPropagatedToTrack) {
  WebmMuxer::VideoParameters params(
      gfx::Size(1, 1), 0, media_m96::VideoCodec::kVP9,
...
class WebmMuxerTestUnparametrized : public testing::Test {
 public:
  ...
  bool Parse() {
    ...
    webm_muxer_ = nullptr;
    media_m96::WebMStreamParser parser;
    parser.Init(
  ...
  void AddVideoAtOffset(int system_timestamp_offset_ms, bool is_key_frame) {
    WebmMuxer::VideoParameters params(
        gfx::Size(1, 1), 0, media_m96::VideoCodec::kVP8, gfx::ColorSpace());
    webm_muxer_->OnEncodedVideo(
  ...
  void AddAudioAtOffsetWithDuration(int system_timestamp_offset_ms,
    ...
    media_m96::AudioParameters audio_params(
        media_m96::AudioParameters::Format::AUDIO_PCM_LOW_LATENCY,
        media_m96::CHANNEL_LAYOUT_MONO, frame_rate_hz, frames_per_buffer);
 ...
 protected:
  // media_m96::StreamParser callbacks.
  void OnInit(const media_m96::StreamParser::InitParameters&) {}
  bool OnNewConfig(std::unique_ptr<media_m96::MediaTracks> tracks,
                   const media_m96::StreamParser::TextTrackConfigMap&) {
    return true;
  }
  bool OnNewBuffers(const media_m96::StreamParser::BufferQueueMap& map) {
    for (const auto& kv : map) {
      int track_id = kv.first;
      const media_m96::StreamParser::BufferQueue& queue = kv.second;
 ...
 private:
  ...
  media_m96::MockMediaLog media_log_;
