...
absl::optional<std::unique_ptr<fuchsia::media_m96::Compression>>
GetFuchsiaCompressionFromDecoderConfig(AudioDecoderConfig config) {
  auto compression = std::make_unique<fuchsia::media_m96::Compression>();
  switch (config.codec()) {
    case AudioCodec::kAAC:
      compression->type = fuchsia::media_m96::AUDIO_ENCODING_AAC;
      break;
    case AudioCodec::kMP3:
      compression->type = fuchsia::media_m96::AUDIO_ENCODING_MP3;
      break;
    case AudioCodec::kVorbis:
      compression->type = fuchsia::media_m96::AUDIO_ENCODING_VORBIS;
      break;
    case AudioCodec::kOpus:
      compression->type = fuchsia::media_m96::AUDIO_ENCODING_OPUS;
      break;
    case AudioCodec::kFLAC:
      compression->type = fuchsia::media_m96::AUDIO_ENCODING_FLAC;
      break;
...
absl::optional<fuchsia::media_m96::AudioSampleFormat>
GetFuchsiaSampleFormatFromSampleFormat(SampleFormat sample_format) {
  switch (sample_format) {
    case kSampleFormatU8:
      return fuchsia::media_m96::AudioSampleFormat::UNSIGNED_8;
    case kSampleFormatS16:
      return fuchsia::media_m96::AudioSampleFormat::SIGNED_16;
    case kSampleFormatS24:
      return fuchsia::media_m96::AudioSampleFormat::SIGNED_24_IN_32;
    case kSampleFormatF32:
      return fuchsia::media_m96::AudioSampleFormat::FLOAT;
...
scoped_refptr<media_m96::DecoderBuffer> PreparePcm24Buffer(
  ...
  scoped_refptr<media_m96::DecoderBuffer> result =
      base::MakeRefCounted<media_m96::DecoderBuffer>(samples * 4);
...
void FuchsiaAudioRenderer::InitializeStreamSink() {
  ...
  if (!compression.value()) {
    absl::optional<fuchsia::media_m96::AudioSampleFormat> sample_format =
    ...
    stream_type.sample_format = fuchsia::media_m96::AudioSampleFormat::SIGNED_16;
  }
...
void FuchsiaAudioRenderer::StartAudioConsumer() {
  ...
  fuchsia::media_m96::AudioConsumerStartFlags flags{};
  if (demuxer_stream_->liveness() == DemuxerStream::LIVENESS_LIVE) {
    flags = fuchsia::media_m96::AudioConsumerStartFlags::LOW_LATENCY;
  }
  ...
  audio_consumer_->Start(flags, fuchsia::media_m96::NO_TIMESTAMP,
...
void FuchsiaAudioRenderer::OnAudioConsumerStatusChanged(
  ...
  if (status.has_error()) {
    LOG(ERROR) << "fuchsia::media_m96::AudioConsumer reported an error";
    OnError(AUDIO_RENDERER_ERROR);
    return;
  }
...
void FuchsiaAudioRenderer::SendInputPacket(
  ...
  fuchsia::media_m96::StreamPacket stream_packet;
