...
#include "third_party/chromium/media/midi/midi_jni_headers/UsbMidiDeviceAndroid_jni.h"
#include "third_party/chromium/media/midi/usb_midi_descriptor_parser.h"
