...
#include "third_party/chromium/media/capture/video/chromeos/mock_camera_module.h"
#include "third_party/chromium/media/capture/video/chromeos/mock_vendor_tag_ops.h"
