...
gfx::ColorVolumeMetadata ConvertMdcvToColorVolumeMetadata(
  ...
  color_volume_metadata.primaries.fRX = mdcv.display_primaries_rx;
  color_volume_metadata.primaries.fRY = mdcv.display_primaries_ry;
  color_volume_metadata.primaries.fGX = mdcv.display_primaries_gx;
  color_volume_metadata.primaries.fGY = mdcv.display_primaries_gy;
  color_volume_metadata.primaries.fBX = mdcv.display_primaries_bx;
  color_volume_metadata.primaries.fBY = mdcv.display_primaries_by;
  color_volume_metadata.primaries.fWX = mdcv.white_point_x;
  color_volume_metadata.primaries.fWY = mdcv.white_point_y;
