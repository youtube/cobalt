...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_COMMON_FRAME_ID_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_COMMON_FRAME_ID_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_COMMON_FRAME_ID_H_
