...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_COMMON_STREAM_PROCESSOR_HELPER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_COMMON_STREAM_PROCESSOR_HELPER_H_
...
// Helper class of fuchsia::media_m96::StreamProcessor. It's responsible for:
...
class MEDIA_EXPORT StreamProcessorHelper {
 public:
  class MEDIA_EXPORT IoPacket {
   public:
    ...
    void set_format(fuchsia::media_m96::FormatDetails format) {
      format_ = std::move(format);
    }
    const fuchsia::media_m96::FormatDetails& format() const { return format_; }
   ...
   private:
    ...
    bool unit_end_;
    fuchsia::media_m96::FormatDetails format_;
  ...
  class Client {
   public:
    ...
    virtual void OnStreamProcessorAllocateOutputBuffers(
        const fuchsia::media_m96::StreamBufferConstraints& stream_constraints) = 0;
    ...
    virtual void OnStreamProcessorOutputFormat(
        fuchsia::media_m96::StreamOutputFormat format) = 0;
  ...
  StreamProcessorHelper(fuchsia::media_m96::StreamProcessorPtr processor,
                        Client* client);
 ...
 private:
  ...
  void OnInputConstraints(
      fuchsia::media_m96::StreamBufferConstraints input_constraints);
  void OnFreeInputPacket(fuchsia::media_m96::PacketHeader free_input_packet);
  void OnOutputConstraints(
      fuchsia::media_m96::StreamOutputConstraints output_constraints);
  void OnOutputFormat(fuchsia::media_m96::StreamOutputFormat output_format);
  void OnOutputPacket(fuchsia::media_m96::Packet output_packet,
  ...
  fuchsia::media_m96::StreamBufferConstraints output_buffer_constraints_;

  fuchsia::media_m96::StreamProcessorPtr processor_;
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_COMMON_STREAM_PROCESSOR_HELPER_H_
