...
#ifndef COBALT_TESTING_SHELL_CONTENT_BROWSER_TEST_CONTENT_BROWSER_CLIENT_H_
#define COBALT_TESTING_SHELL_CONTENT_BROWSER_TEST_CONTENT_BROWSER_CLIENT_H_
...
class ContentBrowserTestContentBrowserClient
    : public cobalt::CobaltContentBrowserClient {
 public:
...
#endif  // COBALT_TESTING_SHELL_CONTENT_BROWSER_TEST_CONTENT_BROWSER_CLIENT_H_
