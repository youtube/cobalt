...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_SUBSAMPLE_ENTRY_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_SUBSAMPLE_ENTRY_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_SUBSAMPLE_ENTRY_H_
