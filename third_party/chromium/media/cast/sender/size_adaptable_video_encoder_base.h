...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_SIZE_ADAPTABLE_VIDEO_ENCODER_BASE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_SIZE_ADAPTABLE_VIDEO_ENCODER_BASE_H_
...
#include "third_party/chromium/media/cast/sender/video_encoder.h"
...
class SizeAdaptableVideoEncoderBase : public VideoEncoder {
 public:
  ...
  bool EncodeVideoFrame(scoped_refptr<media_m96::VideoFrame> video_frame,
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_SIZE_ADAPTABLE_VIDEO_ENCODER_BASE_H_
