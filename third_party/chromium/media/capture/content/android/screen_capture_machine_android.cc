...
#include "third_party/chromium/media/capture/content/android/screen_capture_machine_android.h"
...
#include "third_party/chromium/media/capture/content/android/screen_capture_jni_headers/ScreenCapture_jni.h"
