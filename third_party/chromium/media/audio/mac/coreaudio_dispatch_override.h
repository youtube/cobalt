...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_MAC_COREAUDIO_DISPATCH_OVERRIDE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_MAC_COREAUDIO_DISPATCH_OVERRIDE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_MAC_COREAUDIO_DISPATCH_OVERRIDE_H_
