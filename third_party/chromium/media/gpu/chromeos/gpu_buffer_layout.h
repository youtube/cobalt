...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_CHROMEOS_GPU_BUFFER_LAYOUT_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_CHROMEOS_GPU_BUFFER_LAYOUT_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_CHROMEOS_GPU_BUFFER_LAYOUT_H_
