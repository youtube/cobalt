  ...
  'targets': [
    ...
    },
    {
      ...
      'sources': [
        ...
        '<(DEPTH)/starboard/shared/ffmpeg_alsa/alsa_sink.cc',
        '<(DEPTH)/starboard/shared/ffmpeg_alsa/alsa_sink.h',
        '<(DEPTH)/starboard/shared/ffmpeg_alsa/alsa_util.cc',
        '<(DEPTH)/starboard/shared/ffmpeg_alsa/alsa_util.h',
        '<(DEPTH)/starboard/shared/ffmpeg_alsa/ffmpeg_common.cc',
        '<(DEPTH)/starboard/shared/ffmpeg_alsa/ffmpeg_common.h',
        '<(DEPTH)/starboard/shared/ffmpeg_alsa/ffmpeg_audio_decoder.cc',
        '<(DEPTH)/starboard/shared/ffmpeg_alsa/ffmpeg_audio_decoder.h',
        '<(DEPTH)/starboard/shared/ffmpeg_alsa/ffmpeg_video_decoder.cc',
        '<(DEPTH)/starboard/shared/ffmpeg_alsa/ffmpeg_video_decoder.h',
        '<(DEPTH)/starboard/shared/ffmpeg_alsa/audio_renderer.cc',
        '<(DEPTH)/starboard/shared/ffmpeg_alsa/audio_renderer.h',
        '<(DEPTH)/starboard/shared/ffmpeg_alsa/player_create.cc',
        '<(DEPTH)/starboard/shared/ffmpeg_alsa/player_destroy.cc',
        '<(DEPTH)/starboard/shared/ffmpeg_alsa/player_get_info.cc',
        '<(DEPTH)/starboard/shared/ffmpeg_alsa/player_internal.cc',
        '<(DEPTH)/starboard/shared/ffmpeg_alsa/player_internal.h',
        '<(DEPTH)/starboard/shared/ffmpeg_alsa/player_seek.cc',
        '<(DEPTH)/starboard/shared/ffmpeg_alsa/player_set_pause.cc',
        '<(DEPTH)/starboard/shared/ffmpeg_alsa/player_set_volume.cc',
        '<(DEPTH)/starboard/shared/ffmpeg_alsa/player_worker.cc',
        '<(DEPTH)/starboard/shared/ffmpeg_alsa/player_worker.h',
        '<(DEPTH)/starboard/shared/ffmpeg_alsa/player_write_end_of_stream.cc',
        '<(DEPTH)/starboard/shared/ffmpeg_alsa/player_write_sample.cc',
        '<(DEPTH)/starboard/shared/ffmpeg_alsa/video_renderer.cc',
        '<(DEPTH)/starboard/shared/ffmpeg_alsa/video_renderer.h',
