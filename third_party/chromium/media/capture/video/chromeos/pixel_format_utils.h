...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_CHROMEOS_PIXEL_FORMAT_UTILS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_CHROMEOS_PIXEL_FORMAT_UTILS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_CHROMEOS_PIXEL_FORMAT_UTILS_H_
