...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_JNI_HDR_METADATA_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_JNI_HDR_METADATA_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_JNI_HDR_METADATA_H_
