...
#include "third_party/chromium/media/gpu/test/video_encoder/video_encoder.h"
#include "third_party/chromium/media/gpu/test/video_encoder/video_encoder_client.h"
#include "third_party/chromium/media/gpu/test/video_encoder/video_encoder_test_environment.h"
...
media_m96::test::VideoEncoderTestEnvironment* g_env;
...
class VideoEncoderTest : public ::testing::Test {
 public:
  ...
  std::unique_ptr<VideoEncoder> CreateVideoEncoder(
    ...
    const media_m96::VideoBitrateAllocation& bitrate = g_env->Bitrate();
...
int main(int argc, char** argv) {
  ...
  base::FilePath video_path =
      (args.size() >= 1) ? base::FilePath(args[0])
                         : base::FilePath(media_m96::test::kDefaultTestVideoPath);
  ...
  base::FilePath::StringType output_folder = media_m96::test::kDefaultOutputFolder;
  ...
  for (base::CommandLine::SwitchMap::const_iterator it = switches.begin();
    ...
    if (it->first == "output_folder") {
      ...
      if (num_spatial_layers > media_m96::test::kMaxSpatialLayers) {
      ...
      if (num_spatial_layers > media_m96::test::kMaxTemporalLayers) {
  ...
  media_m96::test::VideoEncoderTestEnvironment* test_environment =
      media_m96::test::VideoEncoderTestEnvironment::Create(
  ...
  media_m96::test::g_env = static_cast<media_m96::test::VideoEncoderTestEnvironment*>(
