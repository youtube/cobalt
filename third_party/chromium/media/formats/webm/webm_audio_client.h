...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FORMATS_WEBM_WEBM_AUDIO_CLIENT_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FORMATS_WEBM_WEBM_AUDIO_CLIENT_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FORMATS_WEBM_WEBM_AUDIO_CLIENT_H_
