...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_VAAPI_VAAPI_JPEG_ENCODER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_VAAPI_VAAPI_JPEG_ENCODER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_VAAPI_VAAPI_JPEG_ENCODER_H_
