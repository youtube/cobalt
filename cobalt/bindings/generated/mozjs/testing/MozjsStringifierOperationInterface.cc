...
InterfaceData* CreateCachedInterfaceData() {
  ...
  instance_class->name = "MozjsStringifierOperationInterface";
  ...
  prototype_class->name = "MozjsStringifierOperationInterfacePrototype";
  ...
  interface_object_class->name = "MozjsStringifierOperationInterfaceConstructor";
...
JSBool fcn_theStringifierOperation(
  ...
  StringifierOperationInterface* impl =
      WrapperPrivate::GetWrappable<StringifierOperationInterface>(object);
...
// static
JSObject* MozjsStringifierOperationInterface::CreateInstance(
