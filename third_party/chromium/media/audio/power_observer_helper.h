...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_POWER_OBSERVER_HELPER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_POWER_OBSERVER_HELPER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_POWER_OBSERVER_HELPER_H_
