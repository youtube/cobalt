...
#include "third_party/chromium/media/capture/video/file_video_capture_device.h"
#include "third_party/chromium/media/capture/video/mock_video_capture_device_client.h"
