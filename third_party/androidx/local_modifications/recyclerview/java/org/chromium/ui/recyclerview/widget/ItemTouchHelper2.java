...
import static androidx.recyclerview.widget.ItemTouchHelper.ANIMATION_TYPE_SWIPE_SUCCESS;
 ...
 *
 * <p>Depending on which functionality you support, you should override {@link
 * Callback#onMove(RecyclerView, ViewHolder, ViewHolder)} and / or {@link
 * Callback#onSwiped(ViewHolder, int)}.
 *
 * <p>This class is designed to work with any LayoutManager but for certain situations, it can be
 * optimized for your custom LayoutManager by extending methods in the {@link
 * ItemTouchHelper.Callback} class or implementing {@link ItemTouchHelper.ViewDropHandler} interface
 * in your LayoutManager.
 *
 * <p>By default, ItemTouchHelper moves the items' translateX/Y properties to reposition them. You
 * can customize these behaviors by overriding {@link Callback#onChildDraw(Canvas, RecyclerView,
 * ViewHolder, float, float, int, boolean)} or {@link Callback#onChildDrawOver(Canvas, RecyclerView,
 * ViewHolder, float, float, int, boolean)}.
 *
 * <p>Most of the time you only need to override <code>onChildDraw</code>.
 */
public class ItemTouchHelper2 extends RecyclerView.ItemDecoration
    ...
    /**
     * Views, whose state should be cleared after they are detached from RecyclerView. This is
     * necessary after swipe dismissing an item. We wait until animator finishes its job to clean
     * these views.
     */
    ...
    /**
     * The reference coordinates for the action start. For drag & drop, this is the time long press
     * is completed vs for swipe, this is the initial touch point.
     */
    ...
    /**
     * The coordinates of the selected view at the time it is selected. We record these values when
     * action starts so that we can consistently position it even if LayoutManager moves the View.
     */
    ...
    /**
     * The direction flags obtained from unmasking {@link
     * Callback#getAbsoluteMovementFlags(RecyclerView, ViewHolder)} for the current action state.
     */
    @SuppressWarnings("WeakerAccess") /* synthetic access */
    int mSelectedFlags;
     ...
     * framework Animators. Using framework animators has the side effect of clashing with
     * ItemAnimator, creating jumpy UIs.
     */
    @VisibleForTesting List<RecoverAnimation> mRecoverAnimations = new ArrayList<>();
    ...
    /**
     * When user drags a view to the edge, we start scrolling the LayoutManager as long as View is
     ...
     * until view reaches its final position (end of recover animation), we keep a reference so that
     * it can be drawn above other children.
     */
    @SuppressWarnings("WeakerAccess") /* synthetic access */
    View mOverdrawChild;
     ...
     *
     * <p>You can attach ItemTouchHelper to a RecyclerView via {@link
    ...
    /**
     * Attaches the ItemTouchHelper to the provided RecyclerView. If TouchHelper is already attached
     * to a RecyclerView, it will first detach from the previous one. You can call this method with
     * {@code null} to detach it from the current RecyclerView.
     *
     * @param recyclerView The RecyclerView instance to which you want to add this helper or {@code
     *     null} if you want to remove ItemTouchHelper from the current RecyclerView.
     */
    ...
    private void startGestureDetection() {
        ...
        mGestureDetector =
                new GestureDetector(mRecyclerView.getContext(), mItemTouchHelperGestureListener);
    }
    ...
    public void onDrawOver(
            @NonNull Canvas c, @NonNull RecyclerView parent, RecyclerView.@NonNull State state) {
        float dx = 0;
        float dy = 0;
        if (mSelected != null) {
    ...
    @Override
    @SuppressLint("UnknownNullness") // crbug.com/240775049: Cannot annotate properly
    ...
    void select(@Nullable ViewHolder selected, int actionState) {
        ...
        if (mSelected != null) {
            ...
            if (prevSelected.itemView.getParent() != null) {
                        ...
                        new RecoverAnimation(
                            ...
                            public void onAnimationEnd(Animator animation) {
                                ...
                                if (swipeDir <= 0) {
                                    ...
                                    if (swipeDir > 0) {
                                        // Animation might be ended by other animators during a
                                        // layout.
                                        // We defer callback to avoid editing adapter during a
                                        // layout.
                ...
                final long duration =
                        mCallback.getAnimationDuration(
                                mRecyclerView,
                                animationType,
                ...
                new Runnable() {
                    ...
                    public void run() {
                        if (mRecyclerView != null
                            ...
                            // if animator is running or we have other active recover animations, we
                            // try
                            // not to call onSwiped because DefaultItemAnimator is not good at
                            // merging
    ...
    boolean scrollIfNecessary() {
        ...
        if (lm.canScrollVertically()) {
            ...
            if (mDy < 0 && topDiff < 0) {
                ...
                final int bottomDiff =
                        curY
                                + mSelected.itemView.getHeight()
                                + mTmpRect.bottom
    ...
    void checkSelectForSwipe(int action, MotionEvent motionEvent, int pointerIndex) {
        ...
        final int swipeFlags =
                (movementFlags & ACTION_MODE_SWIPE_MASK)
     ...
     * View is long pressed. You can disable that behavior by overriding {@link
     * ItemTouchHelper.Callback#isLongPressDragEnabled()}.
     *
     * <p>For this method to work:
     *
     * <ul>
     *   <li>The provided ViewHolder must be a child of the RecyclerView to which this
     *       ItemTouchHelper is attached.
     *   <li>{@link ItemTouchHelper.Callback} must have dragging enabled.
     *   <li>There must be a previous touch event that was reported to the ItemTouchHelper through
     *       RecyclerView's ItemTouchListener mechanism. As long as no other ItemTouchListener grabs
     *       previous events, this should work as expected.
     * </ul>
     *
     * For example, if you would like to let your user to be able to drag an Item by touching one of
     * its descendants, you may implement it as follows:
     *
     * <pre>
     ...
     * when user swipes their finger (or mouse pointer) over the View. You can disable this behavior
     ...
     *   <li>The provided ViewHolder must be a child of the RecyclerView to which this
     *       ItemTouchHelper is attached.
     *   <li>{@link ItemTouchHelper.Callback} must have swiping enabled.
     *   <li>There must be a previous touch event that was reported to the ItemTouchHelper through
     *       RecyclerView's ItemTouchListener mechanism. As long as no other ItemTouchListener grabs
     *       previous events, this should work as expected.
     * </ul>
    ...
    private int swipeIfNecessary(ViewHolder viewHolder) {
        ...
        final int absoluteMovementFlags =
                mCallback.convertToAbsoluteDirection(
                        originalMovementFlags, mRecyclerView.getLayoutDirection());
        final int flags =
                (absoluteMovementFlags & ACTION_MODE_SWIPE_MASK)
                        >> (ACTION_STATE_SWIPE * DIRECTION_FLAG_COUNT);
        if (flags == 0) {
            return 0;
        }
        final int originalFlags =
                (originalMovementFlags & ACTION_MODE_SWIPE_MASK)
                        >> (ACTION_STATE_SWIPE * DIRECTION_FLAG_COUNT);
        int swipeDir;
        if (Math.abs(mDx) > Math.abs(mDy)) {
            if ((swipeDir = checkHorizontalSwipe(viewHolder, flags)) > 0) {
                ...
                if ((originalFlags & swipeDir) == 0) {
                    // convert to relative
                    return Callback.convertToRelativeDirection(
                            swipeDir, mRecyclerView.getLayoutDirection());
                }
                return swipeDir;
            }
        ...
        if ((flags & (LEFT | RIGHT)) != 0) {
            ...
            if (mVelocityTracker != null && mActivePointerId > -1) {
                mVelocityTracker.computeCurrentVelocity(
                        PIXELS_PER_SECOND, mCallback.getSwipeVelocityThreshold(mMaxSwipeVelocity));
            ...
            final float threshold =
                    mRecyclerView.getWidth() * mCallback.getSwipeThreshold(viewHolder);
    ...
    private int checkVerticalSwipe(ViewHolder viewHolder, int flags) {
        if ((flags & (UP | DOWN)) != 0) {
            ...
            final float threshold =
                    mRecyclerView.getHeight() * mCallback.getSwipeThreshold(viewHolder);
     ...
     *
     * <p>To control which actions user can take on each view, you should override {@link
     * #getMovementFlags(RecyclerView, ViewHolder)} and return appropriate set of direction flags.
     * ({@link #LEFT}, {@link #RIGHT}, {@link #START}, {@link #END}, {@link #UP}, {@link #DOWN}).
     * You can use {@link #makeMovementFlags(int, int)} to easily construct it. Alternatively, you
     * can use {@link SimpleCallback}.
     *
     * <p>If user drags an item, ItemTouchHelper will call {@link Callback#onMove(RecyclerView,
     * ViewHolder, ViewHolder) onMove(recyclerView, dragged, target)}. Upon receiving this callback,
     * you should move the item from the old position ({@code dragged.getAdapterPosition()}) to new
     * position ({@code target.getAdapterPosition()}) in your adapter and also call {@link
     * RecyclerView.Adapter#notifyItemMoved(int, int)}. To control where a View can be dropped, you
     * can override {@link #canDropOver(RecyclerView, ViewHolder, ViewHolder)}. When a dragging View
     * overlaps multiple other views, Callback chooses the closest View with which dragged View
     * might have changed positions. Although this approach works for many use cases, if you have a
     * custom LayoutManager, you can override {@link #chooseDropTarget(ViewHolder, java.util.List,
     * int, int)} to select a custom drop target.
     *
     * <p>When a View is swiped, ItemTouchHelper animates it until it goes out of bounds, then calls
     * {@link #onSwiped(ViewHolder, int)}. At this point, you should update your adapter (e.g.
     * remove the item) and call related Adapter#notify event.
     */
    ...
    public abstract static class Callback {
         ...
         *
         * <p>By default, {@link Callback} applies these changes on {@link
         * RecyclerView.ViewHolder#itemView}.
         *
         * <p>For example, if you have a use case where you only want the text to move when user
        ...
        public static @NonNull ItemTouchUIUtil getDefaultUIUtil() {
            return ItemTouchUIUtilImpl2.INSTANCE;
        }
         ...
         * @param layoutDirection The layout direction of the View. Can be obtained from {@link
         *     ViewCompat#getLayoutDirection(android.view.View)}.
         * @return Updated flags which uses relative flags ({@link #START}, {@link #END}) instead of
         ...
         *
         * <p>For instance, if you want to let your items be drag & dropped vertically and swiped
         * left to be dismissed, you can call this method with: <code>
         * makeMovementFlags(UP | DOWN, LEFT);</code>
         *
         ...
         *
         * @param actionState The action state you want to get flags in. Should be one of {@link
         *     #ACTION_STATE_IDLE}, {@link #ACTION_STATE_SWIPE} or {@link #ACTION_STATE_DRAG}.
         ...
         *
         * <p>Instead of composing this flag manually, you can use {@link #makeMovementFlags(int,
         * int)} or {@link #makeFlag(int, int)}.
         *
         * <p>This flag is composed of 3 sets of 8 bits, where first 8 bits are for IDLE state, next
         * 8 bits are for SWIPE state and third 8 bits are for DRAG state. Each 8 bit sections can
         * be constructed by simply OR'ing direction flags defined in {@link ItemTouchHelper}.
         *
         * <p>For example, if you want it to allow swiping LEFT and RIGHT but only allow starting to
         ...
         *
         * <p>This method is used when selecting drop target for the dragged View. After Views are
         ...
         * new position.
         *
         * <p>If this method returns true, ItemTouchHelper assumes {@code viewHolder} has been moved
         * to the adapter position of {@code target} ViewHolder ({@link
         * ViewHolder#getAbsoluteAdapterPosition() ViewHolder#getAdapterPositionInRecyclerView()}).
         *
         * <p>If you don't support drag & drop, this method will never be called.
         *
         * @param recyclerView The RecyclerView to which ItemTouchHelper is attached to.
         * @param viewHolder The ViewHolder which is being dragged by the user.
         * @param target The ViewHolder over which the currently active item is being dragged.
         * @return True if the {@code viewHolder} has been moved to the adapter position of {@code
         *     target}.
         ...
         * pressed.
         *
         * <p>Default value returns true but you may want to disable this if you want to start
        ...
        /**
         * Returns the fraction that the user should move the View to be considered as swiped. The
         * fraction is calculated with respect to RecyclerView's bounds.
         *
         * <p>Default value is .5f, which means, to swipe a View, user must move the View at least
         ...
         *
         * <p>You can increase this value to make it harder to swipe or decrease it to make it
         * easier. Keep in mind that ItemTouchHelper also checks the perpendicular velocity and
         * makes sure current direction velocity is larger then the perpendicular one. Otherwise,
         * user's movement is ambiguous. You can change the threshold by overriding {@link
         * #getSwipeVelocityThreshold(float)}.
         *
         * <p>The velocity is calculated in pixels per second.
         *
         * <p>The default framework value is passed as a parameter so that you can modify it with a
         * multiplier.
         *
         * @param defaultValue The default value (in pixels per second) used by the ItemTouchHelper.
         * @return The minimum swipe velocity. The default implementation returns the <code>
         ...
         *
         * <p>To consider a movement as swipe, ItemTouchHelper requires it to be larger than the
         ...
         * <p>The velocity is calculated in pixels per second.
         *
         * <p>You can customize this behavior by changing this method. If you increase the value, it
        ...
        /**
         * Called by ItemTouchHelper to select a drop target from the list of ViewHolders that are
         * under the dragged View.
         *
         * <p>Default implementation filters the View with which dragged item have changed position
         * in the drag direction. For instance, if the view is dragged UP, it compares the <code>
         * view.getTop()</code> of the two views before and after drag started. If that value is
         * different, the target view passes the filter.
         *
         * <p>Among these Views which pass the test, the one closest to the dragged view is chosen.
         *
         * <p>This method is called on the main thread every time user moves the View. If you want
         * to override it, make sure it does not do any expensive operations.
         *
         * @param selected The ViewHolder being dragged by the user.
         * @param dropTargets The list of ViewHolder that are under the dragged View and candidate
         *     as a drop.
         * @param curX The updated left value of the dragged View after drag translations are
         *     applied. This value does not include margins added by {@link
         *     RecyclerView.ItemDecoration}s.
         * @param curY The updated top value of the dragged View after drag translations are
         *     applied. This value does not include margins added by {@link
         *     RecyclerView.ItemDecoration}s.
        ...
        @SuppressWarnings("WeakerAccess")
        @SuppressLint("UnknownNullness") // crbug.com/240775049: Cannot annotate properly
        public ViewHolder chooseDropTarget(
                @NonNull ViewHolder selected,
         ...
         *
         * <p>If you are returning relative directions ({@link #START} , {@link #END}) from the
         * {@link #getMovementFlags(RecyclerView, ViewHolder)} method, this method will also use
         * relative directions. Otherwise, it will use absolute directions.
         *
         * <p>If you don't support swiping, this method will never be called.
         *
         * <p>ItemTouchHelper will keep a reference to the View until it is detached from
         * RecyclerView. As soon as it is detached, ItemTouchHelper will call {@link
         * #clearView(RecyclerView, ViewHolder)}.
         *
         * @param viewHolder The ViewHolder which has been swiped by the user.
         * @param direction The direction to which the ViewHolder is swiped. It is one of {@link
         *     #UP}, {@link #DOWN}, {@link #LEFT} or {@link #RIGHT}. If your {@link
         *     #getMovementFlags(RecyclerView, ViewHolder)} method returned relative flags instead
         *     of {@link #LEFT} / {@link #RIGHT}; `direction` will be relative as well. ({@link
         *     #START} or {@link #END}).
         */
         ...
         *
         * <p>If you override this method, you should call super.
         *
         ...
         *     ItemTouchHelper#ACTION_STATE_SWIPE} or {@link ItemTouchHelper#ACTION_STATE_DRAG}.
         * @see #clearView(RecyclerView, RecyclerView.ViewHolder)
         */
        public void onSelectedChanged(@Nullable ViewHolder viewHolder, int actionState) {
            if (viewHolder != null) {
                ItemTouchUIUtilImpl2.INSTANCE.onSelected(viewHolder.itemView);
            }
        }
         ...
         *
         * <p>ItemTouchHelper does not create an extra Bitmap or View while dragging, instead, it
         * modifies the existing View. Because of this reason, it is important that the View is
         * still part of the layout after it is moved. This may not work as intended when swapped
         * Views are close to RecyclerView bounds or there are gaps between them (e.g. other Views
         * which were not eligible for dropping over).
         *
         * <p>This method is responsible to give necessary hint to the LayoutManager so that it will
         ...
         *
         * <p>Default implementation calls {@link RecyclerView#scrollToPosition(int)} if the View's
         * new position is likely to be out of bounds.
         *
         * <p>It is important to ensure the ViewHolder will stay visible as otherwise, it might be
         * removed by the LayoutManager if the move causes the View to go out of bounds. In that
         * case, drag will end prematurely.
         *
         * @param recyclerView The RecyclerView controlled by the ItemTouchHelper.
         * @param viewHolder The ViewHolder under user's control.
         * @param fromPos The previous adapter position of the dragged item (before it was moved).
         * @param target The ViewHolder on which the currently active item has been dropped.
         * @param toPos The new adapter position of the dragged item.
         * @param x The updated left value of the dragged View after drag translations are applied.
         *     This value does not include margins added by {@link RecyclerView.ItemDecoration}s.
         * @param y The updated top value of the dragged View after drag translations are applied.
         *     This value does not include margins added by {@link RecyclerView.ItemDecoration}s.
         */
        public void onMoved(
                final @NonNull RecyclerView recyclerView,
                final @NonNull ViewHolder viewHolder,
                int fromPos,
                final @NonNull ViewHolder target,
                int toPos,
                int x,
                int y) {
            final RecyclerView.LayoutManager layoutManager = recyclerView.getLayoutManager();
            if (layoutManager instanceof ViewDropHandler) {
                ((ViewDropHandler) layoutManager)
                        .prepareForDrop(viewHolder.itemView, target.itemView, x, y);
                return;
            }
        ...
        void onDraw(
                ...
                RecyclerView parent,
                ViewHolder selected,
                List<ItemTouchHelper2.RecoverAnimation> recoverAnimationList,
                int actionState,
                float dX,
                float dY) {
            ...
            for (int i = 0; i < recoverAnimSize; i++) {
                ...
                onChildDraw(
                        c, parent, anim.mViewHolder, anim.mX, anim.mY, anim.mActionState, false);
         ...
         *
         * <p>This is a good place to clear all changes on the View that was done in {@link
         * #onSelectedChanged(RecyclerView.ViewHolder, int)}, {@link #onChildDraw(Canvas,
         * RecyclerView, ViewHolder, float, float, int, boolean)} or {@link #onChildDrawOver(Canvas,
         ...
         *
         * <p>If you would like to customize how your View's respond to user interactions, this is a
         * good place to override.
         *
         * <p>Default implementation translates the child by the given <code>dX</code>, <code>dY
         * </code>. ItemTouchHelper also takes care of drawing the child after other children if it
         * is being dragged. This is done using child re-ordering mechanism. On platforms prior to
         * L, this is achieved via {@link android.view.ViewGroup#getChildDrawingOrder(int, int)} and
         * on L and after, it changes View's elevation value to be greater than all other children.)
         *
        ...
        public void onChildDraw(
                ...
                int actionState,
                boolean isCurrentlyActive) {
            ItemTouchUIUtilImpl2.INSTANCE.onDraw(
                    c, recyclerView, viewHolder.itemView, dX, dY, actionState, isCurrentlyActive);
        }
        ...
        public void onChildDrawOver(
                ...
                int actionState,
                boolean isCurrentlyActive) {
            ItemTouchUIUtilImpl2.INSTANCE.onDrawOver(
                    c, recyclerView, viewHolder.itemView, dX, dY, actionState, isCurrentlyActive);
        }
         ...
         *
         * <p>Default implementation uses ItemAnimator's duration values. If <code>animationType
         * </code> is {@link #ANIMATION_TYPE_DRAG}, it returns {@link
         * RecyclerView.ItemAnimator#getMoveDuration()}, otherwise, it returns {@link
         ...
         *     {@link #ANIMATION_TYPE_SWIPE_CANCEL} or {@link #ANIMATION_TYPE_SWIPE_SUCCESS}.
         ...
         *
         * <p>You can override this method to decide how much RecyclerView should scroll in response
         * to this action. Default implementation calculates a value based on the amount of View out
         * of bounds and the time it spent there. The longer user keeps the View out of bounds, the
         * faster the list will scroll. Similarly, the larger portion of the View is out of bounds,
         * the faster the RecyclerView will scroll.
         *
         * @param recyclerView The RecyclerView instance to which ItemTouchHelper is attached to.
         * @param viewSize The total size of the View in scroll direction, excluding item
         *     decorations.
         ...
         * @return The amount that RecyclerView should scroll. Keep in mind that this value will be
         *     passed to {@link RecyclerView#scrollBy(int, int)} method.
         */
        @SuppressWarnings("WeakerAccess")
        public int interpolateOutOfBoundsScroll(
            ...
            final int value =
                    (int) (cappedScroll * sDragScrollInterpolator.getInterpolation(timeRatio));
            if (value == 0) {
     ...
     * directions and this class will handle the flag callbacks. You should still override onMove or
    ...
    public abstract static class SimpleCallback extends Callback {
        ...
        /**
         * Returns the swipe directions for the provided ViewHolder. Default implementation returns
         * the swipe directions that was set via constructor or {@link #setDefaultSwipeDirs(int)}.
         *
         * @param recyclerView The RecyclerView to which the ItemTouchHelper is attached to.
        ...
        public int getSwipeDirs(
                @SuppressWarnings("unused") @NonNull RecyclerView recyclerView,
                @SuppressWarnings("unused") @NonNull ViewHolder viewHolder) {
            return mDefaultSwipeDirs;
        }

        /**
         * Returns the drag directions for the provided ViewHolder. Default implementation returns
         * the drag directions that was set via constructor or {@link #setDefaultDragDirs(int)}.
         *
         * @param recyclerView The RecyclerView to which the ItemTouchHelper is attached to.
         * @param viewHolder The ViewHolder for which the swipe direction is queried.
         * @return A binary OR of direction flags.
        ...
        public int getMovementFlags(
            ...
            return makeMovementFlags(
                    getDragDirs(recyclerView, viewHolder), getSwipeDirs(recyclerView, viewHolder));
        }
    }
    ...
    private class ItemTouchHelperGestureListener extends GestureDetector.SimpleOnGestureListener {
         ...
         * ItemTouchHelperGestureListener#onLongPress(MotionEvent)}.
         *
         ...
         * ItemTouchHelperGestureListener#onLongPress(MotionEvent)} being called.
         */
        ...
        public void onLongPress(MotionEvent e) {
            ...
            if (mExternalLongPressHandler == null
                    || !mExternalLongPressHandler.handleLongPress(e)) {
                onLongPressInternal(e);
            }
        }

        private void onLongPressInternal(MotionEvent e) {
    ...
    static class RecoverAnimation implements Animator.AnimatorListener {
        ...
        @VisibleForTesting final ValueAnimator mValueAnimator;
        ...
        /**
         * We run updates on onDraw method but use the fraction from animator callback. This way, we
         * can sync translate x/y values w/ the animators to avoid one-off frames.
         */
        public void update() {
     ...
     *     externally.
     */
    public ItemTouchHelper2(@NonNull Callback callback, LongPressHandler externalLongPressHandler) {
        this(callback);
    ...
    public void onExternalDragStart(float x, float y, boolean hideItemWhileDragging) {
        if (!mExternalDragInProgress) {
            ...
            mItemTouchHelperGestureListener.onLongPressInternal(tmpEvent);
            tmpEvent.recycle();
