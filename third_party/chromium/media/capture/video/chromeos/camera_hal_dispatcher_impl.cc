...
bool CameraHalDispatcherImpl::Start(
...

  {
    ...
    if (command_line->HasSwitch(media_m96::switches::kForceControlFaceAe)) {
      if (command_line->GetSwitchValueASCII(
              media_m96::switches::kForceControlFaceAe) == "enable") {
...

  {
    ...
    const base::CommandLine* command_line =
        base::CommandLine::ForCurrentProcess();
    if (command_line->HasSwitch(media_m96::switches::kHdrNetOverride)) {
      std::string value =
