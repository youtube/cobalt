...
JSC::HashTable JSCCallbackInterfaceInterface::InterfaceObject::property_table = {
...
};  // JSCCallbackInterfaceInterface::InterfaceObject::property_table
...
JSC::HashTable JSCCallbackInterfaceInterface::Prototype::property_table = {
    10,  // compactSize
    7,  // compactSizeMask
    property_table_values,
    NULL  // table allocated at runtime
};  // JSCCallbackInterfaceInterface::Prototype::property_table
...
JSC::HashTable JSCCallbackInterfaceInterface::property_table = {
    4,  // compactSize
    3,  // compactSizeMask
    property_table_values,
    NULL  // table allocated at runtime
};  // JSCCallbackInterfaceInterface::property_table
...
bool JSCCallbackInterfaceInterface::getOwnPropertySlot(JSC::JSCell* cell,
    JSC::ExecState* exec, JSC::PropertyName property_name,
    JSC::PropertySlot& slot) {
  TRACE_EVENT1("JSCCallbackInterfaceInterface", "getOwnPropertySlot", "property",
...
void JSCCallbackInterfaceInterface::put(JSC::JSCell* cell, JSC::ExecState* exec,
    JSC::PropertyName property_name, JSC::JSValue value,
    JSC::PutPropertySlot& slot) {
  TRACE_EVENT1("JSCCallbackInterfaceInterface", "put", "property",
               TRACE_STR_COPY(WTF::String(property_name.publicName()).utf8().data()));
  JSCCallbackInterfaceInterface* this_object = JSC::jsCast<JSCCallbackInterfaceInterface*>(cell);
  ASSERT_GC_OBJECT_INHERITS(this_object, &s_info);
...
void setJScallbackAttribute(
  ...
  JSCCallbackInterfaceHolder<SingleOperationInterface> cobalt_value;
...
JSC::EncodedJSValue functionJSregisterCallback(
  ...
  JSCCallbackInterfaceHolder<SingleOperationInterface> callback_interface;
