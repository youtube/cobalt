...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CDM_OUTPUT_PROTECTION_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CDM_OUTPUT_PROTECTION_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CDM_OUTPUT_PROTECTION_H_
