...
#ifndef INTERNAL_STARBOARD_SHARED_UIKIT_APPLICATION_DRM_SYSTEM_H_
#define INTERNAL_STARBOARD_SHARED_UIKIT_APPLICATION_DRM_SYSTEM_H_
...
#endif  // INTERNAL_STARBOARD_SHARED_UIKIT_APPLICATION_DRM_SYSTEM_H_
