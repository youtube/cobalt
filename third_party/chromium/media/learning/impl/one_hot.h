...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_IMPL_ONE_HOT_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_IMPL_ONE_HOT_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_IMPL_ONE_HOT_H_
