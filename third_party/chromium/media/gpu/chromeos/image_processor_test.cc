...
media_m96::test::VideoTestEnvironment* g_env;
...
int main(int argc, char** argv) {
  ...
  auto* const test_environment = new media_m96::test::VideoTestEnvironment;
  media_m96::g_env = reinterpret_cast<media_m96::test::VideoTestEnvironment*>(
