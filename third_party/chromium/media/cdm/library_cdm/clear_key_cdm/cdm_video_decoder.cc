...
#include "third_party/chromium/media/cdm/library_cdm/clear_key_cdm/cdm_video_decoder.h"
...
// Necessary to convert async media_m96::VideoDecoder to sync CdmVideoDecoder.
...
#include "third_party/chromium/media/cdm/cdm_type_conversion.h"
#include "third_party/chromium/media/cdm/library_cdm/cdm_host_proxy.h"
...
media_m96::VideoDecoderConfig ToClearMediaVideoDecoderConfig(
...
// Adapts a media_m96::VideoDecoder to a CdmVideoDecoder. Media VideoDecoders
...
// media_m96::VideoDecoder, we need to run a RunLoop manually and wait for the
...
std::unique_ptr<CdmVideoDecoder> CreateVideoDecoder(
  ...
  static base::NoDestructor<media_m96::NullMediaLog> null_media_log;
  std::unique_ptr<VideoDecoder> video_decoder;
