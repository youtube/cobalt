...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_CAPTURER_SOURCE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_CAPTURER_SOURCE_H_
...
class CAPTURE_EXPORT VideoCapturerSource {
 public:
  ...
  // some capturers that listen to media_m96::VideoCaptureFeedback. However, because
  ...
  using VideoCaptureDeliverFrameCB = base::RepeatingCallback<void(
      ...
      std::vector<scoped_refptr<media_m96::VideoFrame>> scaled_video_frames,
      base::TimeTicks estimated_capture_time)>;

  using VideoCaptureDeviceFormatsCB =
      base::OnceCallback<void(const media_m96::VideoCaptureFormats&)>;
  ...
  virtual media_m96::VideoCaptureFeedbackCB GetFeedbackCallback() const;
  ...
  virtual void OnFrameDropped(media_m96::VideoCaptureFrameDropReason reason) {}
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_CAPTURER_SOURCE_H_
