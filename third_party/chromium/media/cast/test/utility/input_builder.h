...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_TEST_UTILITY_INPUT_BUILDER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_TEST_UTILITY_INPUT_BUILDER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_TEST_UTILITY_INPUT_BUILDER_H_
