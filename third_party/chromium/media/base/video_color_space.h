...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_VIDEO_COLOR_SPACE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_VIDEO_COLOR_SPACE_H_
...
class MEDIA_EXPORT VideoColorSpace {
 public:
  ...
  enum class TransferID : uint8_t {
    ...
    HLG = 18,  // AKA hybrid-log gamma, HLG.
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_VIDEO_COLOR_SPACE_H_
