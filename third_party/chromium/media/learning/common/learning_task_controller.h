...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_COMMON_LEARNING_TASK_CONTROLLER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_COMMON_LEARNING_TASK_CONTROLLER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_COMMON_LEARNING_TASK_CONTROLLER_H_
