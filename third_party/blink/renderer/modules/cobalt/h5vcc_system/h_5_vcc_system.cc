...
// TODO(b/385357645): consider also implementing |window.minimize()| and
//     |window.close()| for backwards compatibility until those usages can be
//     replaced with calls to |window.h5vcc.system.exit()|.
