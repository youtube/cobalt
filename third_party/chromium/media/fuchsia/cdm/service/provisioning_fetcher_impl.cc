...
fidl::InterfaceHandle<fuchsia::media_m96::drm::ProvisioningFetcher>
...
void ProvisioningFetcherImpl::Fetch(
    fuchsia::media_m96::drm::ProvisioningRequest request,
...
void ProvisioningFetcherImpl::OnRetrieveComplete(FetchCallback callback,
  ...
  fuchsia::media_m96::drm::ProvisioningResponse provision_response;
