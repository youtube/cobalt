...
// A spectrum of thread priorities. Platforms should map them appropriately to
// their own priority system.
typedef enum SbThreadPriority {
  kSbThreadPriorityLowest = -2,
  kSbThreadPriorityLow = -1,
  kSbThreadPriorityNormal = 0,
  kSbThreadPriorityHigh = 1,
  kSbThreadPriorityHighest = 2,

  // Well-defined constant value to mean "no priority."
