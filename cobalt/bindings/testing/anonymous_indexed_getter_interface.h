...
#ifndef BINDINGS_TESTING_ANONYMOUS_INDEXED_GETTER_INTERFACE_H_
#define BINDINGS_TESTING_ANONYMOUS_INDEXED_GETTER_INTERFACE_H_
...
#endif  // BINDINGS_TESTING_ANONYMOUS_INDEXED_GETTER_INTERFACE_H_
