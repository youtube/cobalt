...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_KEY_SYSTEM_PROPERTIES_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_KEY_SYSTEM_PROPERTIES_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_KEY_SYSTEM_PROPERTIES_H_
