...
JSC::HashTable JSCNullableTypesTestInterface::InterfaceObject::property_table = {
...
};  // JSCNullableTypesTestInterface::InterfaceObject::property_table
...
JSC::HashTable JSCNullableTypesTestInterface::Prototype::property_table = {
    40,  // compactSize
    31,  // compactSizeMask
    property_table_values,
    NULL  // table allocated at runtime
};  // JSCNullableTypesTestInterface::Prototype::property_table
...
JSC::HashTable JSCNullableTypesTestInterface::property_table = {
    19,  // compactSize
    15,  // compactSizeMask
    property_table_values,
    NULL  // table allocated at runtime
};  // JSCNullableTypesTestInterface::property_table
...
bool JSCNullableTypesTestInterface::getOwnPropertySlot(JSC::JSCell* cell,
    JSC::ExecState* exec, JSC::PropertyName property_name,
    JSC::PropertySlot& slot) {
  TRACE_EVENT1("JSCNullableTypesTestInterface", "getOwnPropertySlot", "property",
...
void JSCNullableTypesTestInterface::put(JSC::JSCell* cell, JSC::ExecState* exec,
    JSC::PropertyName property_name, JSC::JSValue value,
    JSC::PutPropertySlot& slot) {
  TRACE_EVENT1("JSCNullableTypesTestInterface", "put", "property",
               TRACE_STR_COPY(WTF::String(property_name.publicName()).utf8().data()));
  JSCNullableTypesTestInterface* this_object = JSC::jsCast<JSCNullableTypesTestInterface*>(cell);
  ASSERT_GC_OBJECT_INHERITS(this_object, &s_info);
...
void setJSnullableBooleanProperty(
  ...
  base::optional<bool > cobalt_value;
...
void setJSnullableNumericProperty(
  ...
  base::optional<int32_t > cobalt_value;
  FromJSValue(exec_state, value,
      (kConversionFlagNullable), &exception_state,
      &cobalt_value);
  if (exception_state.is_exception_set()) {
...
void setJSnullableStringProperty(
  ...
  base::optional<std::string > cobalt_value;
  FromJSValue(exec_state, value,
      (kConversionFlagNullable), &exception_state,
      &cobalt_value);
  if (exception_state.is_exception_set()) {
...
void setJSnullableObjectProperty(
  ...
  scoped_refptr<ArbitraryInterface> cobalt_value;
  FromJSValue(exec_state, value,
      (kConversionFlagNullable), &exception_state,
      &cobalt_value);
  if (exception_state.is_exception_set()) {
...
JSC::EncodedJSValue functionJSnullableBooleanOperation(
  ...
  base::optional<bool > return_value = impl->NullableBooleanOperation();
...
JSC::EncodedJSValue functionJSnullableNumericOperation(
  ...
  base::optional<int32_t > return_value = impl->NullableNumericOperation();
  return JSC::JSValue::encode(ToJSValue(global_object, return_value));
...
JSC::EncodedJSValue functionJSnullableObjectArgument(
  ...
  // Non-optional arguments
  scoped_refptr<ArbitraryInterface> arg;
...
JSC::EncodedJSValue functionJSnullableObjectOperation(
  ...
  scoped_refptr<ArbitraryInterface> return_value = impl->NullableObjectOperation();
  return JSC::JSValue::encode(ToJSValue(global_object, return_value));
...
JSC::EncodedJSValue functionJSnullableStringOperation(
  ...
  base::optional<std::string > return_value = impl->NullableStringOperation();
  return JSC::JSValue::encode(ToJSValue(global_object, return_value));
