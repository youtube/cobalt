  ...
  'targets': [
    ...
    },
    {
      ...
      'sources': [
        ...
        '<(DEPTH)/starboard/shared/alsa/audio_sink_create.cc',
        '<(DEPTH)/starboard/shared/alsa/audio_sink_destroy.cc',
        ...
        '<(DEPTH)/starboard/shared/alsa/audio_sink_internal.cc',
        '<(DEPTH)/starboard/shared/alsa/audio_sink_internal.h',
        ...
        '<(DEPTH)/starboard/shared/ffmpeg/audio_renderer.cc',
        '<(DEPTH)/starboard/shared/ffmpeg/audio_renderer.h',
        '<(DEPTH)/starboard/shared/ffmpeg/player_create.cc',
        '<(DEPTH)/starboard/shared/ffmpeg/player_destroy.cc',
        '<(DEPTH)/starboard/shared/ffmpeg/player_get_info.cc',
        '<(DEPTH)/starboard/shared/ffmpeg/player_internal.cc',
        '<(DEPTH)/starboard/shared/ffmpeg/player_internal.h',
        '<(DEPTH)/starboard/shared/ffmpeg/player_seek.cc',
        '<(DEPTH)/starboard/shared/ffmpeg/player_set_pause.cc',
        '<(DEPTH)/starboard/shared/ffmpeg/player_set_volume.cc',
        '<(DEPTH)/starboard/shared/ffmpeg/player_worker.cc',
        '<(DEPTH)/starboard/shared/ffmpeg/player_worker.h',
        '<(DEPTH)/starboard/shared/ffmpeg/player_write_end_of_stream.cc',
        '<(DEPTH)/starboard/shared/ffmpeg/player_write_sample.cc',
        '<(DEPTH)/starboard/shared/ffmpeg/video_renderer.cc',
        '<(DEPTH)/starboard/shared/ffmpeg/video_renderer.h',
