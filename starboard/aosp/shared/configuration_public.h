...
#ifndef STARBOARD_AOSP_SHARED_CONFIGURATION_PUBLIC_H_
#define STARBOARD_AOSP_SHARED_CONFIGURATION_PUBLIC_H_

#include "starboard/android/shared/configuration_public.h"

#endif  // STARBOARD_AOSP_SHARED_CONFIGURATION_PUBLIC_H_
