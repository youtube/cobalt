...
std::string GetEffectiveAutoplayPolicy(const base::CommandLine& command_line) {
  ...
  if (base::FeatureList::IsEnabled(media_m96::kUnifiedAutoplay))
...
bool IsLiveCaptionFeatureEnabled() {
  if (!base::FeatureList::IsEnabled(media_m96::kLiveCaption))
    return false;
...
#if defined(OS_LINUX)
  if (base::FeatureList::IsEnabled(media_m96::kUseSodaForLiveCaption)) {
