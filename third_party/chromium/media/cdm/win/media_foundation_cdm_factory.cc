...
#include "third_party/chromium/media/cdm/win/media_foundation_cdm_factory.h"
...
#include "third_party/chromium/media/cdm/cdm_paths.h"
#include "third_party/chromium/media/cdm/win/media_foundation_cdm.h"
#include "third_party/chromium/media/cdm/win/media_foundation_cdm_module.h"
...
void MediaFoundationCdmFactory::OnCdmOriginIdObtained(
  ...
  auto bound_cdm_created_cb = base::BindPostTaskToCurrentDefault(std::move(cdm_created_cb));
