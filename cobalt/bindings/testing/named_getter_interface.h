...
#ifndef COBALT_BINDINGS_TESTING_NAMED_GETTER_INTERFACE_H_
#define COBALT_BINDINGS_TESTING_NAMED_GETTER_INTERFACE_H_
...
#endif  // COBALT_BINDINGS_TESTING_NAMED_GETTER_INTERFACE_H_
