...
JSC::HashTable JSCExceptionsInterface::InterfaceObject::property_table = {
...
};  // JSCExceptionsInterface::InterfaceObject::property_table
...
JSC::HashTable JSCExceptionsInterface::Prototype::property_table = {
    9,  // compactSize
    7,  // compactSizeMask
    property_table_values,
    NULL  // table allocated at runtime
};  // JSCExceptionsInterface::Prototype::property_table
...
JSC::HashTable JSCExceptionsInterface::property_table = {
    4,  // compactSize
    3,  // compactSizeMask
    property_table_values,
    NULL  // table allocated at runtime
};  // JSCExceptionsInterface::property_table
...
bool JSCExceptionsInterface::getOwnPropertySlot(JSC::JSCell* cell,
    JSC::ExecState* exec, JSC::PropertyName property_name,
    JSC::PropertySlot& slot) {
  TRACE_EVENT1("JSCExceptionsInterface", "getOwnPropertySlot", "property",
...
void JSCExceptionsInterface::put(JSC::JSCell* cell, JSC::ExecState* exec,
    JSC::PropertyName property_name, JSC::JSValue value,
    JSC::PutPropertySlot& slot) {
  TRACE_EVENT1("JSCExceptionsInterface", "put", "property",
               TRACE_STR_COPY(WTF::String(property_name.publicName()).utf8().data()));
  JSCExceptionsInterface* this_object = JSC::jsCast<JSCExceptionsInterface*>(cell);
  ASSERT_GC_OBJECT_INHERITS(this_object, &s_info);
