...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_SENDER_ENCODED_FRAME_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_SENDER_ENCODED_FRAME_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_SENDER_ENCODED_FRAME_H_
