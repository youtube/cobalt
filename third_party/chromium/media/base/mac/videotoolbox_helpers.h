...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_MAC_VIDEOTOOLBOX_HELPERS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_MAC_VIDEOTOOLBOX_HELPERS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_MAC_VIDEOTOOLBOX_HELPERS_H_
