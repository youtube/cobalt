...
const CobaltMemoryMetricsEmitter::Metric kAllocatorDumpNamesForMetrics[] = {
    ...
    {"malloc/partitions/allocator",
     "Malloc.Allocator.CommittedSize",
     CobaltMemoryMetricsEmitter::MetricSize::kLarge,
     kVirtualCommittedSize,
     CobaltMemoryMetricsEmitter::EmitTo::kSizeInUmaOnly,
     {}},
    {"malloc/partitions/allocator",
     "Malloc.Allocator.Wasted",
     CobaltMemoryMetricsEmitter::MetricSize::kLarge,
     kWasted,
     CobaltMemoryMetricsEmitter::EmitTo::kSizeInUmaOnly,
     {}},
    {"malloc/partitions/allocator",
     "Malloc.Allocator.Fragmentation",
     CobaltMemoryMetricsEmitter::MetricSize::kPercentage,
     kFragmentation,
     CobaltMemoryMetricsEmitter::EmitTo::kSizeInUmaOnly,
     {}},
    ...
    {"malloc/partitions/allocator/scheduler_loop_quarantine",
     "Malloc.SchedulerLoopQuarantine",
     CobaltMemoryMetricsEmitter::MetricSize::kSmall,
     kSizeInBytes,
     CobaltMemoryMetricsEmitter::EmitTo::kSizeInUmaOnly,
     {}},
    ...
    {"partition_alloc/partitions/buffer",
     "PartitionAlloc.Buffer",
     CobaltMemoryMetricsEmitter::MetricSize::kLarge,
     MemoryAllocatorDump::kNameSize,
     CobaltMemoryMetricsEmitter::EmitTo::kSizeInUmaOnly,
     {}},
    {"partition_alloc/partitions/buffer",
     "PartitionAlloc.Buffer.CommittedSize",
     CobaltMemoryMetricsEmitter::MetricSize::kLarge,
     kVirtualCommittedSize,
     CobaltMemoryMetricsEmitter::EmitTo::kSizeInUmaOnly,
     {}},
    {"partition_alloc/partitions/buffer",
     "PartitionAlloc.Buffer.Fragmentation",
     CobaltMemoryMetricsEmitter::MetricSize::kPercentage,
     kFragmentation,
     CobaltMemoryMetricsEmitter::EmitTo::kSizeInUmaOnly,
     {}},
    {"partition_alloc/partitions/array_buffer",
     "PartitionAlloc.ArrayBuffer",
     CobaltMemoryMetricsEmitter::MetricSize::kLarge,
     MemoryAllocatorDump::kNameSize,
     CobaltMemoryMetricsEmitter::EmitTo::kSizeInUmaOnly,
     {}},
    {"partition_alloc/partitions/array_buffer",
     "PartitionAlloc.ArrayBuffer.CommittedSize",
     CobaltMemoryMetricsEmitter::MetricSize::kLarge,
     kVirtualCommittedSize,
     CobaltMemoryMetricsEmitter::EmitTo::kSizeInUmaOnly,
     {}},
    {"partition_alloc/partitions/array_buffer",
     "PartitionAlloc.ArrayBuffer.Fragmentation",
     CobaltMemoryMetricsEmitter::MetricSize::kPercentage,
     kFragmentation,
     CobaltMemoryMetricsEmitter::EmitTo::kSizeInUmaOnly,
     {}},
    {"partition_alloc/partitions/layout",
     ...
     {}},
    {"partition_alloc/partitions/layout",
     "PartitionAlloc.Layout.CommittedSize",
     CobaltMemoryMetricsEmitter::MetricSize::kLarge,
     kVirtualCommittedSize,
     CobaltMemoryMetricsEmitter::EmitTo::kSizeInUmaOnly,
     {}},
    {"partition_alloc/partitions/layout",
     "PartitionAlloc.Layout.Fragmentation",
     CobaltMemoryMetricsEmitter::MetricSize::kPercentage,
     kFragmentation,
     CobaltMemoryMetricsEmitter::EmitTo::kSizeInUmaOnly,
     {}},
  ...
  for (const auto& pmd : global_dump_->process_dumps()) {
    ...
    if (blink_gc_bytes > 0) {
      ...
      static const Metric kBlinkGCFragMetric = {
          ...
          kFragmentation, EmitTo::kSizeInUmaOnly,  {}};
    ...
    if (blink_gc_main_bytes > 0) {
      ...
      static const Metric kBlinkGCMainFragMetric = {
          ...
          MetricSize::kPercentage, kFragmentation,
