...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_FAKE_AUDIO_INPUT_STREAM_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_FAKE_AUDIO_INPUT_STREAM_H_
...
#include "third_party/chromium/media/base/fake_audio_worker.h"
...
class MEDIA_EXPORT FakeAudioInputStream : public AudioInputStream {
 ...
 private:
  ...
  std::unique_ptr<media_m96::AudioBus> audio_bus_;
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_FAKE_AUDIO_INPUT_STREAM_H_
