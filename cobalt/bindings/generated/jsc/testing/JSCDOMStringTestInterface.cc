...
JSC::HashTable JSCDOMStringTestInterface::InterfaceObject::property_table = {
...
};  // JSCDOMStringTestInterface::InterfaceObject::property_table
...
JSC::HashTable JSCDOMStringTestInterface::Prototype::property_table = {
    4,  // compactSize
    3,  // compactSizeMask
    property_table_values,
    NULL  // table allocated at runtime
};  // JSCDOMStringTestInterface::Prototype::property_table
...
JSC::HashTable JSCDOMStringTestInterface::property_table = {
    20,  // compactSize
    15,  // compactSizeMask
    property_table_values,
    NULL  // table allocated at runtime
};  // JSCDOMStringTestInterface::property_table
...
bool JSCDOMStringTestInterface::getOwnPropertySlot(JSC::JSCell* cell,
    JSC::ExecState* exec, JSC::PropertyName property_name,
    JSC::PropertySlot& slot) {
  TRACE_EVENT1("JSCDOMStringTestInterface", "getOwnPropertySlot", "property",
...
void JSCDOMStringTestInterface::put(JSC::JSCell* cell, JSC::ExecState* exec,
    JSC::PropertyName property_name, JSC::JSValue value,
    JSC::PutPropertySlot& slot) {
  TRACE_EVENT1("JSCDOMStringTestInterface", "put", "property",
               TRACE_STR_COPY(WTF::String(property_name.publicName()).utf8().data()));
  JSCDOMStringTestInterface* this_object = JSC::jsCast<JSCDOMStringTestInterface*>(cell);
  ASSERT_GC_OBJECT_INHERITS(this_object, &s_info);
