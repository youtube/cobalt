...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_MAC_SCOPED_AUDIO_UNIT_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_MAC_SCOPED_AUDIO_UNIT_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_MAC_SCOPED_AUDIO_UNIT_H_
