...
This function may be called very frequently from arbitrary threads and is
expected to be inexpensive and thread safe.
...
implementers should take care to avoid related performance concerns with such
frequent calls.
