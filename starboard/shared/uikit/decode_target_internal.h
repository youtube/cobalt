...
#ifndef INTERNAL_STARBOARD_SHARED_UIKIT_DECODE_TARGET_INTERNAL_H_
#define INTERNAL_STARBOARD_SHARED_UIKIT_DECODE_TARGET_INTERNAL_H_
...
#endif  // INTERNAL_STARBOARD_SHARED_UIKIT_DECODE_TARGET_INTERNAL_H_
