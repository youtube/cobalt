...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_CDM_FUCHSIA_STREAM_DECRYPTOR_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_CDM_FUCHSIA_STREAM_DECRYPTOR_H_
...
class MEDIA_EXPORT FuchsiaStreamDecryptor
 ...
 public:
  ...
  explicit FuchsiaStreamDecryptor(fuchsia::media_m96::StreamProcessorPtr processor);
  ...
  // FuchsiaClearStreamDecryptor and media_m96::Decryptor: they report NO_KEY error
 ...
 private:
  ...
  void OnStreamProcessorAllocateOutputBuffers(
      const fuchsia::media_m96::StreamBufferConstraints& stream_constraints) final;
  void OnStreamProcessorEndOfStream() final;
  void OnStreamProcessorOutputFormat(
      fuchsia::media_m96::StreamOutputFormat format) final;
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_CDM_FUCHSIA_STREAM_DECRYPTOR_H_
