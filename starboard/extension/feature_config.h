...
// By default, tunnel mode has to be enabled explicitly by the web app via mime
// attributes "tunnelmode". Set the following variable to true to force enabling
// tunnel mode on all playbacks.
