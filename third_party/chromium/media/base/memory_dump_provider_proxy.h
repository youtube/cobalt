...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEMORY_DUMP_PROVIDER_PROXY_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEMORY_DUMP_PROVIDER_PROXY_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEMORY_DUMP_PROVIDER_PROXY_H_
