 ...
 * new one. The caller still owns layout and is responsible for uninitializing
 * it.
 */
 ...
 *
 * @param val_type Option type corresponding to the type of val, ignored when
 * val is NULL.
 *
...
#define AV_OPT_SERIALIZE_SEARCH_CHILDREN \
  0x00000004  ///< Serialize options in possible children of the given object.
