...
JSC::HashTable JSCBaseInterface::InterfaceObject::property_table = {
...
};  // JSCBaseInterface::InterfaceObject::property_table
...
JSC::HashTable JSCBaseInterface::Prototype::property_table = {
    9,  // compactSize
    7,  // compactSizeMask
    property_table_values,
    NULL  // table allocated at runtime
};  // JSCBaseInterface::Prototype::property_table
...
JSC::HashTable JSCBaseInterface::property_table = {
    4,  // compactSize
    3,  // compactSizeMask
    property_table_values,
    NULL  // table allocated at runtime
};  // JSCBaseInterface::property_table
