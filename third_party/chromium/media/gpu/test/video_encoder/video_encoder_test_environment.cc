...
const std::vector<base::Feature> kEnabledFeaturesForVideoEncoderTest = {
    ...
    media_m96::kVaapiLowPowerEncoderGen9x,
...
VideoEncoderTestEnvironment* VideoEncoderTestEnvironment::Create(
  ...
  auto video =
      std::make_unique<media_m96::test::Video>(video_path, video_metadata_path);
...
media_m96::test::Video* VideoEncoderTestEnvironment::Video() const {
  return video_.get();
}

media_m96::test::Video* VideoEncoderTestEnvironment::GenerateNV12Video() {
  if (!nv12_video_) {
