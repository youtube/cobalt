...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_IMPL_RANDOM_NUMBER_GENERATOR_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_IMPL_RANDOM_NUMBER_GENERATOR_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_IMPL_RANDOM_NUMBER_GENERATOR_H_
