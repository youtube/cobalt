...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_PIPELINE_IMPL_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_PIPELINE_IMPL_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_PIPELINE_IMPL_H_
