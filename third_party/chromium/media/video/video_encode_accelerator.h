...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_VIDEO_ENCODE_ACCELERATOR_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_VIDEO_ENCODE_ACCELERATOR_H_
...
// use the destructor.
template <>
struct MEDIA_EXPORT default_delete<media_m96::VideoEncodeAccelerator> {
  void operator()(media_m96::VideoEncodeAccelerator* vea) const;
};

}  // namespace std

#endif  // THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_VIDEO_ENCODE_ACCELERATOR_H_
