...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_SIMPLE_SOURCES_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_SIMPLE_SOURCES_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_SIMPLE_SOURCES_H_
