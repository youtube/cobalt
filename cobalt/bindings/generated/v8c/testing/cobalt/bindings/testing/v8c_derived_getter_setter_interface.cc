...
void InitializeTemplate(
  ...
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "derivedIndexedGetter"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "derivedIndexedSetter"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "operationOnDerivedClass"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
