...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_STATUS_OBSERVER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_STATUS_OBSERVER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_STATUS_OBSERVER_H_
