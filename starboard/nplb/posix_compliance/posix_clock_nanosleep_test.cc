...
constexpr unsigned int kAlarmSec = 1;  // Already constexpr, no change needed here, but noted.
...
void AddNsToTimespec(struct timespec* ts, const long nanoseconds_to_add) {
