...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_EXTERNAL_VIDEO_ENCODER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_EXTERNAL_VIDEO_ENCODER_H_
...
#include "third_party/chromium/media/cast/sender/size_adaptable_video_encoder_base.h"
...
// Cast MAIN thread proxy to the internal media_m96::VideoEncodeAccelerator
// implementation running on a separate thread.  Encodes media_m96::VideoFrames and
// emits media_m96::cast::EncodedFrames.
class ExternalVideoEncoder final : public VideoEncoder {
 ...
 private:
  ...
  void OnCreateVideoEncodeAccelerator(
      ...
      std::unique_ptr<media_m96::VideoEncodeAccelerator> vea);
...
class SizeAdaptableExternalVideoEncoder final
 ...
 private:
  // Special callbacks needed by media_m96::cast::ExternalVideoEncoder.
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_EXTERNAL_VIDEO_ENCODER_H_
