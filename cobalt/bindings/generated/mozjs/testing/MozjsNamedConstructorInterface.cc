...
InterfaceData* CreateCachedInterfaceData() {
  ...
  instance_class->name = "MozjsNamedConstructorInterface";
  ...
  prototype_class->name = "MozjsNamedConstructorInterfacePrototype";
  ...
  interface_object_class->name = "MozjsNamedConstructorInterfaceConstructor";
...
void InitializePrototypeAndInterfaceObject(
  ...
  const char name[] = "SomeNamedConstructor";
...
// static
JSObject* MozjsNamedConstructorInterface::CreateInstance(
