...
# Modified from //build/android/gyp/util/java_cpp_enum.py
# pylint: skip-file
# yapf: disable

import collections
from datetime import date
import java_cpp_utils
import re
import optparse
...
def DoMain(argv):
  ...
  parser.add_option('--outdir',
                    help='The output directory location')
  ...
  if not options.outdir:
    parser.error('Need to specify output directory')
  input_paths = args
  for output_path, data in DoGenerate(input_paths):
    with open(options.outdir + output_path, "w+") as file:
      file.write(data)
