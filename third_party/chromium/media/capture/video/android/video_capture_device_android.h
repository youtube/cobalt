...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_ANDROID_VIDEO_CAPTURE_DEVICE_ANDROID_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_ANDROID_VIDEO_CAPTURE_DEVICE_ANDROID_H_
...
class CAPTURE_EXPORT VideoCaptureDeviceAndroid : public VideoCaptureDevice {
 public:
  ...
  // A Java counterpart will be generated for this enum.
  // The values of these are matched with the ones in media_m96::VideoCaptureError
  ...
  // media_m96::VideoCaptureFrameDropReason to allow direct static_casting.
  // GENERATED_JAVA_ENUM_PACKAGE: org.chromium.media
 ...
 private:
  ...
  void SetErrorState(media_m96::VideoCaptureError error,
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_ANDROID_VIDEO_CAPTURE_DEVICE_ANDROID_H_
