...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_DEVICE_NAME_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_DEVICE_NAME_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_DEVICE_NAME_H_
