...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_VIDEO_FRAME_YUV_MAILBOXES_HOLDER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_VIDEO_FRAME_YUV_MAILBOXES_HOLDER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_VIDEO_FRAME_YUV_MAILBOXES_HOLDER_H_
