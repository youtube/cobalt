...
CFDataRef GenerateMasteringDisplayColorVolume(
  ...
  sei.primaries[0].x = __builtin_bswap16(md.primaries.fGX + 0.5f);
  sei.primaries[0].y = __builtin_bswap16(md.primaries.fGY + 0.5f);
  sei.primaries[1].x = __builtin_bswap16(md.primaries.fBX + 0.5f);
  sei.primaries[1].y = __builtin_bswap16(md.primaries.fBY + 0.5f);
  sei.primaries[2].x = __builtin_bswap16(md.primaries.fRX + 0.5f);
  sei.primaries[2].y = __builtin_bswap16(md.primaries.fRY + 0.5f);
  sei.white_point.x = __builtin_bswap16(md.primaries.fWX + 0.5f);
  sei.white_point.y = __builtin_bswap16(md.primaries.fWY + 0.5f);
