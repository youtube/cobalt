...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_DEVICE_DESCRIPTION_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_DEVICE_DESCRIPTION_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_DEVICE_DESCRIPTION_H_
