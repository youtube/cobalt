...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_LOGGING_OVERRIDE_IF_ENABLED_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_LOGGING_OVERRIDE_IF_ENABLED_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_LOGGING_OVERRIDE_IF_ENABLED_H_
