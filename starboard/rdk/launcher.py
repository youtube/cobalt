...
class Launcher(abstract_launcher.AbstractLauncher):
  ...
  def _InitPexpectCommands(self):
    ...
    # rsync command setup
    options = '-avzLhc -e=\'ssh -o \"HostKeyAlgorithms=+ssh-rsa\" -o \"PubkeyAcceptedAlgorithms=+ssh-rsa\" -L \"9000:localhost:9998\" -o \"UserKnownHostsFile=/dev/null\" -o \"StrictHostKeyChecking=no\" -p 10022\''
    ...
    rsa_options = (
        ...
        '-o \"HostKeyAlgorithms=+ssh-rsa\" -o \"PubkeyAcceptedAlgorithms=+ssh-rsa\" -L \"9000:localhost:9998\" '
        '-p 10022 '
        )
