...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_SURFACE_CHOOSER_HELPER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_SURFACE_CHOOSER_HELPER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_SURFACE_CHOOSER_HELPER_H_
