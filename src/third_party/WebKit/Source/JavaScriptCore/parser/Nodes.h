...
#if defined(WTF_COMPILER_GHS)
    // The base ParserArenaDeletable object needs to be constructed at offset 0
    // for the cleanup to work.
    class CommaNode : public ParserArenaDeletable, public ExpressionNode {
#else
