...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_VIDEO_FRAME_RECEIVER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_VIDEO_FRAME_RECEIVER_H_
...
class CAPTURE_EXPORT VideoFrameReceiver {
 public:
  ...
  virtual void OnNewBuffer(
      int32_t buffer_id,
      media_m96::mojom::VideoBufferHandlePtr buffer_handle) = 0;
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_VIDEO_FRAME_RECEIVER_H_
