...
#ifndef INTERNAL_STARBOARD_SHARED_UIKIT_SPEECH_SYNTHESIZER_H_
#define INTERNAL_STARBOARD_SHARED_UIKIT_SPEECH_SYNTHESIZER_H_
...
#endif  // INTERNAL_STARBOARD_SHARED_UIKIT_SPEECH_SYNTHESIZER_H_
