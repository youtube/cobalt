...
#include "third_party/chromium/media/mojo/services/cdm_service.h"
...
#include "third_party/chromium/media/cdm/default_cdm_factory.h"
...
class CdmServiceTest : public testing::Test {
 ...
 private:
  void OnCdmCreated(bool expected_result,
                    ...
                    media_m96::mojom::CdmContextPtr cdm_context,
