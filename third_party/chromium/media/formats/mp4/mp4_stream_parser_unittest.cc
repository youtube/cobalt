...
TEST_F(MP4StreamParserTest, Vp9) {
  ...
  EXPECT_NEAR(color_volume_metadata.primaries.fRX, 0.68, kColorCoordinateUnit);
  EXPECT_NEAR(color_volume_metadata.primaries.fRY, 0.31998,
              kColorCoordinateUnit);
  EXPECT_NEAR(color_volume_metadata.primaries.fGX, 0.26496,
              kColorCoordinateUnit);
  EXPECT_NEAR(color_volume_metadata.primaries.fGY, 0.68998,
              kColorCoordinateUnit);
  EXPECT_NEAR(color_volume_metadata.primaries.fBX, 0.15, kColorCoordinateUnit);
  EXPECT_NEAR(color_volume_metadata.primaries.fBY, 0.05998,
              kColorCoordinateUnit);
  EXPECT_NEAR(color_volume_metadata.primaries.fWX, 0.314,
              kColorCoordinateUnit);
  EXPECT_NEAR(color_volume_metadata.primaries.fWY, 0.351,
              kColorCoordinateUnit);
