...
void MediaCodecAudioDecoder::Initialize(const AudioDecoderConfig& config,
  ...
  // TODO(xhwang): Check whether base::BindPostTaskToCurrentDefault is needed here.
...
void MediaCodecAudioDecoder::SetCdm(CdmContext* cdm_context, InitCB init_cb) {
  ...
  // The callback will be posted back to this thread via base::BindPostTaskToCurrentDefault.
  media_crypto_context_->SetMediaCryptoReadyCB(media_m96::base::BindPostTaskToCurrentDefault(
