...
class UIEvent : public web::Event {
 public:
  ...
  UIEvent(base_token::Token type, Bubbles bubbles, Cancelable cancelable,
 ...
 protected:
  explicit UIEvent(base_token::Token type);
  explicit UIEvent(base_token::Token type, Bubbles bubbles,
