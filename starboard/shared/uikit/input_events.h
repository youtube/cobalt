...
#ifndef INTERNAL_STARBOARD_SHARED_UIKIT_INPUT_EVENTS_H_
#define INTERNAL_STARBOARD_SHARED_UIKIT_INPUT_EVENTS_H_
...
#endif  // INTERNAL_STARBOARD_SHARED_UIKIT_INPUT_EVENTS_H_
