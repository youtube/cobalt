...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_WINDOWS_D3D11_VIDEO_DECODER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_WINDOWS_D3D11_VIDEO_DECODER_H_
...
#include "third_party/chromium/media/gpu/windows/d3d11_decoder_configurator.h"
#include "third_party/chromium/media/gpu/windows/d3d11_h264_accelerator.h"
...
#include "third_party/chromium/media/gpu/windows/d3d11_vp9_accelerator.h"
...
class MEDIA_GPU_EXPORT D3D11VideoDecoder : public VideoDecoder,
 ...
 protected:
  ...
  // std::default_delete<media_m96::VideoDecoder> when held by a
  // std::unique_ptr<media_m96::VideoDecoder>.
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_WINDOWS_D3D11_VIDEO_DECODER_H_
