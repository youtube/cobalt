...
# limitations under the License.
{
  ...
  'variables': {
    ...
    'win32_media_player_files': [
      ...
      '<(DEPTH)/starboard/shared/win32/media_get_max_buffer_capacity.cc',
  ...
  'targets': [
    {
      ...
      'msvs_settings': {
        'VCCLCompilerTool': {
          ...
          'AdditionalOptions': [
            ...
            '<(additional_platform_compiler_options)',
          ]
        }
      },
      'conditions': [
      ...
      'sources': [
        ...
        '<(DEPTH)/starboard/shared/win32/file_atomic_replace.cc',
        ...
        '<(DEPTH)/starboard/shared/win32/graphics.cc',
        '<(DEPTH)/starboard/shared/win32/graphics.h',
        ...
        '<(DEPTH)/starboard/shared/win32/storage_write_record.cc',
        ...
        '<(DEPTH)/starboard/shared/win32/system_get_extensions.cc',
