...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_AUDIO_TIMESTAMP_VALIDATOR_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_AUDIO_TIMESTAMP_VALIDATOR_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_AUDIO_TIMESTAMP_VALIDATOR_H_