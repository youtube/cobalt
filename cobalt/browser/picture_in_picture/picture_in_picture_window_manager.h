...
class PictureInPictureWindowManager {
 public:
  ...
  // Gets the web contents of the active PiP window. Returns null if no window is active.
 ...
 private:
  ...
  // Observes the active WebContents and closes the PiP window if it is destroyed or navigates.
