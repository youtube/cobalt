...
#include "third_party/chromium/media/mojo/clients/mojo_video_encode_accelerator.h"
...
#include "third_party/chromium/media/mojo/mojom/video_encoder_info.mojom.h"
...
class VideoEncodeAcceleratorClient
 ...
 public:
  ...
  void BitstreamBufferReady(
      ...
      const media_m96::BitstreamBufferMetadata& metadata) override;
...
void MojoVideoEncodeAccelerator::Destroy() {
  ...
  vea_client_.reset();
  vea_.reset();
  // See media_m96::VideoEncodeAccelerator for more info on this peculiar pattern.
  delete this;
}
