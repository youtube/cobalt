...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_INPUT_IPC_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_INPUT_IPC_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_INPUT_IPC_H_
