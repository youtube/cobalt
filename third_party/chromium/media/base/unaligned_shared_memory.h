...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_UNALIGNED_SHARED_MEMORY_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_UNALIGNED_SHARED_MEMORY_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_UNALIGNED_SHARED_MEMORY_H_
