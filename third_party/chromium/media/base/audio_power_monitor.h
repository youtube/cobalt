...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_POWER_MONITOR_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_POWER_MONITOR_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_POWER_MONITOR_H_
