...
#include "third_party/chromium/media/base/win/mf_initializer.h"
#include "third_party/chromium/media/filters/vp9_parser.h"
#include "third_party/chromium/media/gpu/command_buffer_helper.h"
#include "third_party/chromium/media/gpu/windows/d3d11_video_device_format_support.h"
#include "third_party/chromium/media/gpu/windows/dxva_picture_buffer_win.h"
#include "third_party/chromium/media/gpu/windows/supported_profile_helpers.h"
...
bool DXVAVideoDecodeAccelerator::CreateDX11DevManager() {
  ...
  if (ShouldUseANGLEDevice()) {
    ...
    RETURN_ON_HR_FAILURE(
        hr, media_m96::SetDebugName(d3d11_device_.Get(), "DXVA_DecodeAccelerator"),
        false);
