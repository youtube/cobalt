...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_MAC_VIDEO_CAPTURE_DEVICE_MAC_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_MAC_VIDEO_CAPTURE_DEVICE_MAC_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_MAC_VIDEO_CAPTURE_DEVICE_MAC_H_
