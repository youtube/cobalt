...
SbWindow ApplicationTizen::CreateWindow(const SbWindowOptions* options) {
...
bool ApplicationTizen::DestroyWindow(SbWindow window) {
...
void ApplicationTizen::Initialize() {
...
void ApplicationTizen::Teardown() {
  SB_NOTIMPLEMENTED();
}

bool ApplicationTizen::MayHaveSystemEvents() {
  SB_NOTIMPLEMENTED();
  return false;
}

shared::starboard::Application::Event* ApplicationTizen::PollNextSystemEvent() {
  SB_NOTIMPLEMENTED();
  return NULL;
}

shared::starboard::Application::Event*
ApplicationTizen::WaitForSystemEventWithTimeout(SbTime time) {
  SB_NOTIMPLEMENTED();
  return NULL;
}

void ApplicationTizen::WakeSystemEventWait() {
  SB_NOTIMPLEMENTED();
}
