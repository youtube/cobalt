...
#ifndef NET_HTTP_MOCK_GSSAPI_LIBRARY_STARBOARD_H_
#define NET_HTTP_MOCK_GSSAPI_LIBRARY_STARBOARD_H_
...
class MockGSSAPILibrary : public GSSAPILibrary {
 ...
 private:
  FRIEND_TEST_ALL_PREFIXES(HttpAuthGSSAPIStarboardTest, GSSAPICycle);
...
#endif  // NET_HTTP_MOCK_GSSAPI_LIBRARY_STARBOARD_H_
