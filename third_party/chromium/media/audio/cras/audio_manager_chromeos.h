...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_CRAS_AUDIO_MANAGER_CHROMEOS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_CRAS_AUDIO_MANAGER_CHROMEOS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_CRAS_AUDIO_MANAGER_CHROMEOS_H_
