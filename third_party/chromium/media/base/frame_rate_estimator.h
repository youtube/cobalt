...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_FRAME_RATE_ESTIMATOR_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_FRAME_RATE_ESTIMATOR_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_FRAME_RATE_ESTIMATOR_H_
