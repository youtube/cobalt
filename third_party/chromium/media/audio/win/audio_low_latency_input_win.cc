...
#include "third_party/chromium/media/audio/win/avrt_wrapper_win.h"
#include "third_party/chromium/media/audio/win/core_audio_util_win.h"
#include "third_party/chromium/media/audio/win/volume_range_util.h"
#include "third_party/chromium/media/base/audio_block_fifo.h"
...
AudioInputStream::OpenOutcome WASAPIAudioInputStream::Open() {
  ...
  if (base::FeatureList::IsEnabled(media_m96::kWasapiRawAudioCapture) &&
