...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_CONSTANTS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_CONSTANTS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_CONSTANTS_H_
