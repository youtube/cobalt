...
// static
bool StructTraits<media_m96::mojom::VideoFrameMetadataDataView,
                  media_m96::VideoFrameMetadata>::
    Read(media_m96::mojom::VideoFrameMetadataDataView input,
  ...
  READ_AND_ASSIGN_OPT(media_m96::VideoTransformation, transformation,
                      Transformation);

  if (input.has_copy_mode()) {
    media_m96::VideoFrameMetadata::CopyMode copy_mode;
