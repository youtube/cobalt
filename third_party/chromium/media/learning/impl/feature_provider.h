...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_IMPL_FEATURE_PROVIDER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_IMPL_FEATURE_PROVIDER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_IMPL_FEATURE_PROVIDER_H_
