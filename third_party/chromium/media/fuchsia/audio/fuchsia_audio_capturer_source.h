...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_AUDIO_FUCHSIA_AUDIO_CAPTURER_SOURCE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_AUDIO_FUCHSIA_AUDIO_CAPTURER_SOURCE_H_
...
class MEDIA_EXPORT FuchsiaAudioCapturerSource final
 ...
 private:
  ...
  void OnPacketCaptured(fuchsia::media_m96::StreamPacket packet);
  ...
  // in the constructor.
  fidl::InterfaceHandle<fuchsia::media_m96::AudioCapturer> capturer_handle_;
  ...
  fuchsia::media_m96::AudioCapturerPtr capturer_;
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_AUDIO_FUCHSIA_AUDIO_CAPTURER_SOURCE_H_
