...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_WEBRTC_AUDIO_DELAY_STATS_REPORTER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_WEBRTC_AUDIO_DELAY_STATS_REPORTER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_WEBRTC_AUDIO_DELAY_STATS_REPORTER_H_
