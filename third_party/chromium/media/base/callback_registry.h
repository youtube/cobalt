...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_CALLBACK_REGISTRY_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_CALLBACK_REGISTRY_H_
...
class CallbackRegistry<void(Args...)> {
 public:
  ...
  std::unique_ptr<CallbackRegistration> Register(CallbackType cb)
    ...
    // Use base::BindPostTaskToCurrentDefault so that the callbacks are always posted to the
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_CALLBACK_REGISTRY_H_
