...
static const media_m96::FakeVideoCaptureDevice::DeliveryMode kDefaultDeliveryMode =
    media_m96::FakeVideoCaptureDevice::DeliveryMode::USE_DEVICE_INTERNAL_BUFFERS;
...
static const media_m96::VideoPixelFormat kSupportedPixelFormats[] = {
    media_m96::PIXEL_FORMAT_I420, media_m96::PIXEL_FORMAT_Y16,
    media_m96::PIXEL_FORMAT_MJPEG};
...
media_m96::VideoPixelFormat GetPixelFormatFromDeviceIndex(int device_index) {
  if (device_index == 1)
    return media_m96::PIXEL_FORMAT_Y16;
  if (device_index == 2)
    return media_m96::PIXEL_FORMAT_MJPEG;
  return media_m96::PIXEL_FORMAT_I420;
}

void AppendAllCombinationsToFormatsContainer(
    const std::vector<media_m96::VideoPixelFormat>& pixel_formats,
    const std::vector<gfx::Size>& resolutions,
    const std::vector<float>& frame_rates,
    media_m96::VideoCaptureFormats* output) {
...
class ErrorFakeDevice : public media_m96::VideoCaptureDevice {
 public:
  // VideoCaptureDevice implementation.
  void AllocateAndStart(const media_m96::VideoCaptureParams& params,
                        std::unique_ptr<Client> client) override {
    client->OnError(media_m96::VideoCaptureError::
