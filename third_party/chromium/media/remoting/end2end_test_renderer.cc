...
class End2EndTestRenderer::TestRemotee : public mojom::Remotee {
 public:
  ...
  void OnRemotingSinkReady(
      mojo::PendingRemote<::media_m96::mojom::RemotingSink> sink) override {
  ...
  void StartDataStreams(
      mojo::PendingRemote<::media_m96::mojom::RemotingDataStreamReceiver>
          audio_stream,
      mojo::PendingRemote<::media_m96::mojom::RemotingDataStreamReceiver>
    ...
    if (audio_stream.is_valid()) {
      ...
      audio_buffer_writer_ = ::media_m96::MojoDecoderBufferWriter::Create(
          GetDefaultDecoderBufferConverterCapacity(
              ::media_m96::DemuxerStream::AUDIO),
          &audio_data_pipe);
    ...
    if (video_stream.is_valid()) {
      ...
      video_buffer_writer_ = ::media_m96::MojoDecoderBufferWriter::Create(
          GetDefaultDecoderBufferConverterCapacity(
              ::media_m96::DemuxerStream::VIDEO),
          &video_data_pipe);
...
End2EndTestRenderer::End2EndTestRenderer(std::unique_ptr<Renderer> renderer)
  ...
  mojo::PendingRemote<media_m96::mojom::Remotee> remotee;
