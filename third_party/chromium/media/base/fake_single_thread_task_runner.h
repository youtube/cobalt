...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_FAKE_SINGLE_THREAD_TASK_RUNNER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_FAKE_SINGLE_THREAD_TASK_RUNNER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_FAKE_SINGLE_THREAD_TASK_RUNNER_H_
