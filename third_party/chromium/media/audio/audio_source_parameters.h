...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_SOURCE_PARAMETERS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_SOURCE_PARAMETERS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_SOURCE_PARAMETERS_H_
