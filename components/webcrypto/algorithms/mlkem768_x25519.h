...
#ifndef COMPONENTS_WEBCRYPTO_ALGORITHMS_MLKEM768_X25519_H_
#define COMPONENTS_WEBCRYPTO_ALGORITHMS_MLKEM768_X25519_H_

#include "components/webcrypto/algorithm_implementation.h"

namespace webcrypto {

class MlKem768X25519Implementation : public AlgorithmImplementation {
 public:
  MlKem768X25519Implementation() = default;
  ...
  // Can't use the default implementation because SPKI and PKCS8 are not
  // supported export/import formats.
  Status SerializeKeyForClone(const blink::WebCryptoKey& key,
                              std::vector<uint8_t>* key_data) const override;
...
#endif  // COMPONENTS_WEBCRYPTO_ALGORITHMS_MLKEM768_X25519_H_
