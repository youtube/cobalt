...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_PERMISSION_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_PERMISSION_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_PERMISSION_H_
