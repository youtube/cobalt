...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_SIMPLE_WATCH_TIMER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_SIMPLE_WATCH_TIMER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_SIMPLE_WATCH_TIMER_H_
