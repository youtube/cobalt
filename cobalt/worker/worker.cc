...
void Worker::Run(bool is_shared, const std::string& url,
  ...
  //    that agent.
  // 7. Let realm execution context be the result of creating a new JavaScript
...
void Worker::RunLoop() {
  ...
  // Worker thread.
  inside_port_.reset(
      new MessagePort(nullptr /* EventTarget */, nullptr /* WorkerSettings */));
