...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_COMMON_VMO_BUFFER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_COMMON_VMO_BUFFER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_COMMON_VMO_BUFFER_H_
