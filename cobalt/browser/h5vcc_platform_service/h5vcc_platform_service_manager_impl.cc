...
void H5vccPlatformServiceManagerImpl::Has(const std::string& service_name,
  ...
  LOG(WARNING) << "ColinL: H5vccPlatformServiceManagerImpl has check for:" << service_name;
  ...
  LOG(WARNING) << "ColinL: platform_service_extension is " << platform_service_extension;

  LOG(WARNING) << "ColinL: return value is " << platform_service_extension->Has(service_name.c_str());
