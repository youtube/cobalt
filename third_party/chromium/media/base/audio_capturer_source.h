...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_CAPTURER_SOURCE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_CAPTURER_SOURCE_H_
...
class AudioCapturerSource
    : public base::RefCountedThreadSafe<media_m96::AudioCapturerSource> {
 public:
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_CAPTURER_SOURCE_H_
