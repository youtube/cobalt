...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_SYSTEM_IMPL_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_SYSTEM_IMPL_H_
...
class MEDIA_EXPORT AudioSystemImpl : public AudioSystem {
 ...
 private:
  ...
  base::OnceCallback<void(Args...)> Maybebase::BindPostTaskToCurrentDefault(
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_SYSTEM_IMPL_H_
