...
CobaltContentBrowserClient::CreateBrowserMainParts(
  ...
  browser_main_parts->SetMetricsServices(TakeMetricsServicesManager(),
                                         metrics_services_manager_client_);
  browser_main_parts->SetExperimentConfig(TakePrefService(exp_config_));
  browser_main_parts->SetLocalState(TakePrefService(local_state_));
...
std::unique_ptr<PrefService> CobaltContentBrowserClient::TakePrefService(
    std::unique_ptr<PrefService>& pref_service) {
  return std::move(pref_service);
}

std::unique_ptr<metrics_services_manager::MetricsServicesManager>
CobaltContentBrowserClient::TakeMetricsServicesManager() {
