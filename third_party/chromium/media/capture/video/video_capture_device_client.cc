...
#include "third_party/chromium/media/capture/video/video_capture_device_client.h"
...
#include "third_party/chromium/media/capture/video/scoped_buffer_pool_reservation.h"
...
bool IsFormatSupported(media_m96::VideoPixelFormat pixel_format) {
  return (pixel_format == media_m96::PIXEL_FORMAT_I420 ||
          // NV12 and MJPEG are used by GpuMemoryBuffer on Chrome OS.
          pixel_format == media_m96::PIXEL_FORMAT_NV12 ||
          pixel_format == media_m96::PIXEL_FORMAT_MJPEG ||
          pixel_format == media_m96::PIXEL_FORMAT_Y16);
}
...
void GetI420BufferAccess(
    const media_m96::VideoCaptureDevice::Client::Buffer& buffer,
  ...
  *u_plane_data = *y_plane_data + media_m96::VideoFrame::PlaneSize(
                                      media_m96::PIXEL_FORMAT_I420,
                                      media_m96::VideoFrame::kYPlane, dimensions)
                                      .GetArea();
  *v_plane_data = *u_plane_data + media_m96::VideoFrame::PlaneSize(
                                      media_m96::PIXEL_FORMAT_I420,
                                      media_m96::VideoFrame::kUPlane, dimensions)
                                      .GetArea();
...
gfx::ColorSpace OverrideColorSpaceForLibYuvConversion(
    ...
    const media_m96::VideoPixelFormat pixel_format) {
  gfx::ColorSpace overriden_color_space = color_space;
  switch (pixel_format) {
    case media_m96::PIXEL_FORMAT_UNKNOWN:  // Color format not set.
      break;
    case media_m96::PIXEL_FORMAT_ARGB:
    case media_m96::PIXEL_FORMAT_XRGB:
    case media_m96::PIXEL_FORMAT_RGB24:
    case media_m96::PIXEL_FORMAT_ABGR:
    case media_m96::PIXEL_FORMAT_XBGR:
...
// see https://msdn.microsoft.com/en-us/library/windows/desktop/dd407253
  ...
  DCHECK_GE(static_cast<size_t>(length),
            media_m96::VideoFrame::AllocationSize(format.pixel_format,
                                              format.frame_size));
...
ReadyFrameInBuffer VideoCaptureDeviceClient::CreateReadyFrameFromExternalBuffer(
  ...
  if (!base::Contains(buffer_ids_known_by_receiver_, buffer_id)) {
    media_m96::mojom::VideoBufferHandlePtr buffer_handle =
        media_m96::mojom::VideoBufferHandle::New();
