...
InterfaceData* CreateCachedInterfaceData() {
  ...
  instance_class->name = "MozjsNamedGetterInterface";
  ...
  prototype_class->name = "MozjsNamedGetterInterfacePrototype";
  ...
  interface_object_class->name = "MozjsNamedGetterInterfaceConstructor";
