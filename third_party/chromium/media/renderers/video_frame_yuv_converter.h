...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_VIDEO_FRAME_YUV_CONVERTER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_VIDEO_FRAME_YUV_CONVERTER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_VIDEO_FRAME_YUV_CONVERTER_H_
