...
#include "third_party/chromium/media/gpu/windows/media_foundation_video_encode_accelerator_win.h"
...
using media_m96::MediaBufferScopedPointer;
...
bool MediaFoundationVideoEncodeAccelerator::Initialize(const Config& config,
  ...
  if (config.input_format == PIXEL_FORMAT_NV12 &&
      base::FeatureList::IsEnabled(media_m96::kMediaFoundationD3D11VideoCapture)) {
...
void MediaFoundationVideoEncodeAccelerator::RequestEncodingParametersChange(
    const media_m96::Bitrate& bitrate,
    uint32_t framerate) {
...
HRESULT MediaFoundationVideoEncodeAccelerator::InitializeD3DVideoProcessing(
  ...
  hr = media_m96::SetDebugName(scaled_d3d11_texture.Get(),
