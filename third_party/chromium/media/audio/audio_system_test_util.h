...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_SYSTEM_TEST_UTIL_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_SYSTEM_TEST_UTIL_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_SYSTEM_TEST_UTIL_H_
