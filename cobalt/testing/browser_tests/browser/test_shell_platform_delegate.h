#ifndef COBALT_SHELL_BROWSER_TEST_SHELL_PLATFORM_DELEGATE_H_
#define COBALT_SHELL_BROWSER_TEST_SHELL_PLATFORM_DELEGATE_H_
...
#endif  // COBALT_SHELL_BROWSER_TEST_SHELL_PLATFORM_DELEGATE_H_
