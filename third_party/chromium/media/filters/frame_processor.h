...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_FRAME_PROCESSOR_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_FRAME_PROCESSOR_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_FRAME_PROCESSOR_H_
