...
> IMPORTANT: As this version is a RC (Release Candidate), the code is subject to change. Only the Starboard API is frozen. **This is ready for integration and we STRONGLY RECOMMEND you start integration of this Cobalt 27 LTS RC on your respective platforms early and report issues ASAP** so there is ample time to investigate and resolve any detected issues before Cobalt 27 LTS Stable Release later this year.
