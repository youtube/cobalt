...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FFMPEG_FFMPEG_DELETERS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FFMPEG_FFMPEG_DELETERS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FFMPEG_FFMPEG_DELETERS_H_
