...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_TRACK_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_TRACK_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_TRACK_H_
