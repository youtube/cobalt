...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_MOCK_AUDIO_MANAGER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_MOCK_AUDIO_MANAGER_H_
...
class MockAudioManager : public AudioManager {
 public:
  ...
  using MakeOutputStreamCallback =
      base::RepeatingCallback<media_m96::AudioOutputStream*(
          const media_m96::AudioParameters& params,
          const std::string& device_id)>;
  using MakeInputStreamCallback =
      base::RepeatingCallback<media_m96::AudioInputStream*(
          const media_m96::AudioParameters& params,
          const std::string& device_id)>;
 ...
 protected:
  ...
  void GetAudioInputDeviceDescriptions(
      media_m96::AudioDeviceDescriptions* device_descriptions) override;
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_MOCK_AUDIO_MANAGER_H_
