...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_DEMUXER_MEMORY_LIMIT_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_DEMUXER_MEMORY_LIMIT_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_DEMUXER_MEMORY_LIMIT_H_
