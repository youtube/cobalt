...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_URL_DEMUXER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_URL_DEMUXER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_URL_DEMUXER_H_
