...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_AUDIO_SENDER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_AUDIO_SENDER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_AUDIO_SENDER_H_
