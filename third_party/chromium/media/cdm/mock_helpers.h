...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CDM_MOCK_HELPERS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CDM_MOCK_HELPERS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CDM_MOCK_HELPERS_H_
