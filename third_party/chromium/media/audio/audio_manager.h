...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_MANAGER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_MANAGER_H_
 ...
 public:
  ...
  using AddDiverterCallback =
      base::RepeatingCallback<void(const base::UnguessableToken&,
                                   media_m96::AudioSourceDiverter*)>;
  using RemoveDiverterCallback =
      base::RepeatingCallback<void(media_m96::AudioSourceDiverter*)>;
  ...
  virtual void RemoveDiverter(media_m96::AudioSourceDiverter* diverter);
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_MANAGER_H_
