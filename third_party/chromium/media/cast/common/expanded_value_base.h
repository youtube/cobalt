...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_COMMON_EXPANDED_VALUE_BASE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_COMMON_EXPANDED_VALUE_BASE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_COMMON_EXPANDED_VALUE_BASE_H_
