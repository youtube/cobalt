...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_AUDIO_CLOCK_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_AUDIO_CLOCK_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_AUDIO_CLOCK_H_
