...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_CLIENT_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_CLIENT_H_
...
#include "third_party/chromium/media/base/media_types.h"
...
class MEDIA_EXPORT MediaClient {
 public:
  ...
  virtual absl::optional<::media_m96::AudioRendererAlgorithmParameters>
  GetAudioRendererAlgorithmParameters(AudioParameters audio_parameters) = 0;
};

}  // namespace media_m96

#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_CLIENT_H_
