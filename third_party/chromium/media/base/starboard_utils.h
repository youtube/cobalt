...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_STARBOARD_UTILS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_STARBOARD_UTILS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_STARBOARD_UTILS_H_
