...
// Used by |SbDrmSessionUpdateRequestFunc| and |SbDrmSessionUpdatedFunc| to
// indicate the status of the operation on a particular session.
// https://w3c.github.io/encrypted-media/#error-names
typedef enum SbDrmSessionStatus {
  kSbDrmSessionStatusSuccess,
  kSbDrmSessionStatusTypeError,
  kSbDrmSessionStatusNotSupportedError,
  kSbDrmSessionStatusInvalidStateError,
  kSbDrmSessionStatusQuotaExceededError,
...
// |kSbDrmSessionStatusSuccess| to provide more details about the error.  It may
// be NULL if |status| is |kSbDrmSessionStatusSuccess| or if no error message
// can be provided.
