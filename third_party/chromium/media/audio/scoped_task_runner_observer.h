...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_SCOPED_TASK_RUNNER_OBSERVER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_SCOPED_TASK_RUNNER_OBSERVER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_SCOPED_TASK_RUNNER_OBSERVER_H_
