...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_WIN_WAVEOUT_OUTPUT_WIN_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_WIN_WAVEOUT_OUTPUT_WIN_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_WIN_WAVEOUT_OUTPUT_WIN_H_
