...
namespace JSC {
    ...
    public:
        ...
        { 
            return Structure::create(globalData, globalObject, proto, TypeInfo(ObjectType, StructureFlags), s_classinfo()); 
        }
    ...
    {
        ASSERT(asObject(value)->inherits(InternalFunction::s_classinfo()));
