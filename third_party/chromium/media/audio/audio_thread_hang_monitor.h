...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_THREAD_HANG_MONITOR_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_THREAD_HANG_MONITOR_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_THREAD_HANG_MONITOR_H_
