...
#ifndef STARBOARD_TIZEN_APPLICATION_WAYLAND_H_
#define STARBOARD_TIZEN_APPLICATION_WAYLAND_H_
...
class ApplicationWayland : public shared::starboard::QueueApplication {
 public:
  ...
  static ApplicationWayland* Get() {
    return static_cast<ApplicationWayland*>(shared::starboard::Application::Get());
  }
...
#endif // STARBOARD_TIZEN_APPLICATION_WAYLAND_H_