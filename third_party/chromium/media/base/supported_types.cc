...
#include "third_party/chromium/media/base/android/media_codec_util.h"  // nogncheck
#endif
...
bool IsColorSpaceSupported(const VideoColorSpace& color_space) {
  switch (color_space.primaries) {
    ...
    case VideoColorSpace::PrimaryID::P3:
      break;
  }
  ...
  switch (color_space.transfer) {
    ...
    case VideoColorSpace::TransferID::SRGB:
      break;
