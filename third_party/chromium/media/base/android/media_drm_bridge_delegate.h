...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_MEDIA_DRM_BRIDGE_DELEGATE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_MEDIA_DRM_BRIDGE_DELEGATE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_MEDIA_DRM_BRIDGE_DELEGATE_H_
