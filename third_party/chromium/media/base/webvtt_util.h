...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_WEBVTT_UTIL_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_WEBVTT_UTIL_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_WEBVTT_UTIL_H_
