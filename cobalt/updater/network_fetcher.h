...
//
//    A NetworkFetcher instance is created for the duration of a single network
//    operation (e.g., a file download or a POST request). Once the operation
//    completes or is canceled, the instance is expected to be destroyed.
//    Ownership is managed via std::unique_ptr, ensuring proper cleanup after
//    use.
//
