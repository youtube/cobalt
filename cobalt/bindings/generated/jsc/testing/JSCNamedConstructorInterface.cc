...
JSC::HashTable JSCNamedConstructorInterface::InterfaceObject::property_table = {
...
};  // JSCNamedConstructorInterface::InterfaceObject::property_table
...
JSC::HashTable JSCNamedConstructorInterface::NamedInterfaceObject::property_table = {
    // Sizes will be calculated based on the number of static functions as well.
    2,  // compactSize
    1,  // compactSizeMask
    property_table_values,
    NULL  // table allocated at runtime
};  // JSCNamedConstructorInterface::NamedInterfaceObject::property_table
...
JSC::HashTable JSCNamedConstructorInterface::Prototype::property_table = {
    4,  // compactSize
    3,  // compactSizeMask
    property_table_values,
    NULL  // table allocated at runtime
};  // JSCNamedConstructorInterface::Prototype::property_table
...
JSC::HashTable JSCNamedConstructorInterface::property_table = {
    2,  // compactSize
    1,  // compactSizeMask
    property_table_values,
    NULL  // table allocated at runtime
};  // JSCNamedConstructorInterface::property_table
...
bool JSCNamedConstructorInterface::getOwnPropertySlot(JSC::JSCell* cell,
    JSC::ExecState* exec, JSC::PropertyName property_name,
    JSC::PropertySlot& slot) {
  TRACE_EVENT1("JSCNamedConstructorInterface", "getOwnPropertySlot", "property",
...
void JSCNamedConstructorInterface::put(JSC::JSCell* cell, JSC::ExecState* exec,
    JSC::PropertyName property_name, JSC::JSValue value,
    JSC::PutPropertySlot& slot) {
  TRACE_EVENT1("JSCNamedConstructorInterface", "put", "property",
               TRACE_STR_COPY(WTF::String(property_name.publicName()).utf8().data()));
  JSCNamedConstructorInterface* this_object = JSC::jsCast<JSCNamedConstructorInterface*>(cell);
  ASSERT_GC_OBJECT_INHERITS(this_object, &s_info);
