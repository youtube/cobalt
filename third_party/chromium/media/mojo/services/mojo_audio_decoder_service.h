...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_MOJO_SERVICES_MOJO_AUDIO_DECODER_SERVICE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_MOJO_SERVICES_MOJO_AUDIO_DECODER_SERVICE_H_
...
class MEDIA_MOJO_EXPORT MojoAudioDecoderService final
 ...
 public:
  MojoAudioDecoderService(MojoCdmServiceContext* mojo_cdm_service_context,
                          std::unique_ptr<media_m96::AudioDecoder> decoder);
 ...
 private:
  ...
  void OnDecodeStatus(DecodeCallback callback, media_m96::Status status);
  ...
  // own destructor.
  std::unique_ptr<media_m96::AudioDecoder> decoder_;
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_MOJO_SERVICES_MOJO_AUDIO_DECODER_SERVICE_H_
