...
#include "third_party/chromium/media/cast/net/udp_transport_impl.h"
...
#include "third_party/chromium/media/cast/net/transport_util.h"
#include "third_party/chromium/media/cast/net/udp_packet_pipe.h"
#include "net/base/io_buffer.h"
#include "net/base/net_errors.h"
#include "net/log/net_log_source.h"
#include "net/traffic_annotation/network_traffic_annotation.h"

using media_m96::cast::transport_util::kOptionPacerMaxBurstSize;
using media_m96::cast::transport_util::LookupOptionWithDefault;
...
int32_t GetTransportSendBufferSize(const base::DictionaryValue& options) {
  ...
  int32_t max_burst_size =
      LookupOptionWithDefault(options, kOptionPacerMaxBurstSize,
                              media_m96::cast::kMaxBurstSize) *
      media_m96::cast::kMaxIpPacketSize;
...
UdpTransportImpl::UdpTransportImpl(
    ...
    : io_thread_proxy_(io_thread_proxy),
      ...
      send_buffer_size_(media_m96::cast::kMaxBurstSize *
                        media_m96::cast::kMaxIpPacketSize),
...
void UdpTransportImpl::ReceiveNextPacket(int length_or_status) {
  ...
  while (true) {
    if (length_or_status == net::ERR_IO_PENDING) {
      next_packet_ = std::make_unique<Packet>(media_m96::cast::kMaxIpPacketSize);
      ...
      length_or_status = udp_socket_->RecvFrom(
          recv_buf_.get(), media_m96::cast::kMaxIpPacketSize, &recv_addr_,
          base::BindOnce(&UdpTransportImpl::ReceiveNextPacket,
