...
def __filegroups(ctx):
    ...
    fg = {
        # This list must be kept in sync with the 'musl_all_headers' in 
        # //third_party/musl/BUILD.gn. Siso needs these explicitly listed
        # here to ensure they are available to remote workers.
