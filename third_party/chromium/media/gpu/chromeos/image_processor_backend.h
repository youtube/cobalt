...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_CHROMEOS_IMAGE_PROCESSOR_BACKEND_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_CHROMEOS_IMAGE_PROCESSOR_BACKEND_H_
...
template <>
struct MEDIA_GPU_EXPORT default_delete<media_m96::ImageProcessorBackend> {
  constexpr default_delete() = default;

  template <
      typename U,
      typename = typename std::enable_if<
          std::is_convertible<U*, media_m96::ImageProcessorBackend*>::value>::type>
  default_delete(const default_delete<U>& d) {}

  void operator()(media_m96::ImageProcessorBackend* ptr) const;
};

}  // namespace std

#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_CHROMEOS_IMAGE_PROCESSOR_BACKEND_H_
