...
class MediaCodecBridge {
 public:
  ...
  // When they are not set, MediaCodecBridge will use the maximum resolutions
  // the platform can decode.
  // They have to be set at the same time (i.e. we cannot set one of them
  // without the other), which will be checked in the function.
