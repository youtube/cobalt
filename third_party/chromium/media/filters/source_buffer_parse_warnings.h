...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_SOURCE_BUFFER_PARSE_WARNINGS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_SOURCE_BUFFER_PARSE_WARNINGS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_SOURCE_BUFFER_PARSE_WARNINGS_H_
