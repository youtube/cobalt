...
#include "third_party/chromium/media/capture/video/win/video_capture_device_win.h"
...
#include "third_party/chromium/media/capture/video/win/video_capture_device_utils_win.h"
...
VideoCaptureDeviceWin::VideoCaptureDeviceWin(
    ...
    : device_descriptor_(device_descriptor),
      ...
      enable_get_photo_state_(
          base::FeatureList::IsEnabled(media_m96::kDirectShowGetPhotoState)) {
...
void VideoCaptureDeviceWin::AllocateAndStart(
  ...
  if (FAILED(hr)) {
    SetErrorState(
        media_m96::VideoCaptureError::kWinDirectShowFailedToGetNumberOfCapabilities,
  ...
  if (hr != S_OK) {
    SetErrorState(media_m96::VideoCaptureError::
  ...
  if (FAILED(hr)) {
    SetErrorState(
        media_m96::VideoCaptureError::kWinDirectShowFailedToConnectTheCaptureGraph,
  ...
  base::UmaHistogramEnumeration(
      ...
      capture_format_.pixel_format, media_m96::VideoPixelFormat::PIXEL_FORMAT_MAX);
  base::UmaHistogramEnumeration(
...
void VideoCaptureDeviceWin::SetErrorState(media_m96::VideoCaptureError error,
