...
#else
// Cobalt introduces the SkYUV2RGBShader which composes 3 other shaders and
// does indeed require more than 1024 bytes.
typedef SkSmallAllocator<3, 2048> SkTBlitterAllocator;
#endif
