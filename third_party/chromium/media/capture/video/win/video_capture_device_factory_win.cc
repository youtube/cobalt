...
using DevicesInfo = std::vector<media_m96::VideoCaptureDeviceInfo>;
...
GetMFAttributes() {
  if (base::FeatureList::IsEnabled(
          media_m96::kIncludeIRCamerasInDeviceEnumeration)) {
...
VideoCaptureDeviceFactoryWin::VideoCaptureDeviceFactoryWin()
    : use_media_foundation_(
          base::FeatureList::IsEnabled(media_m96::kMediaFoundationVideoCapture)),
      use_d3d11_with_media_foundation_(
          base::FeatureList::IsEnabled(
              media_m96::kMediaFoundationD3D11VideoCapture) &&
