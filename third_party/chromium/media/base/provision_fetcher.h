...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_PROVISION_FETCHER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_PROVISION_FETCHER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_PROVISION_FETCHER_H_
