...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_IVF_PARSER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_IVF_PARSER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_IVF_PARSER_H_
