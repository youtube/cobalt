...
#include "third_party/chromium/media/capture/video/fake_video_capture_device.h"
...
#include "third_party/chromium/media/audio/fake_audio_input_stream.h"
...
#include "third_party/chromium/media/capture/video/gpu_memory_buffer_utils.h"
...
void FakePhotoDevice::GetPhotoState(
  ...
  photo_state->brightness = media_m96::mojom::Range::New();
  photo_state->contrast = media_m96::mojom::Range::New();
  photo_state->saturation = media_m96::mojom::Range::New();
  photo_state->sharpness = media_m96::mojom::Range::New();
