...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_VIDEO_FRAME_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_VIDEO_FRAME_H_
...
class MEDIA_EXPORT VideoFrame : public base::RefCountedThreadSafe<VideoFrame> {
 public:
  ...
  // media_m96::DuplicateFDs() if they need to retain a copy of the FDs for
  ...
  // destroyed. For such use cases, use media_m96::DuplicateFDs() to obtain your
  // own copy of the FDs.
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_VIDEO_FRAME_H_
