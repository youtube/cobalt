...
#include "third_party/chromium/media/audio/audio_output_device.h"
...
void AudioOutputDevice::OnAuthSignal() {
  ...
  // The callback is always posted by way media_m96::base::BindPostTaskToCurrentDefault() usage upon
