...
namespace JSC {
    ...
    public:
        ...
        {
            return Structure::create(globalData, globalObject, prototype, TypeInfo(ErrorInstanceType, StructureFlags), s_classinfo());
        }
    ...
    protected:
        JS_EXPORT_PRIVATE ErrorInstance(JSGlobalData&, Structure*);
