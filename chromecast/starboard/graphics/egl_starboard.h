...
Sb_eglChooseConfig(EGLDisplay dpy,
...
__attribute__((visibility("default"))) EGLBoolean
Sb_eglCopyBuffers(EGLDisplay dpy,
                  EGLSurface surface,
                  EGLNativePixmapType target);

__attribute__((visibility("default"))) EGLContext
Sb_eglCreateContext(EGLDisplay dpy,
                    EGLConfig config,
                    EGLContext share_context,
                    const EGLint* attrib_list);

__attribute__((visibility("default"))) EGLSurface
Sb_eglCreatePbufferSurface(EGLDisplay dpy,
                           EGLConfig config,
                           const EGLint* attrib_list);

__attribute__((visibility("default"))) EGLSurface
Sb_eglCreatePixmapSurface(EGLDisplay dpy,
                          EGLConfig config,
                          EGLNativePixmapType pixmap,
                          const EGLint* attrib_list);

__attribute__((visibility("default"))) EGLSurface
Sb_eglCreateWindowSurface(EGLDisplay dpy,
                          EGLConfig config,
                          EGLNativeWindowType win,
                          const EGLint* attrib_list);

__attribute__((visibility("default"))) EGLBoolean
Sb_eglDestroyContext(EGLDisplay dpy, EGLContext ctx);

__attribute__((visibility("default"))) EGLBoolean
Sb_eglDestroySurface(EGLDisplay dpy, EGLSurface surface);

__attribute__((visibility("default"))) EGLBoolean
Sb_eglGetConfigAttrib(EGLDisplay dpy,
                      EGLConfig config,
                      EGLint attribute,
                      EGLint* value);

__attribute__((visibility("default"))) EGLBoolean
Sb_eglGetConfigs(EGLDisplay dpy,
                 EGLConfig* configs,
                 EGLint config_size,
                 EGLint* num_config);
...
__attribute__((visibility("default"))) EGLSurface
Sb_eglGetCurrentSurface(EGLint readdraw);

__attribute__((visibility("default"))) EGLDisplay
Sb_eglGetDisplay(EGLNativeDisplayType display_id);
...
__attribute__((visibility("default"))) EGLBoolean
Sb_eglMakeCurrent(EGLDisplay dpy,
                  EGLSurface draw,
                  EGLSurface read,
                  EGLContext ctx);

__attribute__((visibility("default"))) EGLBoolean
Sb_eglQueryContext(EGLDisplay dpy,
                   EGLContext ctx,
                   EGLint attribute,
                   EGLint* value);
...
__attribute__((visibility("default"))) EGLBoolean
Sb_eglQuerySurface(EGLDisplay dpy,
                   EGLSurface surface,
                   EGLint attribute,
                   EGLint* value);

__attribute__((visibility("default"))) EGLBoolean
Sb_eglSwapBuffers(EGLDisplay dpy, EGLSurface surface);

__attribute__((visibility("default"))) EGLBoolean
Sb_eglTerminate(EGLDisplay dpy);

__attribute__((visibility("default"))) EGLBoolean Sb_eglWaitGL(void);

__attribute__((visibility("default"))) EGLBoolean
Sb_eglWaitNative(EGLint engine);
...
__attribute__((visibility("default"))) EGLBoolean
Sb_eglSurfaceAttrib(EGLDisplay dpy,
                    EGLSurface surface,
                    EGLint attribute,
                    EGLint value);

__attribute__((visibility("default"))) EGLBoolean
Sb_eglSwapInterval(EGLDisplay dpy, EGLint interval);
