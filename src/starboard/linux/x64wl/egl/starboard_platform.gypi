...
# limitations under the License.
{
  ...
  'variables': {
    'starboard_platform_sources': [
      '<(DEPTH)/starboard/linux/x64wl/egl/main.cc',
      '<(DEPTH)/starboard/linux/x64wl/egl/system_get_property.cc',
      '<(DEPTH)/starboard/linux/x64wl/egl/player_output_mode_supported.cc',
