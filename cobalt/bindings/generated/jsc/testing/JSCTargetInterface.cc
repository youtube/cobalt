...
JSC::HashTable JSCTargetInterface::InterfaceObject::property_table = {
...
};  // JSCTargetInterface::InterfaceObject::property_table
...
JSC::HashTable JSCTargetInterface::Prototype::property_table = {
    10,  // compactSize
    7,  // compactSizeMask
    property_table_values,
    NULL  // table allocated at runtime
};  // JSCTargetInterface::Prototype::property_table
...
JSC::HashTable JSCTargetInterface::property_table = {
    2,  // compactSize
    1,  // compactSizeMask
    property_table_values,
    NULL  // table allocated at runtime
};  // JSCTargetInterface::property_table
...
bool JSCTargetInterface::getOwnPropertySlot(JSC::JSCell* cell,
    JSC::ExecState* exec, JSC::PropertyName property_name,
    JSC::PropertySlot& slot) {
  TRACE_EVENT1("JSCTargetInterface", "getOwnPropertySlot", "property",
...
void JSCTargetInterface::put(JSC::JSCell* cell, JSC::ExecState* exec,
    JSC::PropertyName property_name, JSC::JSValue value,
    JSC::PutPropertySlot& slot) {
  TRACE_EVENT1("JSCTargetInterface", "put", "property",
               TRACE_STR_COPY(WTF::String(property_name.publicName()).utf8().data()));
  JSCTargetInterface* this_object = JSC::jsCast<JSCTargetInterface*>(cell);
  ASSERT_GC_OBJECT_INHERITS(this_object, &s_info);
