...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_DECRYPTING_MEDIA_RESOURCE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_DECRYPTING_MEDIA_RESOURCE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_DECRYPTING_MEDIA_RESOURCE_H_
