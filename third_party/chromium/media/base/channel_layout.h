...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_CHANNEL_LAYOUT_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_CHANNEL_LAYOUT_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_CHANNEL_LAYOUT_H_
