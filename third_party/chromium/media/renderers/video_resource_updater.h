...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_VIDEO_RESOURCE_UPDATER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_VIDEO_RESOURCE_UPDATER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_VIDEO_RESOURCE_UPDATER_H_
