...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_RENDERER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_RENDERER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_RENDERER_H_
