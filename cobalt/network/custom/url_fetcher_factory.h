...
#ifndef COBALT_NETWORK_CUSTOM_URL_FETCHER_FACTORY_H_
#define COBALT_NETWORK_CUSTOM_URL_FETCHER_FACTORY_H_
...
#endif  // COBALT_NETWORK_CUSTOM_URL_FETCHER_FACTORY_H_
