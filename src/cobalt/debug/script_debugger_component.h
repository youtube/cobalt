...
#ifndef COBALT_DEBUG_SCRIPT_DEBUGGER_COMPONENT_H_
#define COBALT_DEBUG_SCRIPT_DEBUGGER_COMPONENT_H_
...
class ScriptDebuggerComponent {
 public:
  ScriptDebuggerComponent(DebugDispatcher* dispatcher,
...
#endif  // COBALT_DEBUG_SCRIPT_DEBUGGER_COMPONENT_H_
