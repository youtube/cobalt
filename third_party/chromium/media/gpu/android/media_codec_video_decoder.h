...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_MEDIA_CODEC_VIDEO_DECODER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_MEDIA_CODEC_VIDEO_DECODER_H_
...
#include "third_party/chromium/media/base/callback_registry.h"
#include "third_party/chromium/media/base/cdm_context.h"
#include "third_party/chromium/media/base/overlay_info.h"
#include "third_party/chromium/media/base/video_decoder.h"
#include "third_party/chromium/media/base/video_decoder_config.h"
#include "third_party/chromium/media/gpu/android/android_video_surface_chooser.h"
#include "third_party/chromium/media/gpu/android/codec_allocator.h"
#include "third_party/chromium/media/gpu/android/codec_wrapper.h"
#include "third_party/chromium/media/gpu/android/device_info.h"
#include "third_party/chromium/media/gpu/android/surface_chooser_helper.h"
#include "third_party/chromium/media/gpu/android/video_frame_factory.h"
...
template <>
struct MEDIA_GPU_EXPORT default_delete<media_m96::MediaCodecVideoDecoder>
    : public default_delete<media_m96::VideoDecoder> {};

}  // namespace std

#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_MEDIA_CODEC_VIDEO_DECODER_H_
