...
# Note, that despite the file extension ".gyp", this file is included by
# several platform variants of linux-x64x11, like a ".gypi" file, since those
# platforms have no need to modify this code.
# pylint: disable=pointless-statement
'''Build file for stadia'''
