  ...
  'targets': [
    ...
    },
    {
      ...
      'sources': [
        ...
        '<(DEPTH)/starboard/raspi/shared/open_max/decode_target_destroy.cc',
        '<(DEPTH)/starboard/raspi/shared/open_max/decode_target_get_format.cc',
        '<(DEPTH)/starboard/raspi/shared/open_max/decode_target_get_plane.cc',
        '<(DEPTH)/starboard/raspi/shared/open_max/decode_target_get_size.cc',
        '<(DEPTH)/starboard/raspi/shared/open_max/decode_target_internal.h',
        '<(DEPTH)/starboard/raspi/shared/open_max/decode_target_is_opaque.cc',
