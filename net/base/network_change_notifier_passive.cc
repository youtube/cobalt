...
#if BUILDFLAG(IS_LINUX) && !BUILDFLAG(IS_STARBOARD) && !BUILDFLAG(IS_COBALT_HERMETIC_BUILD)
...
NetworkChangeNotifierPassive::NetworkChangeCalculatorParamsPassive() {
  ...
  // TODO: b/123, Cobalt - Adjust these values with experimentation. Right now they just follow linux.
