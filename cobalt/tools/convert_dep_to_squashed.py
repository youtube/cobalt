...
def squash_subtree(repo, module_dir, git_source, git_rev):
  """Attempts to squash the subtree into a rebase attempt."""
  repo.get.subtree('--squash', '-P', module_dir, 'pull', git_source, git_rev)
