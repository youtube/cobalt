...

{
  'variables': {
    'glsl_shaders': [
      ...
      '<(DEPTH)/cobalt/renderer/glimp_shaders/glsl/fragment_skia_bounded_x_convolution_filtered_texture.glsl',
      ...
      '<(DEPTH)/cobalt/renderer/glimp_shaders/glsl/fragment_skia_ellipse_masked_texture_domain.glsl',
      ...
      '<(DEPTH)/cobalt/renderer/glimp_shaders/glsl/fragment_skia_texture_domain_masked_texture_domain.glsl',
      ...
      '<(DEPTH)/cobalt/renderer/glimp_shaders/glsl/vertex_skia_two_texcoords_derived_from_position.glsl',
