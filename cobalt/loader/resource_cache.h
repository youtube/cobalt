...
//////////////////////////////////////////////////////////////////////////
// CachedResourceBase - Declarations
//////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////
// CachedResourceBase::OnLoadedCallbackHandler - Definitions
//////////////////////////////////////////////////////////////////////////

inline CachedResourceBase::OnLoadedCallbackHandler::OnLoadedCallbackHandler(
    const scoped_refptr<CachedResourceBase>& cached_resource,
...
inline CachedResourceBase::~CachedResourceBase() {
  DCHECK(cached_resource_thread_checker_.CalledOnValidThread());
...
inline void CachedResourceBase::StartLoading() {
  DCHECK(cached_resource_thread_checker_.CalledOnValidThread());
  DCHECK(!loader_);
...
inline bool CachedResourceBase::IsLoadingComplete() {
  return !loader_ && !retry_timer_;
}

inline void CachedResourceBase::ScheduleLoadingRetry() {
  DCHECK(cached_resource_thread_checker_.CalledOnValidThread());
  DCHECK(!loader_);
  DCHECK(!retry_timer_ || !retry_timer_->IsRunning());
...
inline void CachedResourceBase::OnLoadingComplete(
...
inline CachedResourceBase::CallbackListIterator CachedResourceBase::AddCallback(
...
inline void CachedResourceBase::RemoveCallback(CallbackType type,
                                               CallbackListIterator iterator) {
  DCHECK(cached_resource_thread_checker_.CalledOnValidThread());
...
inline void CachedResourceBase::RunCallbacks(CallbackType type) {
  DCHECK(cached_resource_thread_checker_.CalledOnValidThread());
...
inline void CachedResourceBase::EnableCompletionCallbacks() {
...
//////////////////////////////////////////////////////////////////////////
// ResourceCacheBase - Declarations
//////////////////////////////////////////////////////////////////////////
...
inline void ResourceCacheBase::SetCapacity(uint32 capacity) {
  DCHECK(resource_cache_thread_checker_.CalledOnValidThread());
...
inline void ResourceCacheBase::Purge() {
  DCHECK(resource_cache_thread_checker_.CalledOnValidThread());
  ProcessPendingCallbacks();
  reclaim_memory_func_.Run(0, true);
}

inline void ResourceCacheBase::ProcessPendingCallbacks() {
  DCHECK(resource_cache_thread_checker_.CalledOnValidThread());
...
inline void ResourceCacheBase::DisableCallbacks() {
  DCHECK(resource_cache_thread_checker_.CalledOnValidThread());
...
inline void ResourceCacheBase::NotifyResourceLoadingRetryScheduled(
    CachedResourceBase* cached_resource) {
  DCHECK(resource_cache_thread_checker_.CalledOnValidThread());
  const std::string& url = cached_resource->url().spec();
...
inline void ResourceCacheBase::ReclaimMemoryAndMaybeProcessPendingCallbacks(
    uint32 bytes_to_reclaim_down_to) {
...
inline void ResourceCacheBase::ProcessPendingCallbacksIfUnblocked() {
