...
JSC::HashTable JSCObjectTypeBindingsInterface::InterfaceObject::property_table = {
...
};  // JSCObjectTypeBindingsInterface::InterfaceObject::property_table
...
JSC::HashTable JSCObjectTypeBindingsInterface::Prototype::property_table = {
    4,  // compactSize
    3,  // compactSizeMask
    property_table_values,
    NULL  // table allocated at runtime
};  // JSCObjectTypeBindingsInterface::Prototype::property_table
...
JSC::HashTable JSCObjectTypeBindingsInterface::property_table = {
    19,  // compactSize
    15,  // compactSizeMask
    property_table_values,
    NULL  // table allocated at runtime
};  // JSCObjectTypeBindingsInterface::property_table
...
void setJSderivedInterface(
  ...
  scoped_refptr<DerivedInterface> cobalt_value;
  FromJSValue(exec_state, value,
      kNoConversionFlags, &exception_state,
      &cobalt_value);
  if (exception_state.is_exception_set()) {
...
void setJSobjectProperty(
  ...
  JSCObjectHandleHolder cobalt_value;
  FromJSValue(exec_state, value,
