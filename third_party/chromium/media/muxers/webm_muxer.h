...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_MUXERS_WEBM_MUXER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_MUXERS_WEBM_MUXER_H_
...
class MEDIA_EXPORT WebmMuxer {
 public:
  ...
  // media_m96::VideoFrame.
  struct MEDIA_EXPORT VideoParameters {
    explicit VideoParameters(scoped_refptr<media_m96::VideoFrame> frame);
  ...
  bool OnEncodedVideo(const VideoParameters& params,
                      ...
                      bool is_key_frame);
  bool OnEncodedAudio(const media_m96::AudioParameters& params,
                      std::string encoded_data,
                      base::TimeTicks timestamp);
 ...
 private:
  ...
  void AddAudioTrack(const media_m96::AudioParameters& params);
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_MUXERS_WEBM_MUXER_H_
