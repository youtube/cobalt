...
public final class CommandLineOverrideHelper {
  ...
  public static StringJoiner getDefaultJsFlagOverridesList() {
    ...
    paramOverrides.add("--initial-old-space-size=16");
  ...
  public static void getFlagOverrides(CommandLineOverrideHelperParams params) {
    ...
    String finalJsFlags = jsFlagOverrides.toString();
    CommandLine.getInstance()
        .appendSwitchesAndArguments(new String[] {"--js-flags=" + finalJsFlags});
    Log.i("Coat", "Effective --js-flags: " + finalJsFlags);
    CommandLine.getInstance()
