...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_TEXT_RANGES_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_TEXT_RANGES_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_TEXT_RANGES_H_
