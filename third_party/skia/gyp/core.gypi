...

{
  'sources': [
    ...
    "<(skia_src_path)/core/SkColorLookUpTable.cpp",
    "<(skia_src_path)/core/SkColorLookUpTable.h",
    ...
    "<(skia_src_path)/core/SkColorSpaceXformCanvas.cpp",
    "<(skia_src_path)/core/SkColorSpaceXformer.cpp",
    "<(skia_src_path)/core/SkColorSpaceXformer.h",
    "<(skia_src_path)/core/SkColorSpaceXformImageGenerator.cpp",
    "<(skia_src_path)/core/SkColorSpaceXformImageGenerator.h",
    "<(skia_src_path)/core/SkColorSpaceXform_A2B.cpp",
    "<(skia_src_path)/core/SkColorSpaceXform_A2B.h",
    ...
    "<(skia_src_path)/core/SkFDot6Constants.h",
    ...
    "<(skia_src_path)/core/SkOverdrawCanvas.h",
    ...
    "<(skia_include_path)/private/SkMessageBus.h",
