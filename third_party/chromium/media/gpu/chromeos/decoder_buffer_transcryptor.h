...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_CHROMEOS_DECODER_BUFFER_TRANSCRYPTOR_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_CHROMEOS_DECODER_BUFFER_TRANSCRYPTOR_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_CHROMEOS_DECODER_BUFFER_TRANSCRYPTOR_H_
