...
const ClassInfo InternalFunction::s_info = { "Function", Base::s_classinfo(), 0, 0, CREATE_METHOD_TABLE(InternalFunction) };
const ClassInfo* InternalFunction::s_classinfo() { return &s_info; }
