...
#include "third_party/chromium/media/cast/sender/h264_vt_encoder.h"
...
#include "third_party/chromium/media/ffmpeg/ffmpeg_common.h"
#include "third_party/chromium/media/filters/ffmpeg_glue.h"
...
void SaveDecoderInitResult(bool* out_result, ::media_m96::Status in_result) {
...
void CreateFrameAndMemsetPlane(VideoFrameFactory* const video_frame_factory) {
  const scoped_refptr<media_m96::VideoFrame> video_frame =
...
class H264VideoToolboxEncoderTest : public ::testing::Test {
 protected:
  ...
  static void SetUpTestCase() {
    ...
    frame_ = media_m96::VideoFrame::CreateFrame(
  ...
  static scoped_refptr<media_m96::VideoFrame> frame_;
...
// static
scoped_refptr<media_m96::VideoFrame> H264VideoToolboxEncoderTest::frame_;
