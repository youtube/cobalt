...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_MAC_VT_VIDEO_ENCODE_ACCELERATOR_MAC_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_MAC_VT_VIDEO_ENCODE_ACCELERATOR_MAC_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_MAC_VT_VIDEO_ENCODE_ACCELERATOR_MAC_H_
