...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_IMPL_VOTING_ENSEMBLE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_IMPL_VOTING_ENSEMBLE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_IMPL_VOTING_ENSEMBLE_H_
