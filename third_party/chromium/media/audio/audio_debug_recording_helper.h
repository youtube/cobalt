...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_DEBUG_RECORDING_HELPER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_DEBUG_RECORDING_HELPER_H_
...
#include "third_party/chromium/media/audio/audio_debug_file_writer.h"
...
class MEDIA_EXPORT AudioDebugRecordingHelper : public AudioDebugRecorder {
 ...
 private:
  ...
  void DoWrite(std::unique_ptr<media_m96::AudioBus> data);
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_DEBUG_RECORDING_HELPER_H_
