...
#include "third_party/chromium/media/mojo/mojom/media_foundation_cdm_data_mojom_traits.h"
...
// static
bool StructTraits<media_m96::mojom::MediaFoundationCdmDataDataView,
                  std::unique_ptr<media_m96::MediaFoundationCdmData>>::
    Read(media_m96::mojom::MediaFoundationCdmDataDataView input,
  ...
  *output = std::make_unique<media_m96::MediaFoundationCdmData>(
