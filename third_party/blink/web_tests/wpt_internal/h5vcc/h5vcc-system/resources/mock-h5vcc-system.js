...
class MockH5vccSystem {
  ...
  STUB_ADVERTISING_ID = 'advertisingId';
  ...
  stubAdvertisingID(id) {
    this.stubResult(this.STUB_ADVERTISING_ID, id);
  }
  ...
  getAdvertisingId() {
    ...
    return Promise.resolve({ advertisingId: this.stub_result_.get(this.STUB_ADVERTISING_ID) });
  }
}
