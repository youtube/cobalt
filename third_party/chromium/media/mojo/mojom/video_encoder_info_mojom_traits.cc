...
#include "third_party/chromium/media/mojo/mojom/video_encoder_info_mojom_traits.h"

namespace mojo {

// static
bool StructTraits<media_m96::mojom::ResolutionBitrateLimitDataView,
                  media_m96::ResolutionBitrateLimit>::
    Read(media_m96::mojom::ResolutionBitrateLimitDataView data,
...
// static
bool StructTraits<
    media_m96::mojom::VideoEncoderInfoDataView,
    media_m96::VideoEncoderInfo>::Read(media_m96::mojom::VideoEncoderInfoDataView data,
