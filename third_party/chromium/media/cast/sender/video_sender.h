...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_VIDEO_SENDER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_VIDEO_SENDER_H_
...
#include "third_party/chromium/media/cast/sender/congestion_control.h"
#include "third_party/chromium/media/cast/sender/frame_sender.h"
...
class VideoSender : public FrameSender {
 public:
  VideoSender(scoped_refptr<CastEnvironment> cast_environment,
              ...
              media_m96::VideoCaptureFeedbackCB feedback_callback);
  ...
  void InsertRawVideoFrame(scoped_refptr<media_m96::VideoFrame> video_frame,
 ...
 private:
  ...
  void OnEncodedVideoFrame(scoped_refptr<media_m96::VideoFrame> video_frame,
                           int encoder_bitrate,
                           std::unique_ptr<SenderEncodedFrame> encoded_frame);

  // Encodes media_m96::VideoFrame images into EncodedFrames.  Per configuration,
  ...
  media_m96::VideoCaptureFeedbackCB feedback_cb_;
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_VIDEO_SENDER_H_
