...
#include "third_party/chromium/media/gpu/chromeos/generic_dmabuf_video_frame_mapper.h"
#include "third_party/chromium/media/gpu/chromeos/gpu_memory_buffer_video_frame_mapper.h"
#endif  // BUILDFLAG(USE_CHROMEOS_MEDIA_ACCELERATION)

#if BUILDFLAG(USE_VAAPI)
#include "third_party/chromium/media/gpu/vaapi/vaapi_dmabuf_video_frame_mapper.h"
