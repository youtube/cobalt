...
#include "third_party/chromium/media/gpu/vaapi/vaapi_mjpeg_decode_accelerator.h"
...
#include "third_party/chromium/media/gpu/chromeos/libyuv_image_processor_backend.h"
...
void VaapiMjpegDecodeAccelerator::InitializeOnDecoderTaskRunner(
  ...
  decoder_ = std::make_unique<media_m96::VaapiJpegDecoder>();
