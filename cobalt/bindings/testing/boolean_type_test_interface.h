...
#ifndef BINDINGS_TESTING_BOOLEAN_TYPE_TEST_INTERFACE_H_
#define BINDINGS_TESTING_BOOLEAN_TYPE_TEST_INTERFACE_H_
...
#endif  // BINDINGS_TESTING_BOOLEAN_TYPE_TEST_INTERFACE_H_
