...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_COMMAND_BUFFER_HELPER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_COMMAND_BUFFER_HELPER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_COMMAND_BUFFER_HELPER_H_
