...
#include "third_party/chromium/media/gpu/buildflags.h"
#include "third_party/chromium/media/gpu/gpu_video_accelerator_util.h"
...
#include "third_party/chromium/media/gpu/windows/dxva_video_decode_accelerator_win.h"
#endif
#if defined(OS_MAC)
#include "third_party/chromium/media/gpu/mac/vt_video_decode_accelerator_mac.h"
#endif
#if BUILDFLAG(USE_VAAPI)
#include "third_party/chromium/media/gpu/vaapi/vaapi_video_decode_accelerator.h"
#include "ui/gl/gl_implementation.h"
#elif BUILDFLAG(USE_V4L2_CODEC)
#include "third_party/chromium/media/gpu/v4l2/v4l2_device.h"
#include "third_party/chromium/media/gpu/v4l2/v4l2_slice_video_decode_accelerator.h"
#include "third_party/chromium/media/gpu/v4l2/v4l2_video_decode_accelerator.h"
