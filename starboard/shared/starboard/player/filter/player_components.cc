...
class PlayerComponentsImpl : public PlayerComponents {
 public:
  PlayerComponentsImpl(std::unique_ptr<MediaTimeProviderImpl> media_time_provider,
...
unique_ptr_alias<PlayerComponents> PlayerComponents::Factory::CreateComponents(
  ...
  if (creation_parameters.audio_codec() != kSbMediaAudioCodecNone) {
    ...
    audio_renderer.reset(
        new AudioRendererPcm(std::move(audio_decoder), std::move(audio_renderer_sink),
  ...
  if (creation_parameters.video_codec() != kSbMediaVideoCodecNone) {
    ...
    if (audio_renderer) {
      ...
      media_time_provider_impl.reset(
          new MediaTimeProviderImpl(std::unique_ptr<MonotonicSystemTimeProvider>(
  ...
  return unique_ptr_alias<PlayerComponents>(
      new PlayerComponentsImpl(std::move(media_time_provider_impl),
...
void PlayerComponents::Factory::CreateStubAudioComponents(
  ...
  auto decoder_creator = [](const media::AudioStreamInfo& audio_stream_info,
                            SbDrmSystem drm_system) {
    return unique_ptr_alias<AudioDecoder>(new StubAudioDecoder(audio_stream_info));
  };
