...
#include "third_party/chromium/media/gpu/test/local_gpu_memory_buffer_manager.h"  // nogncheck
...
void DumpError(media_m96::VideoCaptureError,
...
class VideoCaptureDeviceTest
 ...
 protected:
  ...
  VideoCaptureDeviceTest()
    ...
    if (media_m96::ShouldUseCrosCameraService() &&
...
void VideoCaptureDeviceTest::RunCaptureMjpegTestCase() {
  ...
  EXPECT_GE(static_cast<size_t>(1280 * 720),
            media_m96::VideoFrame::AllocationSize(last_format().pixel_format,
