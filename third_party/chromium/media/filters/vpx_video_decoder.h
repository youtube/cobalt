...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_VPX_VIDEO_DECODER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_VPX_VIDEO_DECODER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_VPX_VIDEO_DECODER_H_
