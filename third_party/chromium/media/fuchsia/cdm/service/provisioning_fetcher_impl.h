...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_CDM_SERVICE_PROVISIONING_FETCHER_IMPL_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_CDM_SERVICE_PROVISIONING_FETCHER_IMPL_H_
...
class ProvisioningFetcherImpl
    : public fuchsia::media_m96::drm::ProvisioningFetcher {
 public:
  ...
  fidl::InterfaceHandle<fuchsia::media_m96::drm::ProvisioningFetcher> Bind(
      base::OnceClosure error_callback);

  // fuchsia::media_m96::drm::ProvisioningFetcher implementation.
  void Fetch(fuchsia::media_m96::drm::ProvisioningRequest request,
 ...
 private:
  ...
  fidl::Binding<fuchsia::media_m96::drm::ProvisioningFetcher> binding_;
  base::OnceClosure error_callback_;
  std::unique_ptr<media_m96::ProvisionFetcher> fetcher_;
  bool retrieve_in_progress_ = false;
};

}  // namespace media_m96

#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_CDM_SERVICE_PROVISIONING_FETCHER_IMPL_H_
