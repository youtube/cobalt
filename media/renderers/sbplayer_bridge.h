...
#ifndef MEDIA_RENDERERS_SBPLAYER_BRIDGE_H_
#define MEDIA_RENDERERS_SBPLAYER_BRIDGE_H_
...
#include "media/renderers/sbplayer_interface.h"
#include "media/renderers/sbplayer_set_bounds_helper.h"
...
class MEDIA_EXPORT SbPlayerBridge {
 public:
  class Host {
   public:
...
#endif  // MEDIA_RENDERERS_SBPLAYER_BRIDGE_H_
