...
#include "third_party/chromium/media/mojo/services/interface_factory_impl.h"
...
#include "third_party/chromium/media/mojo/services/mojo_decryptor_service.h"
#include "third_party/chromium/media/mojo/services/mojo_media_client.h"

#if BUILDFLAG(ENABLE_MOJO_AUDIO_DECODER)
#include "third_party/chromium/media/mojo/services/mojo_audio_decoder_service.h"
#endif  // BUILDFLAG(ENABLE_MOJO_AUDIO_DECODER)

#if BUILDFLAG(ENABLE_MOJO_VIDEO_DECODER)
#include "third_party/chromium/media/mojo/services/mojo_video_decoder_service.h"
...
#include "third_party/chromium/media/mojo/services/mojo_renderer_service.h"
#endif

#if BUILDFLAG(ENABLE_MOJO_CDM)
#include "third_party/chromium/media/base/cdm_factory.h"
#include "third_party/chromium/media/mojo/services/mojo_cdm_service.h"
...
void InterfaceFactoryImpl::CreateCastRenderer(
    ...
    mojo::PendingReceiver<media_m96::mojom::Renderer> receiver) {
  DVLOG(2) << __func__;
...
void InterfaceFactoryImpl::CreateMediaFoundationRenderer(
    ...
    mojo::PendingReceiver<media_m96::mojom::Renderer> receiver,
    mojo::PendingReceiver<media_m96::mojom::MediaFoundationRendererExtension>
        renderer_extension_receiver) {
  DVLOG(2) << __func__;
...
void InterfaceFactoryImpl::AddRenderer(
    std::unique_ptr<media_m96::Renderer> renderer,
    mojo::PendingReceiver<mojom::Renderer> receiver) {
