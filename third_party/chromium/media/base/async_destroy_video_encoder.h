...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_ASYNC_DESTROY_VIDEO_ENCODER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_ASYNC_DESTROY_VIDEO_ENCODER_H_
 ...
 public:
  explicit AsyncDestroyVideoEncoder(std::unique_ptr<T> wrapped_encoder)
    ...
    static_assert(std::is_base_of<VideoEncoder, T>::value,
                  "T must implement 'media_m96::VideoEncoder'");
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_ASYNC_DESTROY_VIDEO_ENCODER_H_
