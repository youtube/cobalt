...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_SUPPORTED_VIDEO_DECODER_CONFIG_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_SUPPORTED_VIDEO_DECODER_CONFIG_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_SUPPORTED_VIDEO_DECODER_CONFIG_H_
