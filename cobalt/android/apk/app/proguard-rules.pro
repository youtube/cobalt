...
# Keep classes from media_session services package
-keep,allowshrinking,allowoptimization,allowaccessmodification class org.chromium.services.media_session.** { *; }
