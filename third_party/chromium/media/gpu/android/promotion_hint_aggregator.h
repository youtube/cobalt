...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_PROMOTION_HINT_AGGREGATOR_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_PROMOTION_HINT_AGGREGATOR_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_PROMOTION_HINT_AGGREGATOR_H_
