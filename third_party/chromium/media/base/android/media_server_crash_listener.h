...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_MEDIA_SERVER_CRASH_LISTENER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_MEDIA_SERVER_CRASH_LISTENER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_MEDIA_SERVER_CRASH_LISTENER_H_
