...
JSC::HashTable JSCEnumerationInterface::InterfaceObject::property_table = {
...
};  // JSCEnumerationInterface::InterfaceObject::property_table
...
JSC::HashTable JSCEnumerationInterface::Prototype::property_table = {
    4,  // compactSize
    3,  // compactSizeMask
    property_table_values,
    NULL  // table allocated at runtime
};  // JSCEnumerationInterface::Prototype::property_table
...
JSC::HashTable JSCEnumerationInterface::property_table = {
    4,  // compactSize
    3,  // compactSizeMask
    property_table_values,
    NULL  // table allocated at runtime
};  // JSCEnumerationInterface::property_table
...
bool JSCEnumerationInterface::getOwnPropertySlot(JSC::JSCell* cell,
    JSC::ExecState* exec, JSC::PropertyName property_name,
    JSC::PropertySlot& slot) {
  TRACE_EVENT1("JSCEnumerationInterface", "getOwnPropertySlot", "property",
...
void JSCEnumerationInterface::put(JSC::JSCell* cell, JSC::ExecState* exec,
    JSC::PropertyName property_name, JSC::JSValue value,
    JSC::PutPropertySlot& slot) {
  TRACE_EVENT1("JSCEnumerationInterface", "put", "property",
               TRACE_STR_COPY(WTF::String(property_name.publicName()).utf8().data()));
  JSCEnumerationInterface* this_object = JSC::jsCast<JSCEnumerationInterface*>(cell);
  ASSERT_GC_OBJECT_INHERITS(this_object, &s_info);
...
void setJSenumProperty(
  ...
  EnumerationInterface::TestEnum cobalt_value;
