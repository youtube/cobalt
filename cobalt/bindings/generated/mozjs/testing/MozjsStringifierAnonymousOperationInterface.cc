...
InterfaceData* CreateCachedInterfaceData() {
  ...
  instance_class->name = "MozjsStringifierAnonymousOperationInterface";
  ...
  prototype_class->name = "MozjsStringifierAnonymousOperationInterfacePrototype";
  ...
  interface_object_class->name = "MozjsStringifierAnonymousOperationInterfaceConstructor";
