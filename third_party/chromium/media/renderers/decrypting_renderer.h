...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_DECRYPTING_RENDERER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_DECRYPTING_RENDERER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_DECRYPTING_RENDERER_H_
