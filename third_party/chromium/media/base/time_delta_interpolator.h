...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_TIME_DELTA_INTERPOLATOR_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_TIME_DELTA_INTERPOLATOR_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_TIME_DELTA_INTERPOLATOR_H_
