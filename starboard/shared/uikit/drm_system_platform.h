...
#ifndef INTERNAL_STARBOARD_SHARED_UIKIT_DRM_SYSTEM_PLATFORM_H_
#define INTERNAL_STARBOARD_SHARED_UIKIT_DRM_SYSTEM_PLATFORM_H_
...
#endif  // INTERNAL_STARBOARD_SHARED_UIKIT_DRM_SYSTEM_PLATFORM_H_
