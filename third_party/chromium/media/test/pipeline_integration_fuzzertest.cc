...
void OnEncryptedMediaInitData(media_m96::PipelineIntegrationTestBase* test,
                              media_m96::EmeInitDataType /* type */,
  ...
  base::ThreadTaskRunnerHandle::Get()->PostTask(
      FROM_HERE, base::BindOnce(&PipelineIntegrationTestBase::FailTest,
                                ...
                                media_m96::PIPELINE_ERROR_INITIALIZATION_FAILED));
}

void OnAudioPlayDelay(media_m96::PipelineIntegrationTestBase* test,
 ...
 public:
  ProgressivePipelineIntegrationFuzzerTest() {
    ...
    set_audio_play_delay_cb(
        base::BindPostTaskToCurrentDefault(base::BindRepeating(&OnAudioPlayDelay, this)));
  }
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
  ...
  ::testing::internal::GetUnitTestImpl()
      ...
      ->UponLeavingGTest();
  if (variant == SRC) {
    media_m96::ProgressivePipelineIntegrationFuzzerTest test;
    test.RunTest(data, size);
  } else {
    media_m96::MediaSourcePipelineIntegrationFuzzerTest test;
