...
#if defined(ENABLE_BUILDFLAG_ENABLE_COBALT_LINUX_HACKS)
#define BUILDFLAG_INTERNAL_ENABLE_COBALT_LINUX_HACKS() (1)
#else
#define BUILDFLAG_INTERNAL_ENABLE_COBALT_LINUX_HACKS() (0)
#endif
