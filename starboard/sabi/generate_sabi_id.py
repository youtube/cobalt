...
def _GenerateSabiId(filename, platform, omaha):
  ...
  This function will generate a sorted, whitespace-stripped, escaped string
  id of a Starboard ABI JSON file for the specified platform.

  Args:
    filename: The Starboard ABI JSON that will be used.
    platform: The platform whose Starboard ABI JSON will be used.
    omaha: Whether or not this string will be used for Omaha. When |True|, curly
      braces will be double-escaped.

  Returns:
    The final, processed string id of the Starboard ABI JSON for this platform.
  """
  if platform:
