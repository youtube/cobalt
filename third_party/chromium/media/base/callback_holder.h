...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_CALLBACK_HOLDER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_CALLBACK_HOLDER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_CALLBACK_HOLDER_H_
