...
using media_m96::cast::transport_util::kOptionPacerTargetBurstSize;
...
void CastTransportImpl::SetOptions(const base::DictionaryValue& options) {
  ...
  int burst_size = LookupOptionWithDefault(options, kOptionPacerTargetBurstSize,
                                           media_m96::cast::kTargetBurstSize);
  if (burst_size != media_m96::cast::kTargetBurstSize)
  ...
  if (burst_size != media_m96::cast::kMaxBurstSize)
