...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_VIDEO_ENCODER_FALLBACK_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_VIDEO_ENCODER_FALLBACK_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_VIDEO_ENCODER_FALLBACK_H_
