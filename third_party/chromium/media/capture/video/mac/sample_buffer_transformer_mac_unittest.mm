...
TEST(SampleBufferTransformerBestTransformerForNv12OutputTest,
  ...
  transformer->Reconfigure(
      ...
      kPixelFormatNv12, media_m96::GetSampleBufferSize(sample0));
  ...
  transformer->Reconfigure(
      ...
      kPixelFormatNv12, media_m96::GetSampleBufferSize(sample1));
...
TEST(SampleBufferTransformerBestTransformerForNv12OutputTest,
  ...
  transformer->Reconfigure(
      ...
      kPixelFormatNv12, media_m96::GetPixelBufferSize(pixel0));
  base::ScopedCFTypeRef<CVPixelBufferRef> output_buffer =
  ...
  transformer->Reconfigure(
      SampleBufferTransformer::kBestTransformerForPixelBufferToNv12Output,
      kPixelFormatNv12, media_m96::GetPixelBufferSize(pixel1));
...
TEST(SampleBufferTransformerBestTransformerForNv12OutputTest,
  ...
  transformer->Reconfigure(
      ...
      kPixelFormatNv12, media_m96::GetSampleBufferSize(sample));
  base::ScopedCFTypeRef<CVPixelBufferRef> output_buffer =
