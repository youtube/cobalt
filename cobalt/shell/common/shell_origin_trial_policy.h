...
#ifndef COBALT_SHELL_COMMON_SHELL_ORIGIN_TRIAL_POLICY_H_
#define COBALT_SHELL_COMMON_SHELL_ORIGIN_TRIAL_POLICY_H_
...
#endif  // COBALT_SHELL_COMMON_SHELL_ORIGIN_TRIAL_POLICY_H_
