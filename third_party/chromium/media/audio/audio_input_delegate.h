...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_INPUT_DELEGATE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_INPUT_DELEGATE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_INPUT_DELEGATE_H_
