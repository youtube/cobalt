...
#ifndef COBALT_USER_AGENT_USER_AGENT_PLATFORM_INFO_H_
#define COBALT_USER_AGENT_USER_AGENT_PLATFORM_INFO_H_
...
#endif  // COBALT_USER_AGENT_USER_AGENT_PLATFORM_INFO_H_
