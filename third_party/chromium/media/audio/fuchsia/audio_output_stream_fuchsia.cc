...
#include "third_party/chromium/media/audio/fuchsia/audio_output_stream_fuchsia.h"
...
#include "third_party/chromium/media/audio/fuchsia/audio_manager_fuchsia.h"
#include "third_party/chromium/media/base/audio_sample_types.h"
#include "third_party/chromium/media/base/audio_timestamp_helper.h"
...
fuchsia::media_m96::AudioRenderUsage GetStreamUsage(
    const AudioParameters& parameters) {
  if (parameters.latency_tag() == AudioLatency::LATENCY_RTC)
    return fuchsia::media_m96::AudioRenderUsage::COMMUNICATION;
  return fuchsia::media_m96::AudioRenderUsage::MEDIA;
}
...
bool AudioOutputStreamFuchsia::Open() {
  ...
  fuchsia::media_m96::AudioPtr audio_server =
      base::ComponentContextForProcess()
          ->svc()
          ->Connect<fuchsia::media_m96::Audio>();
  ...
  fuchsia::media_m96::AudioStreamType format;
  format.sample_format = fuchsia::media_m96::AudioSampleFormat::FLOAT;
