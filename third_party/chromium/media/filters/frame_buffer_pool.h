...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_FRAME_BUFFER_POOL_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_FRAME_BUFFER_POOL_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_FRAME_BUFFER_POOL_H_
