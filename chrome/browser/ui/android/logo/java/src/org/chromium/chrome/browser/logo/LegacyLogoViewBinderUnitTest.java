...
/** Unit tests for the {@link LegacyLogoViewBinder}. */
@RunWith(BaseRobolectricTestRunner.class)
@Config(manifest = Config.NONE)
public class LegacyLogoViewBinderUnitTest {
    @Rule public final MockitoRule mMockitoRule = MockitoJUnit.rule();
    private Activity mActivity;
    private PropertyModelChangeProcessor mPropertyModelChangeProcessor;
    private PropertyModel mLogoModel;
    private LegacyLogoView mLogoView;
    ...
    @Mock private LegacyLogoView mMockLogoView;
    ...
    public void setUp() {
        ...
        mLogoView = new LegacyLogoView(mActivity, null);
        LayoutParams params =
    ...
    public void testShowSearchProviderInitialView() {
        ...
        PropertyModelChangeProcessor.create(logoModel, mMockLogoView, new LegacyLogoViewBinder());
