...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_WIN_DXGI_DEVICE_MANAGER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_WIN_DXGI_DEVICE_MANAGER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_WIN_DXGI_DEVICE_MANAGER_H_
