...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_WSOLA_INTERNALS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_WSOLA_INTERNALS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_WSOLA_INTERNALS_H_
