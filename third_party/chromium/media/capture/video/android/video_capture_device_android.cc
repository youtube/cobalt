...
#include "third_party/chromium/media/capture/video/android/video_capture_device_android.h"
...
#include "third_party/chromium/media/capture/video/android/capture_jni_headers/VideoCapture_jni.h"
#include "third_party/chromium/media/capture/video/android/photo_capabilities.h"
...
void VideoCaptureDeviceAndroid::AllocateAndStart(
  ...
  if (!ret) {
    SetErrorState(media_m96::VideoCaptureError::kAndroidFailedToAllocate, FROM_HERE,
                  "failed to allocate");
    return;
  }
  ...
  if (!ret) {
    SetErrorState(media_m96::VideoCaptureError::kAndroidFailedToStartCapture,
...
void VideoCaptureDeviceAndroid::StopAndDeAllocate() {
  ...
  if (!ret) {
    SetErrorState(media_m96::VideoCaptureError::kAndroidFailedToStopCapture,
...
void VideoCaptureDeviceAndroid::OnError(JNIEnv* env,
  ...
  SetErrorState(
      static_cast<media_m96::VideoCaptureError>(android_video_capture_error),
...
void VideoCaptureDeviceAndroid::OnFrameDropped(
  ...
  if (!client_)
    return;
  client_->OnFrameDropped(static_cast<media_m96::VideoCaptureFrameDropReason>(
...
void VideoCaptureDeviceAndroid::SetErrorState(media_m96::VideoCaptureError error,
