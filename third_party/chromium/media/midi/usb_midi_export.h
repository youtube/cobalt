...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_MIDI_USB_MIDI_EXPORT_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_MIDI_USB_MIDI_EXPORT_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_MIDI_USB_MIDI_EXPORT_H_
