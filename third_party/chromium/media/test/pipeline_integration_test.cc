...
#include "third_party/chromium/media/base/cdm_callback_promise.h"
...
#include "third_party/chromium/media/base/mock_media_log.h"
#include "third_party/chromium/media/base/test_data_util.h"
#include "third_party/chromium/media/base/timestamp_constants.h"
#include "third_party/chromium/media/cdm/aes_decryptor.h"
#include "third_party/chromium/media/cdm/json_web_key.h"
...
class KeyProvidingApp : public FakeEncryptedMedia::AppBase {
 public:
  ...
  void OnReject(PromiseResult expected,
                media_m96::CdmPromise::Exception exception_code,
  ...
  std::unique_ptr<SimpleCdmPromise> CreatePromise(PromiseResult expected) {
    std::unique_ptr<media_m96::SimpleCdmPromise> promise(
        new media_m96::CdmCallbackPromise<>(
  ...
  std::unique_ptr<NewSessionCdmPromise> CreateSessionPromise(
    ...
    std::unique_ptr<media_m96::NewSessionCdmPromise> promise(
        new media_m96::CdmCallbackPromise<std::string>(
...
// evicted data shold be reflected in the change of media_m96::Pipeline buffered
