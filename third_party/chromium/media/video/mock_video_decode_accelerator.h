...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_MOCK_VIDEO_DECODE_ACCELERATOR_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_MOCK_VIDEO_DECODE_ACCELERATOR_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_MOCK_VIDEO_DECODE_ACCELERATOR_H_
