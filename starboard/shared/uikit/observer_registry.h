...
#ifndef INTERNAL_STARBOARD_SHARED_UIKIT_OBSERVER_REGISTRY_H_
#define INTERNAL_STARBOARD_SHARED_UIKIT_OBSERVER_REGISTRY_H_
...
#endif  // INTERNAL_STARBOARD_SHARED_UIKIT_OBSERVER_REGISTRY_H_
