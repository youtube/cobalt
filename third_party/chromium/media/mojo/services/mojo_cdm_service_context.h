...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_MOJO_SERVICES_MOJO_CDM_SERVICE_CONTEXT_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_MOJO_SERVICES_MOJO_CDM_SERVICE_CONTEXT_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_MOJO_SERVICES_MOJO_CDM_SERVICE_CONTEXT_H_
