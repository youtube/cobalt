...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_TEST_VIDEO_FRAME_HELPERS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_TEST_VIDEO_FRAME_HELPERS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_TEST_VIDEO_FRAME_HELPERS_H_
