...
InterfaceData* CreateCachedInterfaceData() {
  ...
  instance_class->name = "MozjsArbitraryInterface";
  ...
  prototype_class->name = "MozjsArbitraryInterfacePrototype";
  ...
  interface_object_class->name = "MozjsArbitraryInterfaceConstructor";
...
JSBool get_arbitraryProperty(
  ...
  ArbitraryInterface* impl =
      WrapperPrivate::GetWrappable<ArbitraryInterface>(object);
...
void InitializePrototypeAndInterfaceObject(
  ...
  const char name[] = "ArbitraryInterface";
  name_value.setString(JS_NewStringCopyZ(context, "ArbitraryInterface"));
  success =
...
// static
JSObject* MozjsArbitraryInterface::CreateInstance(
