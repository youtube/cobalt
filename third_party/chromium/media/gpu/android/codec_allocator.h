...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_CODEC_ALLOCATOR_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_CODEC_ALLOCATOR_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_CODEC_ALLOCATOR_H_
