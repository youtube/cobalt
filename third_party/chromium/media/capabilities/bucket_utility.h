...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAPABILITIES_BUCKET_UTILITY_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAPABILITIES_BUCKET_UTILITY_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAPABILITIES_BUCKET_UTILITY_H_
