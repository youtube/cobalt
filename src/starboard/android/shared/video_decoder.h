...
class VideoDecoder
 ...
 public:
  ...
  void onFrameRendered(int64_t presentation_time_us, int64_t render_at_system_time_ns);
  void OnPlaybackStatus(int action,
      double playback_rate, int64_t playback_at_time, SbTime seek_to_time_us);
 private:
