...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_GPU_MEMORY_BUFFER_UTILS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_GPU_MEMORY_BUFFER_UTILS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_GPU_MEMORY_BUFFER_UTILS_H_
