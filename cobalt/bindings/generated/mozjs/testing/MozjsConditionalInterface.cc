...
InterfaceData* CreateCachedInterfaceData() {
  ...
  instance_class->name = "MozjsConditionalInterface";
  ...
  prototype_class->name = "MozjsConditionalInterfacePrototype";
  ...
  interface_object_class->name = "MozjsConditionalInterfaceConstructor";
