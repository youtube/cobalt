...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_GPU_VIDEO_ENCODE_ACCELERATOR_FACTORY_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_GPU_VIDEO_ENCODE_ACCELERATOR_FACTORY_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_GPU_VIDEO_ENCODE_ACCELERATOR_FACTORY_H_
