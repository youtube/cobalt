...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_RENDERER_IMPL_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_RENDERER_IMPL_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_RENDERER_IMPL_H_
