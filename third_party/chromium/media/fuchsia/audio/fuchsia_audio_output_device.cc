...
#include "third_party/chromium/media/fuchsia/audio/fuchsia_audio_output_device.h"
...
void FuchsiaAudioOutputDevice::StartOnAudioThread() {
  ...
  media_pos_frames_ = 0;
  audio_consumer_->Start(fuchsia::media_m96::AudioConsumerStartFlags::LOW_LATENCY,
                         fuchsia::media_m96::NO_TIMESTAMP, 0);
...
void FuchsiaAudioOutputDevice::CreateStreamSink() {
  ...
  stream_type.sample_format = fuchsia::media_m96::AudioSampleFormat::FLOAT;
