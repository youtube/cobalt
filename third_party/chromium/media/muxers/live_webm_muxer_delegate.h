...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_MUXERS_LIVE_WEBM_MUXER_DELEGATE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_MUXERS_LIVE_WEBM_MUXER_DELEGATE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_MUXERS_LIVE_WEBM_MUXER_DELEGATE_H_
