...
void InspectorCSSAgent::ForcePseudoState(Element*,
...
void InspectorCSSAgent::DidReplaceStyleSheetText(CSSStyleSheet*,
                                                 const String&) {}
void InspectorCSSAgent::GetTextPosition(wtf_size_t,
                                        const String*,
                                        TextPosition*) {}
void InspectorCSSAgent::LocalFontsEnabled(bool*) {}
void InspectorCSSAgent::DidUpdateComputedStyle(Element*,
                                               const ComputedStyle*,
                                               const ComputedStyle*) {}
