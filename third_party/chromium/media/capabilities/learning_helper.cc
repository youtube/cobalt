...
#include "third_party/chromium/media/capabilities/learning_helper.h"

#include "base/task/post_task.h"
#include "base/task/thread_pool.h"
#include "third_party/chromium/media/learning/common/feature_library.h"
...
LearningHelper::LearningHelper(FeatureProviderFactoryCB feature_factory) {
  ...
  LearningTask dropped_frame_task(
      ...
      {
          {"codec_profile",
           ::media_m96::learning::LearningTask::Ordering::kUnordered},
          {"width", ::media_m96::learning::LearningTask::Ordering::kNumeric},
          {"height", ::media_m96::learning::LearningTask::Ordering::kNumeric},
          {"frame_rate", ::media_m96::learning::LearningTask::Ordering::kNumeric},
      },
  ...
  if (feature_factory) {
    ...
    dropped_frame_task.feature_descriptions.push_back(
        {"origin", ::media_m96::learning::LearningTask::Ordering::kUnordered});
    dropped_frame_task.feature_descriptions.push_back(
