...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_BUFFER_CONVERTER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_BUFFER_CONVERTER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_BUFFER_CONVERTER_H_
