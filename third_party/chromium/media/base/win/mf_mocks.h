...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_WIN_MF_MOCKS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_WIN_MF_MOCKS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_WIN_MF_MOCKS_H_
