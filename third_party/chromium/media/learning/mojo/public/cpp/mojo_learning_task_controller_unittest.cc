...
#include "third_party/chromium/media/learning/mojo/public/cpp/mojo_learning_task_controller.h"
...
class MojoLearningTaskControllerTest : public ::testing::Test {
 ...
 public:
  ...
  void SetUp() override {
    ...
    mojo::Remote<media_m96::learning::mojom::LearningTaskController> remote(
