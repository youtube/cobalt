...
InterfaceData* CreateCachedInterfaceData() {
  ...
  instance_class->name = "MozjsStaticPropertiesInterface";
  ...
  prototype_class->name = "MozjsStaticPropertiesInterfacePrototype";
  ...
  interface_object_class->name = "MozjsStaticPropertiesInterfaceConstructor";
