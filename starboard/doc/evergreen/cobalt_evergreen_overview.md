...
In order to verify the platform requirements you should run the `nplb` tests
defined under `nplb_evergreen_compat_tests` . These tests ensure that the
platform is configured appropriately for Evergreen.
