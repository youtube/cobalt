...
Note that the helper python script simply runs `elf_loader_sandbox --evergreen_content=. --evergreen_library=libnplb.so`, which you do manually instead if you prefer, changing the flag values as necessary.
