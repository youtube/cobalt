...
#ifndef INTERNAL_STARBOARD_SHARED_UIKIT_AV_SAMPLE_BUFFER_AUDIO_RENDERER_H_
#define INTERNAL_STARBOARD_SHARED_UIKIT_AV_SAMPLE_BUFFER_AUDIO_RENDERER_H_
...
#endif  // INTERNAL_STARBOARD_SHARED_UIKIT_AV_SAMPLE_BUFFER_AUDIO_RENDERER_H_
