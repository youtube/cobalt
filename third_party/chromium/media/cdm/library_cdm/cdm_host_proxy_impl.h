...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CDM_LIBRARY_CDM_CDM_HOST_PROXY_IMPL_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CDM_LIBRARY_CDM_CDM_HOST_PROXY_IMPL_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CDM_LIBRARY_CDM_CDM_HOST_PROXY_IMPL_H_
