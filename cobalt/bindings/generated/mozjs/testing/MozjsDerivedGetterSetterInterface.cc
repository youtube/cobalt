...
InterfaceData* CreateCachedInterfaceData() {
  ...
  instance_class->name = "MozjsDerivedGetterSetterInterface";
  ...
  prototype_class->name = "MozjsDerivedGetterSetterInterfacePrototype";
  ...
  interface_object_class->name = "MozjsDerivedGetterSetterInterfaceConstructor";
...
JSBool get_length(
  ...
  DerivedGetterSetterInterface* impl =
      WrapperPrivate::GetWrappable<DerivedGetterSetterInterface>(object);
...
void InitializePrototypeAndInterfaceObject(
  ...
  const char name[] = "DerivedGetterSetterInterface";
  name_value.setString(JS_NewStringCopyZ(context, "DerivedGetterSetterInterface"));
  success =
...
// static
JSObject* MozjsDerivedGetterSetterInterface::CreateInstance(
