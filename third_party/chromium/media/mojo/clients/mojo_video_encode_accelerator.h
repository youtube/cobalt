...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_MOJO_CLIENTS_MOJO_VIDEO_ENCODE_ACCELERATOR_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_MOJO_CLIENTS_MOJO_VIDEO_ENCODE_ACCELERATOR_H_
...
// remote media_m96::mojom::VideoEncodeAccelerator passed on ctor and held as
// |vea_|. An internal mojo::VEA::Client acts as the remote's mojo VEA client,
// trampolining methods to the media_m96::VEA::Client passed on Initialize(). For
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_MOJO_CLIENTS_MOJO_VIDEO_ENCODE_ACCELERATOR_H_
