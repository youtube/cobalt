...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_MEMORY_DATA_SOURCE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_MEMORY_DATA_SOURCE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_MEMORY_DATA_SOURCE_H_
