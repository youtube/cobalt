...
#include "third_party/chromium/media/renderers/default_decoder_factory.h"
...
#include "third_party/chromium/media/filters/decrypting_audio_decoder.h"
#include "third_party/chromium/media/filters/decrypting_video_decoder.h"
#endif
...
DefaultDecoderFactory::GetSupportedVideoDecoderConfigsForWebRTC() {
  ...
  if (!base::FeatureList::IsEnabled(media_m96::kExposeSwDecodersToWebRTC))
