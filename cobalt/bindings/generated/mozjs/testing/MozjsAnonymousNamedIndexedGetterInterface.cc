...
InterfaceData* CreateCachedInterfaceData() {
  ...
  instance_class->name = "MozjsAnonymousNamedIndexedGetterInterface";
  ...
  prototype_class->name = "MozjsAnonymousNamedIndexedGetterInterfacePrototype";
  ...
  interface_object_class->name = "MozjsAnonymousNamedIndexedGetterInterfaceConstructor";
...
JSBool get_length(
  ...
  AnonymousNamedIndexedGetterInterface* impl =
      WrapperPrivate::GetWrappable<AnonymousNamedIndexedGetterInterface>(object);
...
void InitializePrototypeAndInterfaceObject(
  ...
  const char name[] = "AnonymousNamedIndexedGetterInterface";
  name_value.setString(JS_NewStringCopyZ(context, "AnonymousNamedIndexedGetterInterface"));
  success =
...
// static
JSObject* MozjsAnonymousNamedIndexedGetterInterface::CreateInstance(
