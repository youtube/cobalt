...
class ClearKeyProperties : public KeySystemProperties {
 public:
  ...
  media_m96::EmeConfigRule GetEncryptionSchemeConfigRule(
      media_m96::EncryptionScheme encryption_scheme) const override {
...
KeySystemsImpl::KeySystemsImpl()
  ...
  for (size_t i = 0; i < std::size(kMimeTypeToCodecsMap); ++i) {
