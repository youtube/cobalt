...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_MOJO_SERVICES_DEFERRED_DESTROY_UNIQUE_RECEIVER_SET_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_MOJO_SERVICES_DEFERRED_DESTROY_UNIQUE_RECEIVER_SET_H_
...
class DeferredDestroyUniqueReceiverSet {
 ...
 private:
  void OnReceiverRemoved(std::unique_ptr<Interface> ptr) {
    ...
    // Use base::BindPostTaskToCurrentDefault() to force post the destroy callback. This is
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_MOJO_SERVICES_DEFERRED_DESTROY_UNIQUE_RECEIVER_SET_H_
