...
void StarboardRendererClient::OnMojoRendererInitialized(PipelineStatus status) {
  ...
  SetMojoRendererInitialized(true, status);
...
void StarboardRendererClient::SetMojoRendererInitialized(
  ...
  is_mojo_renderer_initialized_ = initialized;
  pipeline_status_ = status;
}

bool StarboardRendererClient::IsMojoRendererInitialized() {
  base::AutoLock auto_lock(lock_);
  return is_mojo_renderer_initialized_;
}

PipelineStatus StarboardRendererClient::pipeline_status() {
  base::AutoLock auto_lock(lock_);
...
void StarboardRendererClient::UpdateStarboardRenderingMode(
  ...
  // OnMojoRendererInitialized() should be called from
  // StarboardRenderer after this. In the case where
  // OnMojoRendererInitialized() is called before
  // this, run |init_cb_| if not null.
