...
#include "third_party/chromium/media/gpu/vaapi/h264_vaapi_video_decoder_delegate.h"
...
#include "third_party/chromium/media/gpu/vaapi/vaapi_common.h"
...
#define SHDRToSP(a) slice_param.a = slice_hdr->a
  ...
  static_assert(std::size(slice_param.RefPicList0) ==
                    std::size(slice_param.RefPicList1),
