...
/*
  The following open() error conditions are not tested due to the difficulty of
  reliably triggering them in a portable unit testing environment:

  - [EMFILE]/[ENFILE]: The process/system has run out of file descriptors.
  - [ENOSPC]: The filesystem is full.
  - [EROFS]: The filesystem is read-only.
  - [ENXIO]/[ETXTBSY]: Involve special files (devices, running executables).
