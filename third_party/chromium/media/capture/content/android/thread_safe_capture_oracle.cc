...
#include "third_party/chromium/media/capture/content/android/thread_safe_capture_oracle.h"
...
bool ThreadSafeCaptureOracle::ObserveEventAndDecideCapture(
  ...
  gfx::Size coded_size;
  media_m96::VideoCaptureDevice::Client::Buffer output_buffer;
...
void ThreadSafeCaptureOracle::ReportError(media_m96::VideoCaptureError error,
...
void ThreadSafeCaptureOracle::DidCaptureFrame(
  ...
  media_m96::VideoCaptureFormat format(frame->coded_size(),
