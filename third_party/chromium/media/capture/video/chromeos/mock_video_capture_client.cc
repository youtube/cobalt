...
#include "third_party/chromium/media/capture/video/chromeos/mock_video_capture_client.h"
...
void MockVideoCaptureClient::DumpError(media_m96::VideoCaptureError,
