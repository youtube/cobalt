...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_IMPL_FISHER_IRIS_DATASET_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_IMPL_FISHER_IRIS_DATASET_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_IMPL_FISHER_IRIS_DATASET_H_
