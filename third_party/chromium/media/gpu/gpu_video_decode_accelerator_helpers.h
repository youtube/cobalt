...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_GPU_VIDEO_DECODE_ACCELERATOR_HELPERS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_GPU_VIDEO_DECODE_ACCELERATOR_HELPERS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_GPU_VIDEO_DECODE_ACCELERATOR_HELPERS_H_
