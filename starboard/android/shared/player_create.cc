...
SbPlayer SbPlayerCreate(SbWindow window,
  ...
  if (creation_param->output_mode != kSbPlayerOutputModeDecodeToTexture &&
      ...
      // TODO: Now this code is also used to avoid creating multiple punch-out
      //       player as it happens to work as is.  We should consider refine
      //       the checking.  Note that even without the check here, SbPlayer
      //       will properly handle this by reporting error in VideoDecoder,
