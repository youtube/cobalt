...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_VAAPI_VA_SURFACE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_VAAPI_VA_SURFACE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_VAAPI_VA_SURFACE_H_
