...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_ALSA_ALSA_WRAPPER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_ALSA_ALSA_WRAPPER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_ALSA_ALSA_WRAPPER_H_
