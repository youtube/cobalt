...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_MOJO_CLIENTS_MOJO_RENDERER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_MOJO_CLIENTS_MOJO_RENDERER_H_
...
#include "third_party/chromium/media/base/time_delta_interpolator.h"
...
// A media_m96::Renderer that proxies to a mojom::Renderer. That
...
class MojoRenderer : public Renderer, public mojom::RendererClient {
 public:
  ...
  void Initialize(MediaResource* media_resource,
                  media_m96::RendererClient* client,
 ...
 private:
  ...
  void InitializeRendererFromStreams(media_m96::RendererClient* client);

  // Initialize the remote renderer when |media_resource| is of type
  // MediaResource::Type::URL.
  void InitializeRendererFromUrl(media_m96::RendererClient* client);
  ...
  void OnInitialized(media_m96::RendererClient* client, bool success);
  void OnFlushed();
  ...
  media_m96::RendererClient* client_ = nullptr;
  ...
  media_m96::TimeDeltaInterpolator media_time_interpolator_;
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_MOJO_CLIENTS_MOJO_RENDERER_H_
