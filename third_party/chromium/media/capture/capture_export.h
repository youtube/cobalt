...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_CAPTURE_EXPORT_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_CAPTURE_EXPORT_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_CAPTURE_EXPORT_H_
