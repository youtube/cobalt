...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_GPU_VIDEO_ACCELERATOR_FACTORIES_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_GPU_VIDEO_ACCELERATOR_FACTORIES_H_
...
class MEDIA_EXPORT GpuVideoAcceleratorFactories {
 public:
  ...
  virtual std::unique_ptr<media_m96::VideoDecoder> CreateVideoDecoder(
      MediaLog* media_log,
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_GPU_VIDEO_ACCELERATOR_FACTORIES_H_
