...
VideoDecodeAccelerator::SupportedProfile::SupportedProfile()
    : profile(media_m96::VIDEO_CODEC_PROFILE_UNKNOWN), encrypted_only(false) {}
...
void default_delete<media_m96::VideoDecodeAccelerator>::operator()(
    media_m96::VideoDecodeAccelerator* vda) const {
  vda->Destroy();
}
