    ...
    ['_toolset=="host"', {
      'actions': [
        ...
        '<(v8_inspector_js_protocol)',
          ...
          'outputs': [
          #  The stamp is generated by multiple targets depending on this.
          #  Cobalt's bulid system(probably gyp's fault) can not handle multiple
          #  taregting producing the same output.
