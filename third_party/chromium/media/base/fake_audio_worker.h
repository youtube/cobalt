...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_FAKE_AUDIO_WORKER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_FAKE_AUDIO_WORKER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_FAKE_AUDIO_WORKER_H_
