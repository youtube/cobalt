...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_SERIALIZERS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_SERIALIZERS_H_
...
#include "third_party/chromium/media/base/media_serializers_base.h"
  ...
  static base::Value Serialize(const gfx::HDRMetadata& value) {
    ...
    FIELD_SERIALIZE("primaries",
                    base::StringPrintf(
                        ...
                        value.color_volume_metadata.primaries.fRX,
                        value.color_volume_metadata.primaries.fRY,
                        value.color_volume_metadata.primaries.fGX,
                        value.color_volume_metadata.primaries.fGY,
                        value.color_volume_metadata.primaries.fBX,
                        value.color_volume_metadata.primaries.fBY,
                        value.color_volume_metadata.primaries.fWX,
                        value.color_volume_metadata.primaries.fWY));
    return result;
  }
};
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_SERIALIZERS_H_
