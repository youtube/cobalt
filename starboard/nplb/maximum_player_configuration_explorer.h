...
// The search process is carried out using the
// |SearchGradedPosetDepthFirstMultiplePathPruning|, where the
// |IsConfigCreatable| function is provided as the test function.
class MaximumPlayerConfigurationExplorer {
 ...
 private:
  ...
  // be passed as the |resource_types| parameter to
  // |SearchGradedPosetDepthFirstMultiplePathPruning| function.
