...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_VIDEO_CAPTURE_DEVICE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_VIDEO_CAPTURE_DEVICE_H_
...
class CAPTURE_EXPORT VideoFrameConsumerFeedbackObserver {
 public:
  ...
  virtual void OnUtilizationReport(int frame_feedback_id,
                                   media_m96::VideoCaptureFeedback feedback) {}
};
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_VIDEO_CAPTURE_DEVICE_H_
