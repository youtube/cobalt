...
public class VideoSurfaceView extends SurfaceView {
  ...
  private class SurfaceHolderCallback implements SurfaceHolder.Callback {
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
      ...
      if (sawInitialChange) {
        Log.e(TAG, "COBALT: Video surface changed; decoding may break");
      }
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
      currentSurface = null;
      nativeOnVideoSurfaceChanged(currentSurface);
      Log.e(TAG, "COBALT: surfaceDestroyed");
    }
  }
  ...
  private static VideoSurfaceView gVideoSurfaceView;

  @SuppressWarnings("unused")
  // @UsedByNative
  static void TryCreateVideoSurfaceView() {
    if (gVideoSurfaceView != null) {
      return;
    }

/*    // gVideoSurfaceView = new VideoSurfaceView(ContextUtils.getApplicationContext());
    ...
    new Runnable() {
      @Override 
      public void run() {
        gVideoSurfaceView = new VideoSurfaceView(activity);
        activity.addContentView(
          gVideoSurfaceView, new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
      }
    });
