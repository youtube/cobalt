...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_MEDIA_CRYPTO_CONTEXT_IMPL_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_MEDIA_CRYPTO_CONTEXT_IMPL_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_MEDIA_CRYPTO_CONTEXT_IMPL_H_
