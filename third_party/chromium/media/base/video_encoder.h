...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_VIDEO_ENCODER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_VIDEO_ENCODER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_VIDEO_ENCODER_H_
