...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_TEST_RANDOM_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_TEST_RANDOM_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_TEST_RANDOM_H_
