...
#include "third_party/chromium/media/renderers/win/media_foundation_renderer.h"
...
#include "third_party/chromium/media/base/win/test_utils.h"
...
class MediaFoundationRendererTest : public testing::Test {
 public:
  ...
  bool GetMediaFoundationCdmProxy(
    ...
    base::BindPostTaskToCurrentDefault(std::move(get_mf_cdm_proxy_cb)).Run(mf_cdm_proxy_);
    return true;
  }
