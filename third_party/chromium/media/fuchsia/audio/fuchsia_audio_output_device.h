...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_AUDIO_FUCHSIA_AUDIO_OUTPUT_DEVICE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_AUDIO_FUCHSIA_AUDIO_OUTPUT_DEVICE_H_
...
class MEDIA_EXPORT FuchsiaAudioOutputDevice : public AudioRendererSink {
 public:
  static scoped_refptr<FuchsiaAudioOutputDevice> Create(
      fidl::InterfaceHandle<fuchsia::media_m96::AudioConsumer>
 ...
 private:
  ...
  void OnAudioConsumerStatusChanged(fuchsia::media_m96::AudioConsumerStatus status);
  ...
  fuchsia::media_m96::AudioConsumerPtr audio_consumer_;
  fuchsia::media_m96::StreamSinkPtr stream_sink_;
  fuchsia::media_m96::audio::VolumeControlPtr volume_control_;
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_AUDIO_FUCHSIA_AUDIO_OUTPUT_DEVICE_H_
