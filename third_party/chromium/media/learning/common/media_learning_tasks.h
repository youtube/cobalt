...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_COMMON_MEDIA_LEARNING_TASKS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_COMMON_MEDIA_LEARNING_TASKS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_COMMON_MEDIA_LEARNING_TASKS_H_
