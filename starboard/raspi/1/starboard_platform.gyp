  ...
  'targets': [
    ...
    },
    {
      ...
      'sources': [
        ...
        '<(DEPTH)/starboard/stub/drm_close_session.cc',
        '<(DEPTH)/starboard/stub/drm_create_system.cc',
        '<(DEPTH)/starboard/stub/drm_destroy_system.cc',
        '<(DEPTH)/starboard/stub/drm_generate_session_update_request.cc',
        '<(DEPTH)/starboard/stub/drm_system_internal.h',
        '<(DEPTH)/starboard/stub/drm_update_session.cc',
        '<(DEPTH)/starboard/stub/media_is_supported.cc',
      ],
      'defines': [
