...
class NET_EXPORT TCPSocketStarboard {
 public:
  ...
  TCPSocketStarboard(const TCPSocketStarboard&) = delete;
  TCPSocketStarboard& operator=(const TCPSocketStarboard&) = delete;
  ...
  int SetIPv6Only(bool ipv6_only) { return 0; }
  ...
  int BindToNetwork(handles::NetworkHandle network) { return 0; }
