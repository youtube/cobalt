...
TEST(PosixLocaltimeTests, HandlesSpecificKnownPositiveTimeInDST) {
  ScopedTZ tz("America/New_York");
  // Timestamp for 2023-10-26 10:30:00 UTC which is Thu Oct 26 06:30:00 AM EDT 2023.
...
TEST(PosixLocaltimeTests, HandlesSpecificKnownPositiveTimeNotInDST) {
  ScopedTZ tz("America/New_York");
  // Timestamp for 2023-12-25 10:30:00 UTC which is Mon Dec 25 05:30:00 AM EST 2023.
  // Generated using: date -u -d "2023-12-25 10:30:00 UTC" +%s  (gives
  // 1703500200)
  ...
  CompareTm(*result_tm_ptr, expected_tm, "specific_time (2023-12-25)");
}

TEST(PosixLocaltimeTests, HandlesSpecificKnownPositiveTimeInDifferentTimezone) {
  ScopedTZ tz("Europe/Paris");
  // Timestamp for 2023-10-26 10:30:00 UTC which is Thu Oct 26 12:30:00 PM CEST 2023.
  // Generated using: date -u -d "2023-10-26 10:30:00 UTC" +%s  (gives
  // 1698316200)
  time_t specific_time = 1698316200;
...
TEST(PosixLocaltimeTests, HandlesNegativeTimeBeforeEpoch) {
  ScopedTZ tz("America/New_York");
...
TEST(PosixLocaltimeTests, ReturnsPointerToStaticBufferAndOverwrites) {
  ...
  // 2. Verify that the content of the static buffer now corresponds to the data for time2.
