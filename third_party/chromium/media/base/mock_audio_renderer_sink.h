...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_MOCK_AUDIO_RENDERER_SINK_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_MOCK_AUDIO_RENDERER_SINK_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_MOCK_AUDIO_RENDERER_SINK_H_
