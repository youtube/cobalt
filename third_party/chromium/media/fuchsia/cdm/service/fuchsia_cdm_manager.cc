...
#include "third_party/chromium/media/fuchsia/cdm/service/fuchsia_cdm_manager.h"
...
#include "third_party/chromium/media/fuchsia/cdm/service/provisioning_fetcher_impl.h"
...
class FuchsiaCdmManager::KeySystemClient {
 public:
  ...
  zx_status_t Bind(
      fidl::InterfaceHandle<fuchsia::media_m96::drm::KeySystem> key_system_handle,
 ...
 private:
  ...
  absl::optional<DataStoreId> GetDataStoreIdForPath(
    ...
    fuchsia::media_m96::drm::DataStoreParams params;
    ...
    key_system_->AddDataStore(
        ...
        [this, data_store_id, storage_path](
            fpromise::result<void, fuchsia::media_m96::drm::Error> result) {
          if (result.is_error()) {
  ...
  fuchsia::media_m96::drm::KeySystemPtr key_system_;
  ...
  // fuchsia::media_m96::drm::NO_DATA_STORE. The value will be incremented each time
  // we add a DataStore.
