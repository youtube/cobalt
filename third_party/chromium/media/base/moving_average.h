...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_MOVING_AVERAGE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_MOVING_AVERAGE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_MOVING_AVERAGE_H_
