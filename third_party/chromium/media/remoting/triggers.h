...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_REMOTING_TRIGGERS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_REMOTING_TRIGGERS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_REMOTING_TRIGGERS_H_
