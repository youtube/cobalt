...
//
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_WIN_AVRT_WRAPPER_WIN_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_WIN_AVRT_WRAPPER_WIN_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_WIN_AVRT_WRAPPER_WIN_H_
