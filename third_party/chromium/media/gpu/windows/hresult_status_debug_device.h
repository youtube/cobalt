...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_WINDOWS_HRESULT_STATUS_DEBUG_DEVICE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_WINDOWS_HRESULT_STATUS_DEBUG_DEVICE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_WINDOWS_HRESULT_STATUS_DEBUG_DEVICE_H_