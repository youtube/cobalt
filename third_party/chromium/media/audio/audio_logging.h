...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_LOGGING_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_LOGGING_H_
...
class AudioLog {
 public:
  ...
  // the created stream.
  virtual void OnCreated(const media_m96::AudioParameters& params,
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_LOGGING_H_
