...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FORMATS_WEBM_CLUSTER_BUILDER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FORMATS_WEBM_CLUSTER_BUILDER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FORMATS_WEBM_CLUSTER_BUILDER_H_
