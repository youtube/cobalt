...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_VIDEO_FRAME_FACTORY_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_VIDEO_FRAME_FACTORY_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_VIDEO_FRAME_FACTORY_H_
