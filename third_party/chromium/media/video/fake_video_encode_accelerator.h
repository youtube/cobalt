...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_FAKE_VIDEO_ENCODE_ACCELERATOR_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_FAKE_VIDEO_ENCODE_ACCELERATOR_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_FAKE_VIDEO_ENCODE_ACCELERATOR_H_
