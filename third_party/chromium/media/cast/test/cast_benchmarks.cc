...
#include "third_party/chromium/media/cast/test/skewed_single_thread_task_runner.h"
 ...
 public:
  ...
  void SendFakeVideoFrame() {
    ...
    cast_sender_->video_frame_input()->InsertRawVideoFrame(
        media_m96::VideoFrame::CreateColorFrame(gfx::Size(2, 2), 0x00, 0x80, 0x80,
  ...
  void BasicPlayerGotVideoFrame(scoped_refptr<media_m96::VideoFrame> video_frame,
...
int main(int argc, char** argv) {
  ...
  media_m96::cast::CastBenchmark benchmark;
