...
void InspectorPageAgent::FrameRequestedNavigation(Frame*,
                                                  const KURL&,
                                                  ClientNavigationReason,
                                                  NavigationPolicy) {}
void InspectorPageAgent::FrameScheduledNavigation(LocalFrame*,
                                                  const KURL&,
                                                  base::TimeDelta,
                                                  ClientNavigationReason) {}
void InspectorPageAgent::FrameClearedScheduledNavigation(LocalFrame*) {}
void InspectorPageAgent::WindowOpen(const KURL&,
                                    const AtomicString&,
...
void InspectorPageAgent::LifecycleEvent(LocalFrame*,
                                        DocumentLoader*,
                                        const char*,
                                        double) {}
void InspectorPageAgent::PaintTiming(Document*, const char*, double) {}
void InspectorPageAgent::DidProduceCompilationCache(const ClassicScript&,
                                                    v8::Local<v8::Script>) {}
void InspectorPageAgent::ApplyCompilationModeOverride(
    const ClassicScript&,
    v8::ScriptCompiler::CachedData**,
    v8::ScriptCompiler::CompileOptions*) {}
void InspectorPageAgent::FileChooserOpened(LocalFrame*,
                                           HTMLInputElement*,
                                           bool,
                                           bool*,
                                           bool*) {}
