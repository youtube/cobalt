...
// TODO: b/477798131 - This method should be removed.
...
PlayerWorker::~PlayerWorker() {
  ...
  job_thread_->ScheduleAndWait([this] { DoStop(); });

  // Once `job_thread_` is destroyed, the whole pipeline has been torn down and
