...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_CAST_ENVIRONMENT_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_CAST_ENVIRONMENT_H_
...
#include "third_party/chromium/media/cast/logging/log_event_dispatcher.h"
...
class CastEnvironment : public base::RefCountedThreadSafe<CastEnvironment> {
 public:
  ...
  // All of the media_m96::cast implementation must use this TickClock.
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_CAST_ENVIRONMENT_H_
