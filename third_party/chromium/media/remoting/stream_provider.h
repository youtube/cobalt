...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_REMOTING_STREAM_PROVIDER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_REMOTING_STREAM_PROVIDER_H_
...
class StreamProvider final : public Demuxer {
 ...
 private:
  // An implementation of media_m96::DemuxerStream on Media Remoting receiver.
...
template <>
struct default_delete<media_m96::remoting::StreamProvider> {
  constexpr default_delete() = default;

  template <typename U,
            typename = typename std::enable_if<std::is_convertible<
                U*,
                media_m96::remoting::StreamProvider*>::value>::type>
  explicit default_delete(const default_delete<U>& d) {}

  void operator()(media_m96::remoting::StreamProvider* ptr) const;
};

}  // namespace std

#endif  // THIRD_PARTY_CHROMIUM_MEDIA_REMOTING_STREAM_PROVIDER_H_
