...
InterfaceData* CreateCachedInterfaceData() {
  ...
  instance_class->name = "MozjsConstantsInterface";
  ...
  prototype_class->name = "MozjsConstantsInterfacePrototype";
  ...
  interface_object_class->name = "MozjsConstantsInterfaceConstructor";
...
void InitializePrototypeAndInterfaceObject(
  ...
  const char name[] = "ConstantsInterface";
  name_value.setString(JS_NewStringCopyZ(context, "ConstantsInterface"));
  success =
...
// static
JSObject* MozjsConstantsInterface::CreateInstance(
