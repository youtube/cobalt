...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_FAKE_AUDIO_OUTPUT_STREAM_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_FAKE_AUDIO_OUTPUT_STREAM_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_FAKE_AUDIO_OUTPUT_STREAM_H_
