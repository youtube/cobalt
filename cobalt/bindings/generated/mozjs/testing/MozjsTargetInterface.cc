...
InterfaceData* CreateCachedInterfaceData() {
  ...
  instance_class->name = "MozjsTargetInterface";
  ...
  prototype_class->name = "MozjsTargetInterfacePrototype";
  ...
  interface_object_class->name = "MozjsTargetInterfaceConstructor";
...
void InitializePrototypeAndInterfaceObject(
  ...
  const char name[] = "TargetInterface";
  name_value.setString(JS_NewStringCopyZ(context, "TargetInterface"));
  bool success =
