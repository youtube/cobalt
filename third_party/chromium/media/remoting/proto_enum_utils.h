...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_REMOTING_PROTO_ENUM_UTILS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_REMOTING_PROTO_ENUM_UTILS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_REMOTING_PROTO_ENUM_UTILS_H_
