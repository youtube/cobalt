...
#ifndef STARBOARD_SHARED_STARBOARD_PLAYER_FILTER_EXPERIMENTAL_FEATURES_H_
#define STARBOARD_SHARED_STARBOARD_PLAYER_FILTER_EXPERIMENTAL_FEATURES_H_
...
#endif  // STARBOARD_SHARED_STARBOARD_PLAYER_FILTER_EXPERIMENTAL_FEATURES_H_
