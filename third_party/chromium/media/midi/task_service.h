...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_MIDI_TASK_SERVICE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_MIDI_TASK_SERVICE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_MIDI_TASK_SERVICE_H_
