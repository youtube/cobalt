...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_MAC_AUDIO_INPUT_MAC_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_MAC_AUDIO_INPUT_MAC_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_MAC_AUDIO_INPUT_MAC_H_
