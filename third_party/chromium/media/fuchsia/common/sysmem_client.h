...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_COMMON_SYSMEM_CLIENT_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_COMMON_SYSMEM_CLIENT_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_COMMON_SYSMEM_CLIENT_H_
