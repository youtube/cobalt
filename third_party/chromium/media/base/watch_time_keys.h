...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_WATCH_TIME_KEYS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_WATCH_TIME_KEYS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_WATCH_TIME_KEYS_H_
