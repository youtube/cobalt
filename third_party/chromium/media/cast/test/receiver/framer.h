...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_TEST_RECEIVER_FRAMER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_TEST_RECEIVER_FRAMER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_TEST_RECEIVER_FRAMER_H_
