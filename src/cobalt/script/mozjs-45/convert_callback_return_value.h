...
#ifndef COBALT_SCRIPT_MOZJS_45_CONVERT_CALLBACK_RETURN_VALUE_H_
#define COBALT_SCRIPT_MOZJS_45_CONVERT_CALLBACK_RETURN_VALUE_H_
...
#endif  // COBALT_SCRIPT_MOZJS_45_CONVERT_CALLBACK_RETURN_VALUE_H_
