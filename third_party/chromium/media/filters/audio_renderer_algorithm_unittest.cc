...
#include "third_party/chromium/media/filters/audio_renderer_algorithm.h"
...
#include "third_party/chromium/media/filters/wsola_internals.h"
...
class AudioRendererAlgorithmTest : public testing::Test {
 public:
  ...
  void Initialize(ChannelLayout channel_layout,
    ...
    media_m96::AudioParameters::Format format =
        media_m96::AudioParameters::AUDIO_PCM_LINEAR;
    if (sample_format == kSampleFormatAc3)
      format = media_m96::AudioParameters::AUDIO_BITSTREAM_AC3;
    else if (sample_format == kSampleFormatEac3)
      format = media_m96::AudioParameters::AUDIO_BITSTREAM_EAC3;
