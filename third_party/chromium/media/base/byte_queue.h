...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_BYTE_QUEUE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_BYTE_QUEUE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_BYTE_QUEUE_H_
