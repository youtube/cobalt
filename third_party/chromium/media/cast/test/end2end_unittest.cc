 ...
 public:
  ...
  void CheckVideoFrame(bool examine_content,
    ...
    if (examine_content && expected_video_frame.should_be_continuous) {
      scoped_refptr<media_m96::VideoFrame> expected_I420_frame =
...
class End2EndTest : public ::testing::Test {
 public:
  void ReceivePacket(std::unique_ptr<media_m96::cast::Packet> packet) {
 ...
 protected:
  ...
  void SendVideoFrame(int frame_number, base::TimeTicks reference_time) {
    ...
    if (video_sender_config_.codec == CODEC_VIDEO_FAKE) {
      video_frame =
          media_m96::VideoFrame::CreateBlackFrame(GetTestVideoFrameSize());
    } else {
      const gfx::Size size = GetTestVideoFrameSize();
      video_frame = media_m96::VideoFrame::CreateFrame(
