...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_DEVICE_MONITORS_SYSTEM_MESSAGE_WINDOW_WIN_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_DEVICE_MONITORS_SYSTEM_MESSAGE_WINDOW_WIN_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_DEVICE_MONITORS_SYSTEM_MESSAGE_WINDOW_WIN_H_
