...
public class BundleUtils {
    ...
    // BUNDLES_SUPPORTED and ISOLATED_SPLITS_ENABLED were removed from
    // BuildConfig when bundle/isolated-split support was reworked upstream.
    // The cobalt/nplb apk is a plain (non-bundle) apk, so both are false.
