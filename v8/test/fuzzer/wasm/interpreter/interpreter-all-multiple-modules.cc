...
bool GenerateModuleWithExternalFuncs(
    ...
    std::vector<fuzzing::ExportData>* imports) {  v8::base::Vector<const uint8_t> wire_bytes =
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
  return LLVMFuzzerTestTwoModulesCommon(data, size,
                                        GenerateModuleWithExternalFuncs);
}
