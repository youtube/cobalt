...
namespace ui {
namespace {
struct KeyboardCodeConversionAndroidTestCase {
...
class KeyboardCodeConversionAndroidTest
    : public testing::TestWithParam<KeyboardCodeConversionAndroidTestCase> {
};

TEST_P(KeyboardCodeConversionAndroidTest, TestKeyboardCodeConversion) {
  const KeyboardCodeConversionAndroidTestCase& test_case = GetParam();

  EXPECT_EQ(KeyboardCodeFromAndroidKeyCode(test_case.input_keycode),
            test_case.expected_value);
}

INSTANTIATE_TEST_SUITE_P(KeyboardCodeConversionAndroidTestSuiteInstantiation, KeyboardCodeConversionAndroidTest,
testing::ValuesIn<KeyboardCodeConversionAndroidTestCase>({
  ...
  {"AKEYCODE_VOLUMNE_DOWN", AKEYCODE_VOLUME_DOWN, VKEY_VOLUME_DOWN},
  {"AKEYCODE_VOLUME_UP", AKEYCODE_VOLUME_UP, VKEY_VOLUME_UP},
  {"AKEYCODE_MEDIA_NEXT", AKEYCODE_MEDIA_NEXT, VKEY_MEDIA_NEXT_TRACK},
  {"AKEYCODE_MEDIA_PREVIOUS", AKEYCODE_MEDIA_PREVIOUS, VKEY_MEDIA_PREV_TRACK},
  ...
  {"AKEYCODE_MEDIA_PLAY_PAUSE", AKEYCODE_MEDIA_PLAY_PAUSE, VKEY_MEDIA_PLAY_PAUSE},
  ...
  {"AKEYCODE_MEDIA_FAST_FORWARD", AKEYCODE_MEDIA_FAST_FORWARD, VKEY_OEM_104},
...
// TODO: b/415832960 - Remove this buildflag when we create our own Cobalt mapping file.
...
}), [](const testing::TestParamInfo<KeyboardCodeConversionAndroidTest::ParamType>& info){return info.param.test_name;});
}  // namespace
}  // namespace ui
