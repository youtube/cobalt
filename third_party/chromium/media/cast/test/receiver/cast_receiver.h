...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_TEST_RECEIVER_CAST_RECEIVER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_TEST_RECEIVER_CAST_RECEIVER_H_
...
using VideoFrameDecodedCallback =
    base::RepeatingCallback<void(scoped_refptr<media_m96::VideoFrame> video_frame,
                                 base::TimeTicks playout_time,
                                 bool is_continuous)>;
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_TEST_RECEIVER_CAST_RECEIVER_H_
