...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AGC_AUDIO_STREAM_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AGC_AUDIO_STREAM_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AGC_AUDIO_STREAM_H_
