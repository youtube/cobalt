...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_MIDI_MIDI_MANAGER_WINRT_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_MIDI_MIDI_MANAGER_WINRT_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_MIDI_MIDI_MANAGER_WINRT_H_
