...
void CameraAppDeviceBridgeImpl::OnDeviceMojoDisconnected(
    const std::string& device_id) {
  auto remove_device = media_m96::base::BindPostTaskToCurrentDefault(
...
CameraAppDeviceBridgeImpl::GetOrCreateCameraAppDevice(
  ...
  auto device_impl = std::make_unique<media_m96::CameraAppDeviceImpl>(
