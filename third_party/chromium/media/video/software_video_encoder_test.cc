...
#include "third_party/chromium/media/video/video_encode_accelerator_adapter.h"
...
class SoftwareVideoEncoderTest
 ...
 public:
  ...
  std::unique_ptr<VideoEncoder> CreateEncoder(VideoCodec codec) {
    switch (codec) {
      case media_m96::VideoCodec::kVP8:
      case media_m96::VideoCodec::kVP9:
#if BUILDFLAG(ENABLE_LIBVPX)
        return std::make_unique<media_m96::VpxVideoEncoder>();
#else
        return nullptr;
#endif
      case media_m96::VideoCodec::kH264:
#if BUILDFLAG(ENABLE_OPENH264)
