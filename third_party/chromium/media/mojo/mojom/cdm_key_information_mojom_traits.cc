...
#include "third_party/chromium/media/mojo/mojom/cdm_key_information_mojom_traits.h"

#include "base/notreached.h"

namespace mojo {

using MojomKeyStatus = media_m96::mojom::CdmKeyStatus;
using NativeKeyStatus = media_m96::CdmKeyInformation::KeyStatus;
...
// static
bool StructTraits<media_m96::mojom::CdmKeyInformationDataView,
                  std::unique_ptr<media_m96::CdmKeyInformation>>::
    Read(media_m96::mojom::CdmKeyInformationDataView input,
  ...
  *output = std::make_unique<media_m96::CdmKeyInformation>(
