...
#ifndef STARBOARD_TVOS_SHARED_SEARCH_CONTROLLER_FOCUS_DELEGATE_H_
#define STARBOARD_TVOS_SHARED_SEARCH_CONTROLLER_FOCUS_DELEGATE_H_
...
#endif  // STARBOARD_TVOS_SHARED_SEARCH_CONTROLLER_FOCUS_DELEGATE_H_
