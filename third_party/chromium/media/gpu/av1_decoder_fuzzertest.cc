...
class FakeAV1Accelerator : public media_m96::AV1Decoder::AV1Accelerator {
 public:
  ...
  // media_m96::AV1Decoder::AV1Accelerator implementation.
  scoped_refptr<media_m96::AV1Picture> CreateAV1Picture(bool apply_grain) override {
    return base::MakeRefCounted<media_m96::AV1Picture>();
  }
  Status SubmitDecode(const media_m96::AV1Picture& pic,
                      const libgav1::ObuSequenceHeader& sequence_header,
                      const media_m96::AV1ReferenceFrameVector& ref_frames,
                      const libgav1::Vector<libgav1::TileBuffer>& tile_buffers,
                      base::span<const uint8_t> data) override {
    return Status::kOk;
  }
  bool OutputPicture(const media_m96::AV1Picture& pic) override { return true; }
};
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
  ...
  media_m96::AV1Decoder decoder(std::make_unique<FakeAV1Accelerator>(),
                            media_m96::AV1PROFILE_PROFILE_MAIN);
  ...
  for (int i = 0; i < 2; ++i) {
    ...
    scoped_refptr<media_m96::DecoderBuffer> decoder_buffer =
        media_m96::DecoderBuffer::CopyFrom(decoder_buffer_data.data(),
