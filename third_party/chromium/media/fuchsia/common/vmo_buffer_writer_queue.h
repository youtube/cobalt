...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_COMMON_VMO_BUFFER_WRITER_QUEUE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_COMMON_VMO_BUFFER_WRITER_QUEUE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_COMMON_VMO_BUFFER_WRITER_QUEUE_H_
