...
class CobaltRendererHostImpl
 ...
 public:
  ...
  CobaltRendererHostImpl(const CobaltRendererHostImpl&) = delete;
  CobaltRendererHostImpl& operator=(const CobaltRendererHostImpl&) = delete;

  // mojom::CobaltRendererHost implementation
  void ReportFullyDrawn() override;

 private:
  CobaltRendererHostImpl(
      content::RenderFrameHost& render_frame_host,
      mojo::PendingReceiver<performance::mojom::CobaltRendering> receiver);
};
