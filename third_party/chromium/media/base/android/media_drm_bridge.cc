...
#include "third_party/chromium/media/base/android/android_util.h"
#include "third_party/chromium/media/base/android/media_codec_util.h"
#include "third_party/chromium/media/base/android/media_drm_bridge_client.h"
#include "third_party/chromium/media/base/android/media_drm_bridge_delegate.h"
#include "third_party/chromium/media/base/android/media_jni_headers/MediaDrmBridge_jni.h"
#include "third_party/chromium/media/base/cdm_key_information.h"
#include "third_party/chromium/media/base/logging_override_if_enabled.h"
...
std::string ConvertInitDataType(media_m96::EmeInitDataType init_data_type) {
  ...
  switch (init_data_type) {
    case media_m96::EmeInitDataType::WEBM:
      return "video/webm";
    case media_m96::EmeInitDataType::CENC:
      return "video/mp4";
    case media_m96::EmeInitDataType::KEYIDS:
      return "keyids";
    default:
      NOTREACHED();
      return "unknown";
...
void MediaDrmBridge::CreateSessionAndGenerateRequest(
    ...
    media_m96::EmeInitDataType init_data_type,
