...
InterfaceData* CreateCachedInterfaceData() {
  ...
  instance_class->name = "MozjsDOMStringTestInterface";
  ...
  prototype_class->name = "MozjsDOMStringTestInterfacePrototype";
  ...
  interface_object_class->name = "MozjsDOMStringTestInterfaceConstructor";
