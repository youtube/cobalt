...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_PAINT_CANVAS_VIDEO_RENDERER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_PAINT_CANVAS_VIDEO_RENDERER_H_
...
class MEDIA_EXPORT PaintCanvasVideoRenderer {
 public:
  ...
  // |rgb_pixels|.
  static void ConvertVideoFrameToRGBPixels(const media_m96::VideoFrame* video_frame,
                                           void* rgb_pixels,
                                           size_t row_bytes,
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_PAINT_CANVAS_VIDEO_RENDERER_H_
