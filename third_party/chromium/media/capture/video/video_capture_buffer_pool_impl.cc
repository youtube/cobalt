...
#include "third_party/chromium/media/capture/video/video_capture_buffer_pool_impl.h"
...
#include "third_party/chromium/media/capture/video/video_capture_buffer_handle.h"
#include "third_party/chromium/media/capture/video/video_capture_buffer_pool_util.h"
#include "third_party/chromium/media/capture/video/video_capture_buffer_tracker.h"
#include "third_party/chromium/media/capture/video/video_capture_buffer_tracker_factory_impl.h"
#include "ui/gfx/buffer_format_util.h"

#if defined(OS_WIN)
#include "third_party/chromium/media/capture/video/win/video_capture_buffer_tracker_factory_win.h"
...
VideoCaptureBufferPoolImpl::VideoCaptureBufferPoolImpl(
    ...
    : buffer_type_(buffer_type),
      ...
      buffer_tracker_factory_(
          std::make_unique<media_m96::VideoCaptureBufferTrackerFactoryWin>())
#else
      buffer_tracker_factory_(
          std::make_unique<media_m96::VideoCaptureBufferTrackerFactoryImpl>())
#endif
{
  DCHECK_GT(count, 0);
}
