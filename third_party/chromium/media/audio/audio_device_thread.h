...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_DEVICE_THREAD_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_DEVICE_THREAD_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_DEVICE_THREAD_H_
