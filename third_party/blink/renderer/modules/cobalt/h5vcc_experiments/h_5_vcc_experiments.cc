...
bool H5vccExperiments::getFeature(const String& feature_name) {
  ...
  //   auto utf8 = feature_name.Utf8();
  //   feature.assign(utf8.data(), utf8.length());
  // }
  ...
  //                                                      &disable_features);
  // if (enable_features.find(feature) != std::string::npos) {
  //   result = true;
  // } else if (disable_features.find(feature) != std::string::npos) {
  //   result = false;
  // }
