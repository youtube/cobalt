...
media_m96::AudioOutputStream* MockAudioManager::MakeAudioOutputStream(
...
media_m96::AudioOutputStream* MockAudioManager::MakeAudioOutputStreamProxy(
    const media_m96::AudioParameters& params,
    const std::string& device_id) {
...
media_m96::AudioInputStream* MockAudioManager::MakeAudioInputStream(
    const media_m96::AudioParameters& params,
    const std::string& device_id,
    const LogCallback& log_callback) {
