...
#include "third_party/chromium/media/gpu/ipc/common/media_param_traits.h"

namespace IPC {

void ParamTraits<media_m96::BitstreamBuffer>::Write(base::Pickle* m,
                                                const param_type& p) {
  WriteParam(m, p.id());
...
bool ParamTraits<media_m96::BitstreamBuffer>::Read(const base::Pickle* m,
...
void ParamTraits<media_m96::BitstreamBuffer>::Log(const param_type& p,
                                              std::string* l) {
