...
#include "third_party/chromium/media/capture/video/linux/v4l2_capture_delegate.h"
...
#include "third_party/chromium/media/capture/video/blob_utils.h"
#include "third_party/chromium/media/capture/video/linux/video_capture_device_linux.h"

using media_m96::mojom::MeteringMode;
    ...
    if (buf_error_flag_set) {
      ...
      client_->OnFrameDropped(
          VideoCaptureFrameDropReason::kV4L2BufferErrorFlagWasSet);
               ...
               media_m96::VideoFrame::AllocationSize(capture_format_.pixel_format,
