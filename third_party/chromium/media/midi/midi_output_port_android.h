...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_MIDI_MIDI_OUTPUT_PORT_ANDROID_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_MIDI_MIDI_OUTPUT_PORT_ANDROID_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_MIDI_MIDI_OUTPUT_PORT_ANDROID_H_
