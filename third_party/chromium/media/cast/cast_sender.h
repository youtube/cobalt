...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_CAST_SENDER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_CAST_SENDER_H_
...
class VideoFrameInput : public base::RefCountedThreadSafe<VideoFrameInput> {
 public:
  ...
  virtual void InsertRawVideoFrame(scoped_refptr<media_m96::VideoFrame> video_frame,
  ...
  // and instantiate its own media_m96::VideoFrames.
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_CAST_SENDER_H_
