...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_REMOTING_RECEIVER_CONTROLLER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_REMOTING_RECEIVER_CONTROLLER_H_
...
class ReceiverController : mojom::RemotingSink {
 ...
 private:
  ...
  // media_m96::mojom::RemotingSink implementation.
  ...
  mojo::Remote<media_m96::mojom::Remotee> media_remotee_;
  mojo::Receiver<media_m96::mojom::RemotingSink> receiver_{this};
};

}  // namespace remoting
}  // namespace media_m96

#endif  // THIRD_PARTY_CHROMIUM_MEDIA_REMOTING_RECEIVER_CONTROLLER_H_
