...
void InitializePrototypeAndInterfaceObject(
  ...
  const char name[] = "GetOpaqueRootInterface";
  name_value.setString(JS_NewStringCopyZ(context, "GetOpaqueRootInterface"));
  success =
...
// static
JSObject* MozjsGetOpaqueRootInterface::CreateInstance(
