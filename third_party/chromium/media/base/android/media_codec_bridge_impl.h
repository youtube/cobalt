...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_MEDIA_CODEC_BRIDGE_IMPL_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_MEDIA_CODEC_BRIDGE_IMPL_H_
...
#include "third_party/chromium/media/base/android/media_codec_direction.h"
...
class MEDIA_EXPORT VideoCodecConfig {
 public:
  ...
  // called on an arbitrary thread, so use base::BindPostTaskToCurrentDefault if needed.
  //
...
class MEDIA_EXPORT MediaCodecBridgeImpl : public MediaCodecBridge {
 public:
  ...
  static std::unique_ptr<MediaCodecBridge> CreateVideoEncoder(
      VideoCodec codec,       // e.g. media_m96::VideoCodec::kVP8
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_MEDIA_CODEC_BRIDGE_IMPL_H_
