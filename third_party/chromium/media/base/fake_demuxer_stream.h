...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_FAKE_DEMUXER_STREAM_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_FAKE_DEMUXER_STREAM_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_FAKE_DEMUXER_STREAM_H_
