...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_VAAPI_VP9_SVC_LAYERS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_VAAPI_VP9_SVC_LAYERS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_VAAPI_VP9_SVC_LAYERS_H_
