...
#ifndef THIRD_PARTY_MUSL_SRC_STARBOARD_PTHREAD_PTHREAD_H_
#define THIRD_PARTY_MUSL_SRC_STARBOARD_PTHREAD_PTHREAD_H_
...
#endif  // THIRD_PARTY_MUSL_SRC_STARBOARD_PTHREAD_PTHREAD_H_
