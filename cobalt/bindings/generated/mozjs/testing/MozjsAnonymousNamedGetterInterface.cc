...
void InitializePrototypeAndInterfaceObject(
  ...
  const char name[] = "AnonymousNamedGetterInterface";
  name_value.setString(JS_NewStringCopyZ(context, "AnonymousNamedGetterInterface"));
  success =
...
// static
JSObject* MozjsAnonymousNamedGetterInterface::CreateInstance(
