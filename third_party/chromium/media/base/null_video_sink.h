...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_NULL_VIDEO_SINK_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_NULL_VIDEO_SINK_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_NULL_VIDEO_SINK_H_
