...
#include "third_party/chromium/media/mojo/services/mojo_audio_output_stream_provider.h"
...
class FakeDelegate : public AudioOutputDelegate {
 public:
  explicit FakeDelegate(
      mojo::PendingRemote<media_m96::mojom::AudioOutputStreamObserver>
          pending_observer)
 ...
 private:
  mojo::PendingRemote<media_m96::mojom::AudioOutputStreamObserver> observer_;
};
...
TEST(MojoAudioOutputStreamProviderTest, AcquireTwice_BadMessage) {
  ...
  provider_remote->Acquire(media_m96::AudioParameters::UnavailableDeviceParams(),
                           std::move(client_1));
...
TEST(MojoAudioOutputStreamProviderTest,
  ...
  mojo::Remote<mojom::AudioOutputStreamProvider> provider_remote;
  StrictMock<MockDeleter> deleter;
  media_m96::AudioParameters params =
      media_m96::AudioParameters::UnavailableDeviceParams();
