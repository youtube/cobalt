...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_CHUNK_DEMUXER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_CHUNK_DEMUXER_H_
...
#include "third_party/chromium/media/base/stream_parser.h"
#include "third_party/chromium/media/filters/source_buffer_parse_warnings.h"
#include "third_party/chromium/media/filters/source_buffer_state.h"
#include "third_party/chromium/media/filters/source_buffer_stream.h"
...
class MEDIA_EXPORT ChunkDemuxer : public Demuxer {
 ...
 private:
  ...
  ChunkDemuxer::Status AddIdInternal(
      const std::string& id,
      std::unique_ptr<media_m96::StreamParser> stream_parser,
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_CHUNK_DEMUXER_H_
