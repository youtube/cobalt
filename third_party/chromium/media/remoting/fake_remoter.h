...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_REMOTING_FAKE_REMOTER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_REMOTING_FAKE_REMOTER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_REMOTING_FAKE_REMOTER_H_
