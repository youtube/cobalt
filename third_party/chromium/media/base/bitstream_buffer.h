...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_BITSTREAM_BUFFER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_BITSTREAM_BUFFER_H_
...
class MEDIA_EXPORT BitstreamBuffer {
 public:
  ...
  // The timestamp is only valid if it's not equal to |media_m96::kNoTimestamp|.
 ...
 private:
  ...
  friend struct IPC::ParamTraits<media_m96::BitstreamBuffer>;
};

}  // namespace media_m96

#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_BITSTREAM_BUFFER_H_
