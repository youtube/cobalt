  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        # TODO[Starboard]: protobuf's port.h leaks memset definition. Fix that before
        # enabling these files.
...

    {
      ...
      'sources': [
        ...
        # Requires quic_trace third-party library, not supported yet.
    ...
    },
    {
      ...
      'sources': [
        ...
        'third_party/quic/tools/quic_simple_server_backend.h',
