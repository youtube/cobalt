...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_TEST_FAKE_MEDIA_SOURCE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_TEST_FAKE_MEDIA_SOURCE_H_
...
class FakeMediaSource final : public media_m96::AudioConverter::InputCallback {
 public:
  ...
  scoped_refptr<media_m96::VideoFrame> PopOldestInsertedVideoFrame();
 ...
 private:
  ...
  // media_m96::AudioConverter::InputCallback implementation.
  double ProvideInput(media_m96::AudioBus* output_bus,
  ...
  const media_m96::AudioParameters output_audio_params_;
  ...
  std::unique_ptr<media_m96::AudioConverter> audio_converter_;
  std::unique_ptr<media_m96::AudioFifo> audio_fifo_;
  std::unique_ptr<media_m96::AudioBus> audio_fifo_input_bus_;
  media_m96::AudioRendererAlgorithm audio_algo_;
  media_m96::NullMediaLog media_log_;

  // Track the timestamp of audio sent to the receiver.
  std::unique_ptr<media_m96::AudioTimestampHelper> audio_sent_ts_;
