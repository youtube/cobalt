...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_CDM_PROMISE_ADAPTER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_CDM_PROMISE_ADAPTER_H_
...
class MEDIA_EXPORT CdmPromiseAdapter {
 public:
  ...
  uint32_t SavePromise(std::unique_ptr<media_m96::CdmPromise> promise);
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_CDM_PROMISE_ADAPTER_H_
