...
#include "third_party/chromium/media/audio/win/audio_low_latency_input_win.h"
...
#include "third_party/chromium/media/audio/win/core_audio_util_win.h"
...
class WriteToFileAudioSink : public AudioInputStream::AudioInputCallback {
 ...
 private:
  media_m96::SeekableBuffer buffer_;
  FILE* binary_file_;
...
TEST_F(WinAudioInputTest, WASAPIAudioInputStreamHardwareSampleRate) {
  ...
  media_m96::AudioDeviceDescriptions device_descriptions;
...
TEST_P(WinAudioInputTest, WASAPIAudioInputStreamOpenStartStopAndClose) {
  ...
  use_raw_audio
      ? feature_list.InitAndEnableFeature(media_m96::kWasapiRawAudioCapture)
      : feature_list.InitAndDisableFeature(media_m96::kWasapiRawAudioCapture);
  ScopedAudioInputStream ais(
      CreateDefaultAudioInputStream(audio_manager_.get()));
