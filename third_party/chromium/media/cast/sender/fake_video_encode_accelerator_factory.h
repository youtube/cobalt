...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_FAKE_VIDEO_ENCODE_ACCELERATOR_FACTORY_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_FAKE_VIDEO_ENCODE_ACCELERATOR_FACTORY_H_
...
class FakeVideoEncodeAcceleratorFactory {
 public:
  ...
  // Set whether the next created media_m96::FakeVideoEncodeAccelerator will
  ...
  // Creates a media_m96::FakeVideoEncodeAccelerator.  If in auto-respond mode,
 ...
 private:
  ...
  std::unique_ptr<media_m96::VideoEncodeAccelerator> next_response_vea_;
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_FAKE_VIDEO_ENCODE_ACCELERATOR_FACTORY_H_
