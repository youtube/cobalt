...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_SOURCE_BUFFER_STREAM_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_SOURCE_BUFFER_STREAM_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_SOURCE_BUFFER_STREAM_H_
