...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_CAST_CONFIG_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_CAST_CONFIG_H_
...
typedef base::OnceCallback<void(scoped_refptr<base::SingleThreadTaskRunner>,
                                std::unique_ptr<media_m96::VideoEncodeAccelerator>)>
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_CAST_CONFIG_H_
