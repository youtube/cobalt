...
#ifndef STARTBOARD_TIZEN_SHARED_AUDIO_AUDIO_SINK_PRIVATE_H_
#define STARTBOARD_TIZEN_SHARED_AUDIO_AUDIO_SINK_PRIVATE_H_
...
#endif  // STARTBOARD_TIZEN_SHARED_AUDIO_AUDIO_SINK_PRIVATE_H_