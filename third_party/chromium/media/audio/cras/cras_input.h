...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_CRAS_CRAS_INPUT_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_CRAS_CRAS_INPUT_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_CRAS_CRAS_INPUT_H_
