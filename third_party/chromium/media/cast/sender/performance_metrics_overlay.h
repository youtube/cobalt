...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_PERFORMANCE_METRICS_OVERLAY_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_PERFORMANCE_METRICS_OVERLAY_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_PERFORMANCE_METRICS_OVERLAY_H_
