...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_EXTRACT_SPS_AND_PPS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_EXTRACT_SPS_AND_PPS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_EXTRACT_SPS_AND_PPS_H_
