...
from .check_coverage import parse_lcov_absolute_coverage, get_differential_coverage, main
...
"""
  ...
  def test_get_differential_coverage_success(self, mock_subprocess):
    ...
    mock_subprocess.assert_called_once_with([
        "diff-cover", self.lcov_file, "--compare-branch=origin/main",
  ...
  @mock.patch(
      'subprocess.run',
      side_effect=subprocess.CalledProcessError(1, "cmd", b"stdout", b"stderr"))
  ...
  @mock.patch('cobalt.tools.code_coverage.check_coverage.parse_lcov_absolute_coverage', return_value=85.0)
  @mock.patch('cobalt.tools.code_coverage.check_coverage.get_differential_coverage', return_value=90.0)
  ...
  @mock.patch('cobalt.tools.code_coverage.check_coverage.parse_lcov_absolute_coverage', return_value=100.0)
  @mock.patch('cobalt.tools.code_coverage.check_coverage.get_differential_coverage', return_value=100.0)
