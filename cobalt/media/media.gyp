...

{
  'targets': [
    ...
    {
      'target_name': 'media_format_unittests',
    ...
    {
      # Rename 'media_unittests' to 'media_unittests' once the original media
      # is removed.
    ...
    {
      # Rename 'media_qt_faststart' to 'qt_faststart' once the original media
      # is removed.
      'target_name': 'media_qt_faststart',
      'type': 'executable',
      'sources': [
    ...
    {
      # Rename 'media_seek_tester' to 'seek_tester' once the original media is
      # removed.
      'target_name': 'media_seek_tester',
      'type': 'executable',
      'dependencies': [
        'media',
        '<(DEPTH)/base/base.gyp:base',
    ...
    {
      # Rename 'media_demuxer_bench' to 'demuxer_bench' once the original media
      # is removed.
      'target_name': 'media_demuxer_bench',
      'type': 'executable',
      'dependencies': [
        'media',
        '<(DEPTH)/base/base.gyp:base',
