...
class InputEventsGenerator {
  ...
  //   application
  //   // events. The caller owns the new events and must delete them when done
  //   with
  //   // them.
  ...
  //                             GameActivityMotionEvent* android_event,
  //                             Events* events);
  //   void UpdateDeviceFlatMapIfNecessary(GameActivityMotionEvent*
  //   android_event,
  ...
  //   should
  //   // generate key unpressed events for it.  We store values for horizontal
  //   and
