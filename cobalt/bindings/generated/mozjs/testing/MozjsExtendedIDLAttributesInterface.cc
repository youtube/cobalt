...
InterfaceData* CreateCachedInterfaceData() {
  ...
  instance_class->name = "MozjsExtendedIDLAttributesInterface";
  ...
  prototype_class->name = "MozjsExtendedIDLAttributesInterfacePrototype";
  ...
  interface_object_class->name = "MozjsExtendedIDLAttributesInterfaceConstructor";
...
void InitializePrototypeAndInterfaceObject(
  ...
  const char name[] = "ExtendedIDLAttributesInterface";
  name_value.setString(JS_NewStringCopyZ(context, "ExtendedIDLAttributesInterface"));
  bool success =
...
// static
JSObject* MozjsExtendedIDLAttributesInterface::CreateInstance(
