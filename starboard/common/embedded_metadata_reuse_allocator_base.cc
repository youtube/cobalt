...
bool EmbeddedMetadataReuseAllocatorBase::MemoryBlock::Merge(
...
bool EmbeddedMetadataReuseAllocatorBase::MemoryBlock::CanFulfill(
    size_t request_size,
...
void EmbeddedMetadataReuseAllocatorBase::MemoryBlock::Allocate(
    size_t request_size,
    size_t alignment,
...
void EmbeddedMetadataReuseAllocatorBase::Free(void* memory) {
  if (memory == nullptr) {
    return;
  }
...
void EmbeddedMetadataReuseAllocatorBase::PrintAllocations(
...
bool EmbeddedMetadataReuseAllocatorBase::TryFree(void* memory) {
  if (!memory) {
    return true;
  }
...
EmbeddedMetadataReuseAllocatorBase::ExpandToFit(size_t size, size_t alignment) {
  if (ExtraLogLevel() >= 1) {
...
void EmbeddedMetadataReuseAllocatorBase::AddAllocatedBlock(
...
EmbeddedMetadataReuseAllocatorBase::FreeBlockSet::iterator
EmbeddedMetadataReuseAllocatorBase::AddFreeBlock(MemoryBlock block_to_add) {
