...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_LOG_MESSAGE_LEVELS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_LOG_MESSAGE_LEVELS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_LOG_MESSAGE_LEVELS_H_
