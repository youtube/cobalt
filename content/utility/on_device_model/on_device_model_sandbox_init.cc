...
#include "base/feature_list.h"#include "third_party/dawn/include/dawn/dawn_proc.h"          // nogncheck
...
#if !BUILDFLAG(IS_FUCHSIA) && !BUILDFLAG(IS_COBALT_HERMETIC_BUILD)
  if (base::FeatureList::IsEnabled(kOnDeviceModelWarmDrivers)) {    // Warm any relevant drivers before attempting to bring up the sandbox. For
