...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_FEEDBACK_SIGNAL_ACCUMULATOR_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_FEEDBACK_SIGNAL_ACCUMULATOR_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_FEEDBACK_SIGNAL_ACCUMULATOR_H_
