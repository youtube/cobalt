...
InterfaceData* CreateCachedInterfaceData() {
  ...
  instance_class->name = "MozjsExceptionObjectInterface";
  ...
  prototype_class->name = "MozjsExceptionObjectInterfacePrototype";
  ...
  interface_object_class->name = "MozjsExceptionObjectInterfaceConstructor";
...
JSBool get_error(
  ...
  ExceptionObjectInterface* impl =
      WrapperPrivate::GetWrappable<ExceptionObjectInterface>(object);
...
void InitializePrototypeAndInterfaceObject(
  ...
  const char name[] = "ExceptionObjectInterface";
  name_value.setString(JS_NewStringCopyZ(context, "ExceptionObjectInterface"));
  success =
...
// static
JSObject* MozjsExceptionObjectInterface::CreateInstance(
