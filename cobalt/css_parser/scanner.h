...
// YYLTYPE is generated by Bison and is used to store token location.
// See http://www.gnu.org/software/bison/manual/
// html_node/Actions-and-Locations.html#Actions-and-Locations
struct YYLTYPE;
