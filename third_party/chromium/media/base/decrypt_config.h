...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_DECRYPT_CONFIG_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_DECRYPT_CONFIG_H_
...
inline std::ostream& operator<<(std::ostream& os,
                                const media_m96::DecryptConfig& obj) {
  return obj.Print(os);
}

}  // namespace media_m96

#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_DECRYPT_CONFIG_H_
