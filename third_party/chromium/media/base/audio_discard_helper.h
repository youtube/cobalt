...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_DISCARD_HELPER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_DISCARD_HELPER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_DISCARD_HELPER_H_
