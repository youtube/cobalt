...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_TEST_DESTRUCTION_OBSERVABLE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_TEST_DESTRUCTION_OBSERVABLE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_TEST_DESTRUCTION_OBSERVABLE_H_
