# Starboard 18 POSIX APIs


## Background
Updating existing Chromium components in the Cobalt 27 repository or
bringing new ones requires porting to Starboard 18. This Starboardization process
...
Starboard 18 (and earlier versions like Starboard 16 and 17) e.g: `malloc()` - `SbMemoryAllocate()`,
