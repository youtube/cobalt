...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_MOCK_VIDEO_CAPTURE_DEVICE_CLIENT_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_MOCK_VIDEO_CAPTURE_DEVICE_CLIENT_H_
...
class MockVideoCaptureDeviceClient : public VideoCaptureDevice::Client {
 public:
  ...
  MOCK_METHOD3(OnError,
               void(media_m96::VideoCaptureError error,
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_MOCK_VIDEO_CAPTURE_DEVICE_CLIENT_H_
