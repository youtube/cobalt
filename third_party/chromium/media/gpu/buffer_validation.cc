...
bool VerifyGpuMemoryBufferHandle(media_m96::VideoPixelFormat pixel_format,
...
#if defined(OS_LINUX) || defined(OS_CHROMEOS)
  const size_t num_planes = media_m96::VideoFrame::NumPlanes(pixel_format);
  ...
  for (size_t i = 0; i < num_planes; i++) {
    ...
    size_t plane_height =
        media_m96::VideoFrame::Rows(i, pixel_format, coded_size.height());
