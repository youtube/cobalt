...
#ifndef INTERNAL_STARBOARD_SHARED_UIKIT_CRASH_HANDLER_H_
#define INTERNAL_STARBOARD_SHARED_UIKIT_CRASH_HANDLER_H_
...
#endif  // INTERNAL_STARBOARD_SHARED_UIKIT_CRASH_HANDLER_H_
