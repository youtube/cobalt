...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_VIDEO_RENDERER_ALGORITHM_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_VIDEO_RENDERER_ALGORITHM_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_VIDEO_RENDERER_ALGORITHM_H_
