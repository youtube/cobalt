...
#include "third_party/chromium/media/renderers/decrypting_renderer_factory.h"

#include "third_party/chromium/media/base/media_log.h"
#include "third_party/chromium/media/renderers/decrypting_renderer.h"
...
std::unique_ptr<Renderer> DecryptingRendererFactory::CreateRenderer(
  ...
  std::unique_ptr<media_m96::Renderer> renderer = renderer_factory_->CreateRenderer(
