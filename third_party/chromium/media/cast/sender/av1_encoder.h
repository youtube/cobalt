...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_AV1_ENCODER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_AV1_ENCODER_H_
...
#include "third_party/chromium/media/cast/sender/software_video_encoder.h"
...
class Av1Encoder final : public SoftwareVideoEncoder {
 public:
  ...
  void Encode(scoped_refptr<media_m96::VideoFrame> video_frame,
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_SENDER_AV1_ENCODER_H_
