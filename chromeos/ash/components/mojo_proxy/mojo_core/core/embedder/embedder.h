...
COMPONENT_EXPORT(MOJO_LEGACY_CORE_EMBEDDER) void InitFeatures();
...
// implementation.
COMPONENT_EXPORT(MOJO_LEGACY_CORE_EMBEDDER) void EnableMojoIpcz();
...
COMPONENT_EXPORT(MOJO_LEGACY_CORE_EMBEDDER) const IpczAPI& GetIpczAPIForMojo();
COMPONENT_EXPORT(MOJO_LEGACY_CORE_EMBEDDER)
