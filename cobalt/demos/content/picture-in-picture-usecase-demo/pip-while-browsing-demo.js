...
const vBbb1 = document.getElementById('video-bbb-1');
const vAd = document.getElementById('video-ad');
...
const urlAd = 'https://storage.googleapis.com/ytlr-cert.appspot.com/test-materials/media/vp9-live-1080p-30fps.webm';
...
window.addEventListener('keydown', (e) => {
  ...
  if (e.key === 'ArrowRight') {
    ...
    // Use the Center/OK button to enter or exit Picture-in-Picture mode.
