...
def run_comparison(uma_history, smaps_json):
...
def main():
  ...
  with tempfile.TemporaryDirectory() as tmpdir:
    ...
    if args.platform == 'android':
      cmd_batch.append('-d')
    subprocess.run(cmd_batch, check=True, capture_output=True)
