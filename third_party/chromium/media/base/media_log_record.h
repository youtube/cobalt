...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_LOG_RECORD_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_LOG_RECORD_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_LOG_RECORD_H_
