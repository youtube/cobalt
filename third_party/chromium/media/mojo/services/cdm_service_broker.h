...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_MOJO_SERVICES_CDM_SERVICE_BROKER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_MOJO_SERVICES_CDM_SERVICE_BROKER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_MOJO_SERVICES_CDM_SERVICE_BROKER_H_
