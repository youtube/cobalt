...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_RENDERER_MIXER_INPUT_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_RENDERER_MIXER_INPUT_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_RENDERER_MIXER_INPUT_H_
