...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_OUTPUT_DISPATCHER_IMPL_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_OUTPUT_DISPATCHER_IMPL_H_
...
class MEDIA_EXPORT AudioOutputDispatcherImpl
 ...
 private:
  ...
  using AudioLogMap =
      base::flat_map<AudioOutputStream*, std::unique_ptr<media_m96::AudioLog>>;
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_OUTPUT_DISPATCHER_IMPL_H_
