...
#ifndef INTERNAL_STARBOARD_SHARED_UIKIT_VPX_LOOP_FILTER_MANAGER_H_
#define INTERNAL_STARBOARD_SHARED_UIKIT_VPX_LOOP_FILTER_MANAGER_H_
...
#endif  // INTERNAL_STARBOARD_SHARED_UIKIT_VPX_LOOP_FILTER_MANAGER_H_
