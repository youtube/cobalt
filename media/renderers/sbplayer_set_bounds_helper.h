...
#ifndef MEDIA_RENDERERS_SBPLAYER_SET_BOUNDS_HELPER_H_
#define MEDIA_RENDERERS_SBPLAYER_SET_BOUNDS_HELPER_H_
...
#endif  // MEDIA_RENDERERS_SBPLAYER_SET_BOUNDS_HELPER_H_
