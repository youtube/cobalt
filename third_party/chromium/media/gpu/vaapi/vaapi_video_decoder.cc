...
#include "third_party/chromium/media/gpu/vaapi/av1_vaapi_video_decoder_delegate.h"
...
#include "third_party/chromium/media/gpu/vaapi/vp8_vaapi_video_decoder_delegate.h"
#include "third_party/chromium/media/gpu/vaapi/vp9_vaapi_video_decoder_delegate.h"
#include "third_party/chromium/media/media_buildflags.h"
#include "ui/gfx/buffer_format_util.h"

#if BUILDFLAG(ENABLE_PLATFORM_HEVC_DECODING)
#include "third_party/chromium/media/gpu/vaapi/h265_vaapi_video_decoder_delegate.h"
#endif
...
#if BUILDFLAG(IS_CHROMEOS_ASH)
    chromeos::ChromeOsCdmFactory::GetScreenResolutions(base::BindPostTaskToCurrentDefault(
