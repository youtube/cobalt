...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_CLOCKLESS_AUDIO_SINK_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_CLOCKLESS_AUDIO_SINK_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_CLOCKLESS_AUDIO_SINK_H_
