...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_LOG_PROPERTIES_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_LOG_PROPERTIES_H_
...
#include "third_party/chromium/media/base/media_log_type_enforcement.h"
...
enum class MediaLogProperty {
  ...
  // The name of media_m96::Renderer currently being used to play the media stream.
  kRendererName,
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_MEDIA_LOG_PROPERTIES_H_
