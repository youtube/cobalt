...
int main(int argc, char **argv) {
  ...
  if (network_type == "perfect") {
    ...
    in_pipe = media_m96::cast::test::GoodNetwork();
    out_pipe = media_m96::cast::test::GoodNetwork();
  ...
  media_m96::cast::test::QueueManager qm1(fd1, fd2, std::move(in_pipe));
  media_m96::cast::test::QueueManager qm2(fd2, fd1, std::move(out_pipe));
  CheckByteCounters();
