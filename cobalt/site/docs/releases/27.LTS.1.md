...
The Cobalt team has published **Cobalt 27 RC (Release Candidate)** including **Starboard API version 18** to the [27.lts](https://github.com/youtube/cobalt/tree/27.lts.1) branch with tag [27.lts.1](https://github.com/youtube/cobalt/tree/27.lts.1) (`27.lts.1.1040201`).

* [cobalt/CHANGELOG.md](https://github.com/youtube/cobalt/blob/27.lts.1/cobalt/CHANGELOG.md)
* [starboard/CHANGELOG.md](https://github.com/youtube/cobalt/blob/27.lts.1/starboard/CHANGELOG.md)
...
*   **Android (AOSP)**
    ...
    *   Preview available on tip of [27.lts](https://github.com/youtube/cobalt/tree/27.lts.1) branch

Migration guide from Cobalt 25 to Cobalt 27 is available here:

*   [starboard/doc/eap/25_to_27.md](https://github.com/youtube/cobalt/blob/27.lts.1/starboard/doc/eap/25_to_27.md)
...
*   For the latest changes, the code at tip in [27.lts](https://github.com/youtube/cobalt/tree/27.lts.1) is always available, but is under development and may be unstable.
...
*   [Starboard POSIX Reference](https://github.com/youtube/cobalt/blob/27.lts.1/starboard/doc/starboard_posix.md)
*   See the comprehensive list of changes in the [Starboard Changelog](https://github.com/youtube/cobalt/blob/27.lts.1/starboard/CHANGELOG.md).
...
### New Starboard APIs and Extensions ([Starboard Changelog](https://github.com/youtube/cobalt/blob/27.lts.1/starboard/CHANGELOG.md)):
...
*   **Crash Handling**
    * **CobaltExtensionCrashHandlerApi**
        ...
        *   Preview available on tip of [27.lts](https://github.com/youtube/cobalt/tree/27.lts.1)
