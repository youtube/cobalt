...
#include "third_party/chromium/media/video/fake_gpu_memory_buffer.h"
...
media_m96::VideoFrameMetadata GetFullVideoFrameMetadata() {
  ...
  metadata.transformation = media_m96::VIDEO_ROTATION_90;

  // media_m96::VideoFrameMetadata::CopyMode
  metadata.copy_mode = media_m96::VideoFrameMetadata::CopyMode::kCopyToNewTexture;
...
void VerifyVideoFrameMetadataEquality(const media_m96::VideoFrameMetadata& a,
                                      const media_m96::VideoFrameMetadata& b) {
