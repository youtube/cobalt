...
InterfaceData* CreateCachedInterfaceData() {
  ...
  instance_class->name = "MozjsDisabledInterface";
  ...
  prototype_class->name = "MozjsDisabledInterfacePrototype";
  ...
  interface_object_class->name = "MozjsDisabledInterfaceConstructor";
...
void InitializePrototypeAndInterfaceObject(
  ...
  const char name[] = "DisabledInterface";
  name_value.setString(JS_NewStringCopyZ(context, "DisabledInterface"));
  success =
