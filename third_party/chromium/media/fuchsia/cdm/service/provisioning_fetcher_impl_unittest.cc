...
#include "third_party/chromium/media/fuchsia/cdm/service/mock_provision_fetcher.h"
...
namespace drm = ::fuchsia::media_m96::drm;

using ::testing::_;
using ::testing::Eq;
using ::testing::Invoke;
using ::testing::WithArgs;
using MockProvisionFetcher = ::media_m96::testing::MockProvisionFetcher;
