...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_OUTPUT_PROXY_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_OUTPUT_PROXY_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_OUTPUT_PROXY_H_
