...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_CONTENT_DECRYPTION_MODULE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_CONTENT_DECRYPTION_MODULE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_CONTENT_DECRYPTION_MODULE_H_
