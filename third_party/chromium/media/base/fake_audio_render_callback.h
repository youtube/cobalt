...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_FAKE_AUDIO_RENDER_CALLBACK_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_FAKE_AUDIO_RENDER_CALLBACK_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_FAKE_AUDIO_RENDER_CALLBACK_H_
