...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_ALSA_ALSA_OUTPUT_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_ALSA_ALSA_OUTPUT_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_ALSA_ALSA_OUTPUT_H_
