...
TEST(ImmutableStringTest, ScriptGeneratedHashesMatch)
{
    ...
    ASSERT_EQ(0x00000279u, ImmutableString("transpose(E0B").mangledNameHash());
    ...
    ASSERT_EQ(0x00000297u, ImmutableString("memoryBarrier(").mangledNameHash());
    ...
    ASSERT_EQ(0x00000201u, ImmutableString("gl_HelperInvocation").mangledNameHash());
