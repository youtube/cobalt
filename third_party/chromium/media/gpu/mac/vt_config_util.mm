...
#include "third_party/chromium/media/gpu/mac/vt_config_util.h"
...
CFStringRef GetPrimaries(media_m96::VideoColorSpace::PrimaryID primary_id) {
  switch (primary_id) {
    case media_m96::VideoColorSpace::PrimaryID::BT709:
    case media_m96::VideoColorSpace::PrimaryID::UNSPECIFIED:  // Assume BT.709.
    case media_m96::VideoColorSpace::PrimaryID::INVALID:      // Assume BT.709.
      return kCMFormatDescriptionColorPrimaries_ITU_R_709_2;

    case media_m96::VideoColorSpace::PrimaryID::BT2020:
      return kCMFormatDescriptionColorPrimaries_ITU_R_2020;

    case media_m96::VideoColorSpace::PrimaryID::SMPTE170M:
    case media_m96::VideoColorSpace::PrimaryID::SMPTE240M:
      return kCMFormatDescriptionColorPrimaries_SMPTE_C;

    case media_m96::VideoColorSpace::PrimaryID::BT470BG:
      return kCMFormatDescriptionColorPrimaries_EBU_3213;

    case media_m96::VideoColorSpace::PrimaryID::SMPTEST431_2:
      return kCMFormatDescriptionColorPrimaries_DCI_P3;

    case media_m96::VideoColorSpace::PrimaryID::P3:
...
CFStringRef GetTransferFunction(
    media_m96::VideoColorSpace::TransferID transfer_id) {
  switch (transfer_id) {
    case media_m96::VideoColorSpace::TransferID::LINEAR:
    ...
    case media_m96::VideoColorSpace::TransferID::GAMMA22:
    case media_m96::VideoColorSpace::TransferID::GAMMA28:
      return kCMFormatDescriptionTransferFunction_UseGamma;

    case media_m96::VideoColorSpace::TransferID::SRGB:
    ...
    case media_m96::VideoColorSpace::TransferID::SMPTE170M:
    case media_m96::VideoColorSpace::TransferID::BT709:
    case media_m96::VideoColorSpace::TransferID::UNSPECIFIED:  // Assume BT.709.
    case media_m96::VideoColorSpace::TransferID::INVALID:      // Assume BT.709.
      return kCMFormatDescriptionTransferFunction_ITU_R_709_2;

    case media_m96::VideoColorSpace::TransferID::BT2020_10:
    case media_m96::VideoColorSpace::TransferID::BT2020_12:
      return kCMFormatDescriptionTransferFunction_ITU_R_2020;

    case media_m96::VideoColorSpace::TransferID::PQ:
      if (@available(macos 10.13, *))
    ...
    case media_m96::VideoColorSpace::TransferID::HLG:
      if (@available(macos 10.13, *))
    ...
    case media_m96::VideoColorSpace::TransferID::SMPTE240M:
      return kCMFormatDescriptionTransferFunction_SMPTE_240M_1995;

    case media_m96::VideoColorSpace::TransferID::SMPTEST428_1:
...
CFStringRef GetMatrix(media_m96::VideoColorSpace::MatrixID matrix_id) {
  switch (matrix_id) {
    case media_m96::VideoColorSpace::MatrixID::BT709:
    case media_m96::VideoColorSpace::MatrixID::UNSPECIFIED:  // Assume BT.709.
    case media_m96::VideoColorSpace::MatrixID::INVALID:      // Assume BT.709.
      return kCMFormatDescriptionYCbCrMatrix_ITU_R_709_2;

    case media_m96::VideoColorSpace::MatrixID::BT2020_NCL:
      return kCMFormatDescriptionYCbCrMatrix_ITU_R_2020;

    case media_m96::VideoColorSpace::MatrixID::FCC:
    case media_m96::VideoColorSpace::MatrixID::SMPTE170M:
    case media_m96::VideoColorSpace::MatrixID::BT470BG:
      // The FCC-based coefficients don't exactly match BT.601, but they're
      // close enough.
      return kCMFormatDescriptionYCbCrMatrix_ITU_R_601_4;

    case media_m96::VideoColorSpace::MatrixID::SMPTE240M:
...
void SetContentLightLevelInfo(const gfx::HDRMetadata& hdr_metadata,
  ...
  if (@available(macos 10.13, *)) {
    SetDictionaryValue(extensions,
                       ...
                       base::mac::CFToNSCast(
                           media_m96::GenerateContentLightLevelInfo(hdr_metadata)));
  } else {
...
void SetColorVolumeMetadata(const gfx::HDRMetadata& hdr_metadata,
  ...
  if (@available(macos 10.13, *)) {
    SetDictionaryValue(
        ...
        base::mac::CFToNSCast(
            media_m96::GenerateMasteringDisplayColorVolume(hdr_metadata)));
  } else {
...
void SetVp9CodecConfigurationBox(
    media_m96::VideoCodecProfile codec_profile,
    const media_m96::VideoColorSpace& color_space,
    NSMutableDictionary<NSString*, id>* extensions) {
  ...
  if (codec_profile == media_m96::VP9PROFILE_PROFILE2) {
    profile = 2;
    bit_depth = 10;
  }
