...
#ifndef STARBOARD_LINUX_X64WL_CONFIGURATION_PUBLIC_H_
#define STARBOARD_LINUX_X64WL_CONFIGURATION_PUBLIC_H_
...
#endif  // STARBOARD_LINUX_X64WL_CONFIGURATION_PUBLIC_H_
