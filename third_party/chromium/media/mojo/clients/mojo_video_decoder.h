...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_MOJO_CLIENTS_MOJO_VIDEO_DECODER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_MOJO_CLIENTS_MOJO_VIDEO_DECODER_H_
...
class MojoVideoDecoder final : public VideoDecoder,
 ...
 private:
  ...
  void OnChannelTokenReady(media_m96::mojom::CommandBufferIdPtr command_buffer_id,
                           base::OnceClosure complete_cb,
                           const base::UnguessableToken& channel_token);
  void InitAndConstructRemoteDecoder(
      media_m96::mojom::CommandBufferIdPtr command_buffer_id,
      base::OnceClosure complete_cb);
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_MOJO_CLIENTS_MOJO_VIDEO_DECODER_H_
