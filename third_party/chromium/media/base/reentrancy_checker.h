...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_REENTRANCY_CHECKER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_REENTRANCY_CHECKER_H_
...
//   #3 0x7f12edc8bfc6 media_m96::NonReentrantScope::NonReentrantScope()
...
#define NON_REENTRANT_SCOPE(name) ::media_m96::NonReentrantScope name##scope(name)
#else  // DCHECK_IS_ON()
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_REENTRANCY_CHECKER_H_
