...
using media_m96::cast::proto::AggregatedFrameEvent;
using media_m96::cast::proto::AggregatedPacketEvent;
using media_m96::cast::proto::BasePacketEvent;
using media_m96::cast::proto::LogMetadata;
...
TEST_F(EncodingEventSubscriberTest, EventFiltering) {
  ...
  EXPECT_EQ(media_m96::cast::proto::FRAME_DECODED,
...
TEST_F(EncodingEventSubscriberTest, FrameEvent) {
  ...
  EXPECT_EQ(media_m96::cast::proto::FRAME_DECODED, event->event_type(0));
...
TEST_F(EncodingEventSubscriberTest, FrameEventDelay) {
  ...
  ASSERT_EQ(1, event->event_type_size());
  EXPECT_EQ(media_m96::cast::proto::FRAME_PLAYOUT, event->event_type(0));
  ASSERT_EQ(1, event->event_timestamp_ms_size());
  EXPECT_EQ(InMilliseconds(now), event->event_timestamp_ms(0));
...
TEST_F(EncodingEventSubscriberTest, FrameEventSize) {
  ...
  ASSERT_EQ(1, event->event_type_size());
  EXPECT_EQ(media_m96::cast::proto::FRAME_ENCODED, event->event_type(0));
  ASSERT_EQ(1, event->event_timestamp_ms_size());
  EXPECT_EQ(InMilliseconds(now), event->event_timestamp_ms(0));
...
TEST_F(EncodingEventSubscriberTest, MultipleFrameEvents) {
...

  {
    ...
    EXPECT_EQ(media_m96::cast::proto::FRAME_PLAYOUT, event->event_type(0));
    EXPECT_EQ(media_m96::cast::proto::FRAME_DECODED, event->event_type(1));
...
TEST_F(EncodingEventSubscriberTest, PacketEvent) {
  ...
  EXPECT_EQ(media_m96::cast::proto::PACKET_RECEIVED,
...
TEST_F(EncodingEventSubscriberTest, MultiplePacketEventsForPacket) {
  ...
  EXPECT_EQ(media_m96::cast::proto::PACKET_SENT_TO_NETWORK,
            base_event.event_type(0));
  EXPECT_EQ(media_m96::cast::proto::PACKET_RETRANSMITTED,
