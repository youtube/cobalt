...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_WIN_MEDIA_FOUNDATION_CDM_PROXY_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_WIN_MEDIA_FOUNDATION_CDM_PROXY_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_WIN_MEDIA_FOUNDATION_CDM_PROXY_H_
