...
#include "third_party/chromium/media/filters/vp9_compressed_header_parser.h"
#include "third_party/chromium/media/filters/vp9_uncompressed_header_parser.h"
...
VideoColorSpace Vp9FrameHeader::GetColorSpace() const {
  ...
  switch (color_space) {
    ...
    case Vp9ColorSpace::SRGB:
      ret.primaries = VideoColorSpace::PrimaryID::BT709;
      ret.transfer = VideoColorSpace::TransferID::SRGB;
      ret.matrix = VideoColorSpace::MatrixID::BT709;
      break;
  }
  return ret;
