...
JSC::HashTable JSCArbitraryInterface::InterfaceObject::property_table = {
...
};  // JSCArbitraryInterface::InterfaceObject::property_table
...
JSC::HashTable JSCArbitraryInterface::Prototype::property_table = {
    9,  // compactSize
    7,  // compactSizeMask
    property_table_values,
    NULL  // table allocated at runtime
};  // JSCArbitraryInterface::Prototype::property_table
...
JSC::HashTable JSCArbitraryInterface::property_table = {
    4,  // compactSize
    3,  // compactSizeMask
    property_table_values,
    NULL  // table allocated at runtime
};  // JSCArbitraryInterface::property_table
...
bool JSCArbitraryInterface::getOwnPropertySlot(JSC::JSCell* cell,
    JSC::ExecState* exec, JSC::PropertyName property_name,
    JSC::PropertySlot& slot) {
  TRACE_EVENT1("JSCArbitraryInterface", "getOwnPropertySlot", "property",
...
void JSCArbitraryInterface::put(JSC::JSCell* cell, JSC::ExecState* exec,
    JSC::PropertyName property_name, JSC::JSValue value,
    JSC::PutPropertySlot& slot) {
  TRACE_EVENT1("JSCArbitraryInterface", "put", "property",
               TRACE_STR_COPY(WTF::String(property_name.publicName()).utf8().data()));
  JSCArbitraryInterface* this_object = JSC::jsCast<JSCArbitraryInterface*>(cell);
  ASSERT_GC_OBJECT_INHERITS(this_object, &s_info);
