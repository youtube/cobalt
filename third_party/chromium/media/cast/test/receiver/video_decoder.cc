...
class VideoDecoder::ImplBase
 ...
 protected:
  ...
  media_m96::VideoFramePool video_frame_pool_;
 ...
 private:
  ...
  scoped_refptr<VideoFrame> Decode(uint8_t* data, int len) final {
    ...
    libyuv::I420Copy(image->planes[VPX_PLANE_Y], image->stride[VPX_PLANE_Y],
                     ...
                     decoded_frame->visible_data(media_m96::VideoFrame::kYPlane),
                     decoded_frame->stride(media_m96::VideoFrame::kYPlane),
                     decoded_frame->visible_data(media_m96::VideoFrame::kUPlane),
                     decoded_frame->stride(media_m96::VideoFrame::kUPlane),
                     decoded_frame->visible_data(media_m96::VideoFrame::kVPlane),
                     decoded_frame->stride(media_m96::VideoFrame::kVPlane),
...
class VideoDecoder::FakeImpl final : public VideoDecoder::ImplBase {
 ...
 private:
  ...
  scoped_refptr<VideoFrame> Decode(uint8_t* data, int len) final {
    ...
    last_decoded_id_ = id;
    return media_m96::VideoFrame::CreateBlackFrame(gfx::Size(2, 2));
  }
