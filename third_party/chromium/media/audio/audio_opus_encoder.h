...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_OPUS_ENCODER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_OPUS_ENCODER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_OPUS_ENCODER_H_
