...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_IN_MEMORY_URL_PROTOCOL_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_IN_MEMORY_URL_PROTOCOL_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_IN_MEMORY_URL_PROTOCOL_H_
