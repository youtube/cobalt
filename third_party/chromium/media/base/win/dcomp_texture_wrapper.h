...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_WIN_DCOMP_TEXTURE_WRAPPER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_WIN_DCOMP_TEXTURE_WRAPPER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_WIN_DCOMP_TEXTURE_WRAPPER_H_
