...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_ENCODER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_ENCODER_H_
...
struct MEDIA_EXPORT EncodedAudioBuffer {
  EncodedAudioBuffer(const AudioParameters& params,
                     ...
                     base::TimeDelta duration = media_m96::kNoTimestamp);
  ...
  // A duration of media_m96::kNoTimestamp means we don't know the duration or don't
  // care about it.
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_ENCODER_H_
