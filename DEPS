...
vars = {
  ...
  'src_internal_revision': '72be70e45c7b591f2804381c1ec404d5438e255f',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': 'aad4ee35f544182797ae6c75f78d1f5d180e5402',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'pdfium_revision': '59ad47e26ad7024372c0e60bb09d9e150ca7a94b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '0bcb87744081e1b4f4a9ee8d5242caedb807aa5e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'fuzztest_revision': '1d61720657533c73cbffda1e909e2130fcae5029',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '4aefe6c4c90446ba8929a4b5f3dd7908be4dfe4b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'c77cb9bbcd295604893576d3f3377d61ca916243',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'quiche_revision': 'baa66af5e6095b5cb70efad1fcab3a5a2816c45c',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': '2s9UPnpZ2wm1Q4Ve00hkewkQQQCGMtAXn8cYFL-cfiEC',
          },
      ],
...
>>>>>>> c522bbe3365 (Import libc++/trunk from commit 34b0f973 (#6259))
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + '31f87824f2432e207dd4a9da2f3300f4530af65c',
  ...
  'src/clank': {
    ...
    '4bfe42c711371af764387775c2716075ba780b74',
  ...
  'src/ios/third_party/material_components_ios/src': {
      'url': Var('chromium_git') + '/external/github.com/material-components/material-components-ios.git' + '@' + '181be44663ebb6b5dc486ca7b2d959337f9819fc',
      'condition': 'checkout_ios',
  },
    ...
    'packages': [
      {
          ...
          'version': 'WQP_3VSZIlHutyvh9iEePkeKRMt8HhX4s8kh6W2249QC',
      },
    ],
    'condition': 'checkout_android and non_git_source',
    'dep_type': 'cipd',
      ...
      'packages': [
          {
               ...
               'version': 'fgLlp9RaOxtJuuPeWET3B6EvLyGvsuX_b9n9AbFup9IC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/chromite': {
      'url': Var('chromium_git') + '/chromiumos/chromite.git' + '@' + '12ceb773ef2dd7811e99028fcae74b162abe78c3',
      'condition': 'checkout_chromeos',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '245820b2b912adf17b6a530f0ff5b09abe537bf4',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@ab9b2d9a89352a7acd545f91dab3a03db7306b4f',
  'src/third_party/glslang/src': '{chromium_git}/external/github.com/KhronosGroup/glslang@ef5207f9f8cce5097568efb15d3297d8b5d13014',
  ...
  'src/third_party/spirv-tools/src': '{chromium_git}/external/github.com/KhronosGroup/SPIRV-Tools@9fa14b91414994e2bf4d9509b8efc8071f154991',
  ...
  'src/third_party/vulkan-loader/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-Loader@24e67179e2b0c7f9a2945927362c5ab0728e1fa8',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@4bebcc2a911fedd61312318d3a74709416fb8569',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '69dc7f7576d5d26252124dde2b762af4dd22d7db',
    ...
    'packages': [
      {
        ...
        'version': '-pkf-5WDMucZLiJG2FV-UQibpoK31YU24wMoyi0RJwYC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
    ...
    'packages': [
      {
        ...
        'version': 'ySs62uZ-KGylO-nTa0i_tXfjQZ6JKStLZLvqT7LZcIwC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
    ...
    'packages': [
      {
        ...
        'version': 'TTxhrhPI3aNbX33nJFacLMeiXC7jZ8VYNX5IBSYOUjUC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
    ...
    'packages': [
      {
        ...
        'version': 'mCFtIekQ0WhXGtdK4QEsplxjH9zNNw13eT3tkC74pbUC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
...
>>>>>>> 513c3cbbc2d (Reduce minSdkVersion to 24 and Downgrade Google Ads Identifier Version (#6077))
  ...
  'src/components/autofill/core/browser/form_parsing/internal_resources': {
      'url': Var('chrome_git') + '/chrome/components/autofill_regex_patterns.git' + '@' +
        '1c865c428e3d1b62dafa5fb5270b030ad7003b55',
      'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '27e74af0b8141efb894c3676fe89f0041ad24178',
