...
InterfaceData* CreateCachedInterfaceData() {
  ...
  instance_class->name = "MozjsAnonymousIndexedGetterInterface";
  ...
  prototype_class->name = "MozjsAnonymousIndexedGetterInterfacePrototype";
  ...
  interface_object_class->name = "MozjsAnonymousIndexedGetterInterfaceConstructor";
...
JSBool get_length(
  ...
  AnonymousIndexedGetterInterface* impl =
      WrapperPrivate::GetWrappable<AnonymousIndexedGetterInterface>(object);
...
void InitializePrototypeAndInterfaceObject(
  ...
  const char name[] = "AnonymousIndexedGetterInterface";
  name_value.setString(JS_NewStringCopyZ(context, "AnonymousIndexedGetterInterface"));
  success =
...
// static
JSObject* MozjsAnonymousIndexedGetterInterface::CreateInstance(
