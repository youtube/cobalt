...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_FEATURES_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_FEATURES_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_FEATURES_H_
