...
bool MediaCapabilitiesCache::IsWidevineSupported() {
  if (!is_enabled_) {
    return media_capabilities_provider_->IsWidevineSupported();
  }
...
bool MediaCapabilitiesCache::IsCbcsSchemeSupported() {
  if (!is_enabled_) {
    return media_capabilities_provider_->IsCbcsSchemeSupported();
  }
  std::lock_guard scoped_lock(mutex_);
  UpdateMediaCapabilities_Locked();
...
void MediaCapabilitiesCache::UpdateMediaCapabilities_Locked() {
  ...
  is_widevine_supported_ = media_capabilities_provider_->IsWidevineSupported();
  is_cbcs_supported_ = media_capabilities_provider_->IsCbcsSchemeSupported();
