...
#ifndef CHROME_BROWSER_UI_PAGE_ACTION_TEST_SUPPORT_MOCK_PAGE_ACTION_CONTROLLER_H_
#define CHROME_BROWSER_UI_PAGE_ACTION_TEST_SUPPORT_MOCK_PAGE_ACTION_CONTROLLER_H_
...
class MockPageActionController : public PageActionController {
 public:
  ...
  MOCK_METHOD(void,
              SetAnchoredMessageExpandableContent,
              (actions::ActionId,
...
#endif  // CHROME_BROWSER_UI_PAGE_ACTION_TEST_SUPPORT_MOCK_PAGE_ACTION_CONTROLLER_H_
