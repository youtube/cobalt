...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_FFMPEG_GLUE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_FFMPEG_GLUE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_FFMPEG_GLUE_H_
