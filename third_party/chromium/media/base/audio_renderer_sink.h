...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_RENDERER_SINK_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_RENDERER_SINK_H_
...
class AudioRendererSink
    : public base::RefCountedThreadSafe<media_m96::AudioRendererSink> {
 public:
...
class SwitchableAudioRendererSink : public RestartableAudioRendererSink {
 public:
  ...
  // the media_m96::OutputDeviceStatus enum.
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_AUDIO_RENDERER_SINK_H_
