...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_COMMON_LABELLED_EXAMPLE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_COMMON_LABELLED_EXAMPLE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_COMMON_LABELLED_EXAMPLE_H_
