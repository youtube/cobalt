...
#include "third_party/chromium/media/gpu/test/video_player/test_vda_video_decoder.h"
...
#include "third_party/chromium/media/gpu/gpu_video_decode_accelerator_factory.h"
#include "third_party/chromium/media/gpu/macros.h"
#include "third_party/chromium/media/gpu/test/video.h"
#include "third_party/chromium/media/gpu/test/video_player/frame_renderer.h"
#include "testing/gtest/include/gtest/gtest.h"

#if BUILDFLAG(USE_CHROMEOS_MEDIA_ACCELERATION)
#include "third_party/chromium/media/gpu/chromeos/platform_video_frame_utils.h"
#include "third_party/chromium/media/gpu/chromeos/vd_video_decode_accelerator.h"
#include "third_party/chromium/media/gpu/chromeos/video_decoder_pipeline.h"
...
void TestVDAVideoDecoder::Initialize(const VideoDecoderConfig& config,
  ...
  if (use_vd_vda_) {
    ...
    decoder_ = media_m96::VdVideoDecodeAccelerator::Create(
        base::BindRepeating(&media_m96::VideoDecoderPipeline::Create), this,
...
void TestVDAVideoDecoder::PictureReady(const Picture& picture) {
  ...
  if (!picture.visible_rect().IsEmpty()) {
    if (!video_frame->HasTextures()) {
      ...
      gpu::MailboxHolder mailbox_holders[media_m96::VideoFrame::kMaxPlanes];
