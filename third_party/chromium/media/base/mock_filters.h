...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_MOCK_FILTERS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_MOCK_FILTERS_H_
...
class MockMediaClient : public media_m96::MediaClient {
 public:
  MockMediaClient();
  ...
  MOCK_METHOD1(AddSupportedKeySystems,
               void(std::vector<std::unique_ptr<media_m96::KeySystemProperties>>*
                        key_systems));
  MOCK_METHOD0(IsKeySystemsUpdateNeeded, bool());
  MOCK_METHOD1(IsSupportedAudioType, bool(const media_m96::AudioType& type));
  MOCK_METHOD1(IsSupportedVideoType, bool(const media_m96::VideoType& type));
  MOCK_METHOD1(IsSupportedBitstreamAudioCodec, bool(media_m96::AudioCodec codec));
  MOCK_METHOD1(GetAudioRendererAlgorithmParameters,
               absl::optional<::media_m96::AudioRendererAlgorithmParameters>(
                   media_m96::AudioParameters audio_parameters));
};

}  // namespace media_m96

#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_MOCK_FILTERS_H_
