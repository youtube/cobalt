...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_TEST_VIDEO_ENCODER_VIDEO_ENCODER_TEST_ENVIRONMENT_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_TEST_VIDEO_ENCODER_VIDEO_ENCODER_TEST_ENVIRONMENT_H_
...
class VideoEncoderTestEnvironment : public VideoTestEnvironment {
 public:
  ...
  media_m96::test::Video* Video() const;
  // Generate the nv12 video from |video_| the test will be ran on.
  media_m96::test::Video* GenerateNV12Video();
 ...
 private:
  VideoEncoderTestEnvironment(std::unique_ptr<media_m96::test::Video> video,
                              bool enable_bitstream_validator,
                              const base::FilePath& output_folder,
  ...
  std::unique_ptr<media_m96::test::Video> nv12_video_;
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_TEST_VIDEO_ENCODER_VIDEO_ENCODER_TEST_ENVIRONMENT_H_
