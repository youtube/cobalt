...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_NET_UDP_PACKET_PIPE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_NET_UDP_PACKET_PIPE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_NET_UDP_PACKET_PIPE_H_
