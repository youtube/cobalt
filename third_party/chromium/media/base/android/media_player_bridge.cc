...
#include "third_party/chromium/media/base/android/media_player_bridge.h"
...
#include "third_party/chromium/media/base/android/media_common_android.h"
#include "third_party/chromium/media/base/android/media_jni_headers/MediaPlayerBridge_jni.h"
#include "third_party/chromium/media/base/android/media_resource_getter.h"
#include "third_party/chromium/media/base/android/media_url_interceptor.h"
...
void MediaPlayerBridge::Initialize() {
  ...
  if (allow_credentials_ && !url_.SchemeIsFile()) {
    media_m96::MediaResourceGetter* resource_getter =
...
bool MediaPlayerBridge::InterceptMediaUrl(const std::string& url,
  ...
  *offset = kUnsetValue;
  *size = kUnsetValue;
  media_m96::MediaUrlInterceptor* url_interceptor =
...
base::TimeDelta MediaPlayerBridge::GetDuration() {
  ...
  return duration_ms < 0 ? media_m96::kInfiniteDuration
