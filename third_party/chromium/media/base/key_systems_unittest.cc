 ...
 public:
  ...
  EmeConfigRule GetEncryptionSchemeConfigRule(
    ...
    switch (encryption_scheme) {
      case media_m96::EncryptionScheme::kUnencrypted:
      case media_m96::EncryptionScheme::kCenc:
        return media_m96::EmeConfigRule::SUPPORTED;
      case media_m96::EncryptionScheme::kCbcs:
        return media_m96::EmeConfigRule::HW_SECURE_CODECS_NOT_ALLOWED;
    }
    NOTREACHED();
    return media_m96::EmeConfigRule::NOT_SUPPORTED;
  }
...
class TestMediaClient : public MediaClient {
 public:
  ...
  bool IsSupportedAudioType(const media_m96::AudioType& type) final;
  bool IsSupportedVideoType(const media_m96::VideoType& type) final;
  ...
  absl::optional<::media_m96::AudioRendererAlgorithmParameters>
...
bool TestMediaClient::IsSupportedAudioType(const media_m96::AudioType& type) {
  return true;
}

bool TestMediaClient::IsSupportedVideoType(const media_m96::VideoType& type) {
  return true;
}
