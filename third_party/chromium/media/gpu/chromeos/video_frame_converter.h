...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_CHROMEOS_VIDEO_FRAME_CONVERTER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_CHROMEOS_VIDEO_FRAME_CONVERTER_H_
...
template <>
struct MEDIA_GPU_EXPORT default_delete<media_m96::VideoFrameConverter> {
  void operator()(media_m96::VideoFrameConverter* ptr) const;
};

}  // namespace std

#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_CHROMEOS_VIDEO_FRAME_CONVERTER_H_
