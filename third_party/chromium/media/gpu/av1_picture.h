...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_AV1_PICTURE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_AV1_PICTURE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_AV1_PICTURE_H_
