...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_COMMON_VALUE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_COMMON_VALUE_H_
 ...
 public:
  ...
  explicit Value(const T& x) : value_(x) {
    ...
    static_assert(std::is_arithmetic<T>::value || std::is_enum<T>::value,
                  "media_m96::learning::Value works only with arithmetic types");
  }
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_COMMON_VALUE_H_
