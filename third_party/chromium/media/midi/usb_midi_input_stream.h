...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_MIDI_USB_MIDI_INPUT_STREAM_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_MIDI_USB_MIDI_INPUT_STREAM_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_MIDI_USB_MIDI_INPUT_STREAM_H_
