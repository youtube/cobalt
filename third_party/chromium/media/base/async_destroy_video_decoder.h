...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_ASYNC_DESTROY_VIDEO_DECODER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_ASYNC_DESTROY_VIDEO_DECODER_H_
 ...
 public:
  explicit AsyncDestroyVideoDecoder(std::unique_ptr<T> wrapped_decoder)
    ...
    static_assert(std::is_base_of<VideoDecoder, T>::value,
                  "T must implement 'media_m96::VideoDecoder'");
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_ASYNC_DESTROY_VIDEO_DECODER_H_
