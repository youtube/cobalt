...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FORMATS_COMMON_STREAM_PARSER_TEST_BASE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FORMATS_COMMON_STREAM_PARSER_TEST_BASE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FORMATS_COMMON_STREAM_PARSER_TEST_BASE_H_
