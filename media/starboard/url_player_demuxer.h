...
// exposes placeholder streams because the current Chromium pipeline and Mojo
// renderer initialization are stream-based. StarboardRenderer receives the URL
// through the Starboard renderer extension and creates the native URL player.
