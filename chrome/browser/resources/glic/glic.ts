...
export {ObservableSetByTabId} from './glic_api_impl/client/glic_api_client.js';
export type {ObservableSetByTabIdDelegate, ObservableSetByTabIdObservable} from './glic_api_impl/client/glic_api_client.js';
