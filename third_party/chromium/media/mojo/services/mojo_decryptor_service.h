...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_MOJO_SERVICES_MOJO_DECRYPTOR_SERVICE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_MOJO_SERVICES_MOJO_DECRYPTOR_SERVICE_H_
...
class MEDIA_MOJO_EXPORT MojoDecryptorService final : public mojom::Decryptor {
 public:
  using StreamType = media_m96::Decryptor::StreamType;
  using Status = media_m96::Decryptor::Status;
  ...
  MojoDecryptorService(media_m96::Decryptor* decryptor,
 ...
 private:
  ...
  void OnAudioDecoded(DecryptAndDecodeAudioCallback callback,
                      Status status,
                      const media_m96::Decryptor::AudioFrames& frames);
  ...
  media_m96::Decryptor* decryptor_;
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_MOJO_SERVICES_MOJO_DECRYPTOR_SERVICE_H_
