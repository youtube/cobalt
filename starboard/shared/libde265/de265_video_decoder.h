...
#ifndef STARBOARD_SHARED_LIBDE265_DE265_VIDEO_DECODER_H_
#define STARBOARD_SHARED_LIBDE265_DE265_VIDEO_DECODER_H_
...
class De265VideoDecoder : public VideoDecoder, private JobQueue::JobOwner {
 public:
  De265VideoDecoder(JobQueue* job_queue,
 ...
 private:
  ...
  void ProcessDecodedImage(bool flushing);
