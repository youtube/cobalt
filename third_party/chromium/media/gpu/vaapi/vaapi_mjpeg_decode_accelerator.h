...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_VAAPI_VAAPI_MJPEG_DECODE_ACCELERATOR_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_VAAPI_VAAPI_MJPEG_DECODE_ACCELERATOR_H_
...
class MEDIA_GPU_EXPORT VaapiMjpegDecodeAccelerator
 ...
 private:
  ...
  std::unique_ptr<media_m96::VaapiJpegDecoder> decoder_;
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_VAAPI_VAAPI_MJPEG_DECODE_ACCELERATOR_H_
