...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_TEST_IMAGE_QUALITY_METRICS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_TEST_IMAGE_QUALITY_METRICS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_TEST_IMAGE_QUALITY_METRICS_H_
