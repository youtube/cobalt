...
// this property.
public class AOSPStarboardBridge {

  /** Interface to be implemented by the Android Application hosting the starboard app. */
  public interface HostApplication {
    void setStarboardBridge(AOSPStarboardBridge starboardBridge);

    AOSPStarboardBridge getStarboardBridge();
  }
  ...
  public AOSPStarboardBridge(
    ...
    Log.i(TAG, "AOSPStarboardBridge init.");
    ...
    AOSPStarboardBridgeJni.get().initJNI(this);
    ...
    AOSPStarboardBridgeJni.get().handleDeepLink(startDeepLink, /* applicationStarted= */ false);
    AOSPStarboardBridgeJni.get().setAndroidBuildFingerprint(getBuildFingerprint());
    AOSPStarboardBridgeJni.get().setAndroidOSExperience(mIsAmatiDevice);
    AOSPStarboardBridgeJni.get().setAndroidPlayServicesVersion(getPlayServicesVersion());
    AOSPStarboardBridgeJni.get().setYoutubeCertificationScope(getSystemProperty(YTS_CERT_SCOPE_SYSTEM_PROPERTY));
  }
  ...
  interface Natives {
    ...
    boolean initJNI(AOSPStarboardBridge starboardBridge);
  ...
  protected void onActivityDestroy(Activity activity) {
    ...
    if (mApplicationStopped) {
      ...
      AOSPStarboardBridgeJni.get().closeNativeStarboard(mNativeApp);
      mTtsHelper.shutdown();
  ...
  public static boolean isReleaseBuild() {
    return AOSPStarboardBridgeJni.get().isReleaseBuild();
  }

  /** Returns true if the native code is compiled for development (i.e. 'devel' build). */
  public static boolean isDevelopmentBuild() {
    return AOSPStarboardBridgeJni.get().isDevelopmentBuild();
  }
  ...
  public void initializePlatformAudioSink() {
    AOSPStarboardBridgeJni.get().initializePlatformAudioSink();
  }

  /** Sends an event to the web app to navigate to the given URL */
  public void handleDeepLink(String url) {
    AOSPStarboardBridgeJni.get().handleDeepLink(url, mApplicationStarted);
  }
  ...
  protected void measureAppStartTimestamp() {
    ...
    long cppTimestamp = AOSPStarboardBridgeJni.get().currentMonotonicTime();
