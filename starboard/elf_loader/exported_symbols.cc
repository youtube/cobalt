...
ExportedSymbols::ExportedSymbols() {
  ...
  REGISTER_WRAPPER(sigaddset);
  REGISTER_WRAPPER(sigdelset);
  REGISTER_WRAPPER(sigemptyset);
  REGISTER_WRAPPER(sigfillset);
  REGISTER_WRAPPER(sigismember);
  REGISTER_WRAPPER(sigprocmask);
