...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FORMATS_COMMON_OPUS_CONSTANTS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FORMATS_COMMON_OPUS_CONSTANTS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FORMATS_COMMON_OPUS_CONSTANTS_H_
