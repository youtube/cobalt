...
#include "third_party/chromium/media/cast/test/utility/in_process_receiver.h"
...
using media_m96::cast::CastTransportStatus;
using media_m96::cast::UdpTransportImpl;
...
void InProcessReceiver::TransportClient::OnStatusChanged(
  ...
  LOG_IF(ERROR, status == media_m96::cast::TRANSPORT_SOCKET_ERROR)
