...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_WIN_MEDIA_ENGINE_NOTIFY_IMPL_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_WIN_MEDIA_ENGINE_NOTIFY_IMPL_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_WIN_MEDIA_ENGINE_NOTIFY_IMPL_H_
