...
InterfaceData* CreateCachedInterfaceData() {
  ...
  instance_class->name = "MozjsEnumerationInterface";
  ...
  prototype_class->name = "MozjsEnumerationInterfacePrototype";
  ...
  interface_object_class->name = "MozjsEnumerationInterfaceConstructor";
