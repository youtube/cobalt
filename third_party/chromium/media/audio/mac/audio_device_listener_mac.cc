...
#include "third_party/chromium/media/audio/mac/audio_device_listener_mac.h"
...
#include "third_party/chromium/media/audio/mac/core_audio_util_mac.h"
...
AudioDeviceListenerMac::AudioDeviceListenerMac(
  ...
  if (monitor_addition_removal) {
    addition_removal_listener_ = std::make_unique<PropertyListener>(
        ...
        monitor_sources ? media_m96::base::BindPostTaskToCurrentDefault(base::BindRepeating(
