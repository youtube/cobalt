...
class AudioDecoderSelectorTestParam {
 public:
  ...
  static media_m96::DecoderPriority MockDecoderPriorityCB(
      const media_m96::AudioDecoderConfig& config,
      const media_m96::AudioDecoder& decoder) {
    ...
    return above_cutoff == decoder.IsPlatformDecoder()
               ? media_m96::DecoderPriority::kNormal
               : media_m96::DecoderPriority::kDeprioritized;
  }
  static media_m96::DecoderPriority NormalDecoderPriorityCB(
      const media_m96::AudioDecoderConfig& /*config*/,
      const media_m96::AudioDecoder& /*decoder*/) {
    return media_m96::DecoderPriority::kNormal;
  }
  static media_m96::DecoderPriority SkipDecoderPriorityCB(
      const media_m96::AudioDecoderConfig& /*config*/,
      const media_m96::AudioDecoder& /*decoder*/) {
    return media_m96::DecoderPriority::kSkipped;
  }
...
class VideoDecoderSelectorTestParam {
 public:
  ...
  static media_m96::DecoderPriority MockDecoderPriorityCB(
      const media_m96::VideoDecoderConfig& config,
      const media_m96::VideoDecoder& decoder) {
