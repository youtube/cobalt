...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_PIPELINE_CONTROLLER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_PIPELINE_CONTROLLER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FILTERS_PIPELINE_CONTROLLER_H_
