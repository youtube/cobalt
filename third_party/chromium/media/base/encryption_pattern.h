...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_ENCRYPTION_PATTERN_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_ENCRYPTION_PATTERN_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_ENCRYPTION_PATTERN_H_
