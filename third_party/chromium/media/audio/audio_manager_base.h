...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_MANAGER_BASE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_MANAGER_BASE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_AUDIO_MANAGER_BASE_H_
