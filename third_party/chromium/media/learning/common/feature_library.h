...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_COMMON_FEATURE_LIBRARY_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_COMMON_FEATURE_LIBRARY_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_COMMON_FEATURE_LIBRARY_H_
