...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_WIN_MEDIA_ENGINE_EXTENSION_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_WIN_MEDIA_ENGINE_EXTENSION_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_RENDERERS_WIN_MEDIA_ENGINE_EXTENSION_H_
