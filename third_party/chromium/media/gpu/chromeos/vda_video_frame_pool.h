...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_CHROMEOS_VDA_VIDEO_FRAME_POOL_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_CHROMEOS_VDA_VIDEO_FRAME_POOL_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_CHROMEOS_VDA_VIDEO_FRAME_POOL_H_
