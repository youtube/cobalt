...
#ifndef COBALT_NETWORK_CUSTOM_URL_FETCHER_CORE_H_
#define COBALT_NETWORK_CUSTOM_URL_FETCHER_CORE_H_
...
class URLFetcherCore : public base::RefCountedThreadSafe<URLFetcherCore>,
 ...
 public:
  URLFetcherCore(URLFetcher* fetcher, const GURL& original_url,
  ...
  void GetLoadTimingInfoInDelegateThread(
...
#endif  // COBALT_NETWORK_CUSTOM_URL_FETCHER_CORE_H_
