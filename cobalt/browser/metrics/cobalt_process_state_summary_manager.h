...
class CobaltProcessStateSummaryManager {
 public:
  ...
  // Queries Android OS for the prior session exit reason code.
  int GetPriorSessionExitReason();
  ...
  RecordLatestExitReasonAndGetPriorSessionSnapshot(const std::string& uma_name);
