...
InlineLevelReplacedBox::InlineLevelReplacedBox(
    ...
    : ReplacedBox(
          css_computed_style_declaration, replace_image_cb, set_bounds_cb,
          paragraph, text_position, maybe_intrinsic_width,
          maybe_intrinsic_height, maybe_intrinsic_ratio, used_style_provider,
          is_video_punched_out, is_lottie, content_size, layout_stat_tracker),
