...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_HALF_FLOAT_MAKER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_HALF_FLOAT_MAKER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_VIDEO_HALF_FLOAT_MAKER_H_
