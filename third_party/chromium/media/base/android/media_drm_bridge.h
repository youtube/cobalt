...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_MEDIA_DRM_BRIDGE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_MEDIA_DRM_BRIDGE_H_
...
class MEDIA_EXPORT MediaDrmBridge : public ContentDecryptionModule,
 ...
 public:
  ...
  void SetServerCertificate(
      ...
      std::unique_ptr<media_m96::SimpleCdmPromise> promise) override;
  void CreateSessionAndGenerateRequest(
      CdmSessionType session_type,
      media_m96::EmeInitDataType init_data_type,
      const std::vector<uint8_t>& init_data,
      std::unique_ptr<media_m96::NewSessionCdmPromise> promise) override;
  void LoadSession(
      CdmSessionType session_type,
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_ANDROID_MEDIA_DRM_BRIDGE_H_
