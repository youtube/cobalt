...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_ANDROID_OPENSLES_OUTPUT_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_ANDROID_OPENSLES_OUTPUT_H_
...
#include "third_party/chromium/media/audio/android/muteable_audio_output_stream.h"
#include "third_party/chromium/media/audio/android/opensles_util.h"
...
class OpenSLESOutputStream : public MuteableAudioOutputStream {
 ...
 private:
  ...
  media_m96::ScopedSLObjectItf engine_object_;
  media_m96::ScopedSLObjectItf player_object_;
  media_m96::ScopedSLObjectItf output_mixer_;
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_AUDIO_ANDROID_OPENSLES_OUTPUT_H_
