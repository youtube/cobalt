...
#include "third_party/chromium/media/filters/audio_video_metadata_extractor.h"
...
bool AudioVideoMetadataExtractor::Extract(DataSource* source,
  ...
  bool read_ok = true;
  media_m96::BlockingUrlProtocol protocol(source,
                                      base::BindRepeating(&OnError, &read_ok));
  media_m96::FFmpegGlue glue(&protocol);
