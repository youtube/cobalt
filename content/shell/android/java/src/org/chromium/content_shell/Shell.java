...
public class Shell extends LinearLayout {
    ...
    public Shell(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.chrobaltJavaScriptAndroidObject = new ChrobaltJavaScriptAndroidObject();
    }
    ...
    private void initFromNativeTabContents(WebContents webContents) {
        ...
        JavascriptInjector javascriptInjector = JavascriptInjector.fromWebContents(mWebContents, false);
