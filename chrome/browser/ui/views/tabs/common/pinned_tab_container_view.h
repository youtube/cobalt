...
#ifndef CHROME_BROWSER_UI_VIEWS_TABS_COMMON_PINNED_TAB_CONTAINER_VIEW_H_
#define CHROME_BROWSER_UI_VIEWS_TABS_COMMON_PINNED_TAB_CONTAINER_VIEW_H_
...
class PinnedTabContainerView
 ...
 public:
  ...
  PinnedTabContainerView(const PinnedTabContainerView&) = delete;
  PinnedTabContainerView& operator=(const PinnedTabContainerView&) = delete;
  ~PinnedTabContainerView() override;
