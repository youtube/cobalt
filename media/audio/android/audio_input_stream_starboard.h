...
#ifndef MEDIA_AUDIO_ANDROID_AUDIO_INPUT_STREAM_STARBOARD_H_
#define MEDIA_AUDIO_ANDROID_AUDIO_INPUT_STREAM_STARBOARD_H_
...
class AudioInputStreamStarboard : public AgcAudioStream<AudioInputStream> {
 ...
 private:
  ...
  base::TimeTicks last_capture_time_;  // Last capture time sent to callback.
...
#endif  // MEDIA_AUDIO_ANDROID_AUDIO_INPUT_STREAM_STARBOARD_H_
