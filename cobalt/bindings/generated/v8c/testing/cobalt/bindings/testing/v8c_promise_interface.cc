...
void InitializeTemplate(
  ...
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "onSuccess"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "returnBooleanPromise"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "returnInterfacePromise"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "returnStringPromise"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
  instance_template->Set(
    v8::String::NewFromUtf8(isolate, "returnVoidPromise"),
    v8::FunctionTemplate::New(isolate, DummyFunction)
  );
