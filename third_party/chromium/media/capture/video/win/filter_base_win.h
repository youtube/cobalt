...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_WIN_FILTER_BASE_WIN_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_WIN_FILTER_BASE_WIN_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAPTURE_VIDEO_WIN_FILTER_BASE_WIN_H_
