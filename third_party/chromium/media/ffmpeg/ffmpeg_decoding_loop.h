...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FFMPEG_FFMPEG_DECODING_LOOP_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FFMPEG_FFMPEG_DECODING_LOOP_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FFMPEG_FFMPEG_DECODING_LOOP_H_
