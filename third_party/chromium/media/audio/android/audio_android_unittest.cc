...
#include "third_party/chromium/media/audio/android/audio_manager_android.h"
...
#include "third_party/chromium/media/audio/mock_audio_source_callback.h"
#include "third_party/chromium/media/audio/test_audio_thread.h"
#include "third_party/chromium/media/base/decoder_buffer.h"
#include "third_party/chromium/media/base/seekable_buffer.h"
...
class FileAudioSink : public AudioInputStream::AudioInputCallback {
 public:
  explicit FileAudioSink(base::WaitableEvent* event,
    ...
    buffer_ = std::make_unique<media_m96::SeekableBuffer>(0, kMaxBufferSize);
 ...
 private:
  ...
  std::unique_ptr<media_m96::SeekableBuffer> buffer_;
  FILE* binary_file_;
};
...
class FullDuplexAudioSinkSource
 ...
 public:
  explicit FullDuplexAudioSinkSource(const AudioParameters& params)
    ...
    fifo_ = std::make_unique<media_m96::SeekableBuffer>(0, 2 * buffer_size);
 ...
 private:
  ...
  base::Lock lock_;
  std::unique_ptr<media_m96::SeekableBuffer> fifo_;
