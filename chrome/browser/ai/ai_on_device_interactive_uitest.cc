...
// Origin trial test tokens generated by
...
constexpr char kAIPromptAPIMultimodalInputOTToken[] =
    "A5rdsohSsc67RHa6LkV1vD5kczlVlaz/5okYY4MpcFSg5+Ip/mcLM/"
    "NYsiS2qyenpFwJ9g8Bs28G8k/"
    "l2NuA9w0AAABheyJvcmlnaW4iOiAiaHR0cHM6Ly9hLnRlc3Q6MzIxMjMiLCAiZmVhdHVyZSI6I"
    "CJBSVByb21wdEFQSU11bHRpbW9kYWxJbnB1dCIsICJleHBpcnkiOiAyMDI0MTcwNjcyfQ==";
constexpr char kAIProofreaderAPIOTToken[] =
    "A9PazZj3aC9GgJwZeSihxBYq1GguLymuBZwBaIJ9Yuv7UpOduOHvbli80DtMyZORkxog5FY1A0"
    "53xLH8voAcIQQAAABXeyJvcmlnaW4iOiAiaHR0cHM6Ly9hLnRlc3Q6MzIxMjMiLCAiZmVhdHVy"
    "ZSI6ICJBSVByb29mcmVhZGVyQVBJIiwgImV4cGlyeSI6IDIwMjQxNzQ0NDR9";
...
std::vector<std::string> GetAPINames() {
  return {"LanguageModel", "Rewriter", "Proofreader", "Summarizer", "Writer"};
}
 ...
 public:
  void SetUpCommandLine(base::CommandLine* command_line) override {
    if (IsAPIFlagEnabled(GetParam())) {
      command_line->AppendSwitchASCII(switches::kEnableBlinkFeatures,
                                      "AIPromptAPI,AIPromptAPIMultimodalInput,"
                                      "AIProofreadingAPI,AIRewriterAPI,"
  ...
  void SetUpOnMainThread() override {
    ...
    if (IsOTTokenSupplied(GetParam())) {
      ...
      InjectOTToken(tab, kAIPromptAPIMultimodalInputOTToken);
      InjectOTToken(tab, kAIProofreaderAPIOTToken);
    }
  }
  ...
  bool ExpectExposedToWorker(std::string_view name) const {
    ...
    // TODO(crbug.com/466389171): Add Proofreader worker support flag.
    return ExpectExposedToWindow(name) &&
           (IsAPIWorkerFlagEnabled(GetParam()) || name == "Proofreader");
  }
