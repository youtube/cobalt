...
fuchsia::media_m96::drm::LicenseInitData CreateLicenseInitData(
    EmeInitDataType type,
    const std::vector<uint8_t>& data) {
  fuchsia::media_m96::drm::LicenseInitData init_data;
  init_data.type = GetInitDataTypeName(type);
  init_data.data = data;
  return init_data;
}

fuchsia::media_m96::drm::LicenseServerMessage CreateLicenseServerMessage(
    const std::vector<uint8_t>& response) {
  fuchsia::media_m96::drm::LicenseServerMessage message;
...
fuchsia::media_m96::drm::LicenseSessionType ToFuchsiaLicenseSessionType(
    CdmSessionType session_type) {
  switch (session_type) {
    case CdmSessionType::kTemporary:
      return fuchsia::media_m96::drm::LicenseSessionType::TEMPORARY;
    case CdmSessionType::kPersistentLicense:
      return fuchsia::media_m96::drm::LicenseSessionType::PERSISTENT_LICENSE;
  }
}

CdmMessageType ToCdmMessageType(fuchsia::media_m96::drm::LicenseMessageType type) {
  switch (type) {
    case fuchsia::media_m96::drm::LicenseMessageType::REQUEST:
      return CdmMessageType::LICENSE_REQUEST;
    case fuchsia::media_m96::drm::LicenseMessageType::RENEWAL:
      return CdmMessageType::LICENSE_RENEWAL;
    case fuchsia::media_m96::drm::LicenseMessageType::RELEASE:
      return CdmMessageType::LICENSE_RELEASE;
  }
}

CdmKeyInformation::KeyStatus ToCdmKeyStatus(
    fuchsia::media_m96::drm::KeyStatus status) {
  switch (status) {
    case fuchsia::media_m96::drm::KeyStatus::USABLE:
      return CdmKeyInformation::USABLE;
    case fuchsia::media_m96::drm::KeyStatus::EXPIRED:
      return CdmKeyInformation::EXPIRED;
    case fuchsia::media_m96::drm::KeyStatus::RELEASED:
      return CdmKeyInformation::RELEASED;
    case fuchsia::media_m96::drm::KeyStatus::OUTPUT_RESTRICTED:
      return CdmKeyInformation::OUTPUT_RESTRICTED;
    case fuchsia::media_m96::drm::KeyStatus::OUTPUT_DOWNSCALED:
      return CdmKeyInformation::OUTPUT_DOWNSCALED;
    case fuchsia::media_m96::drm::KeyStatus::STATUS_PENDING:
      return CdmKeyInformation::KEY_STATUS_PENDING;
    case fuchsia::media_m96::drm::KeyStatus::INTERNAL_ERROR:
      return CdmKeyInformation::INTERNAL_ERROR;
  }
}

CdmPromise::Exception ToCdmPromiseException(fuchsia::media_m96::drm::Error error) {
  switch (error) {
    case fuchsia::media_m96::drm::Error::TYPE:
      return CdmPromise::Exception::TYPE_ERROR;
    case fuchsia::media_m96::drm::Error::NOT_SUPPORTED:
      return CdmPromise::Exception::NOT_SUPPORTED_ERROR;
    case fuchsia::media_m96::drm::Error::INVALID_STATE:
      return CdmPromise::Exception::INVALID_STATE_ERROR;
    case fuchsia::media_m96::drm::Error::QUOTA_EXCEEDED:
      return CdmPromise::Exception::QUOTA_EXCEEDED_ERROR;

    case fuchsia::media_m96::drm::Error::NOT_PROVISIONED:
      // FuchsiaCdmManager is supposed to provision CDM.
      NOTREACHED();
      return CdmPromise::Exception::INVALID_STATE_ERROR;

    case fuchsia::media_m96::drm::Error::INTERNAL:
...
class FuchsiaCdm::CdmSession {
 public:
  ...
  fidl::InterfaceRequest<fuchsia::media_m96::drm::LicenseSession> NewRequest() {
  ...
  void GenerateLicenseRequest(EmeInitDataType init_data_type,
    ...
    session_->GenerateLicenseRequest(
        ...
        [this](fuchsia::media_m96::drm::LicenseSession_GenerateLicenseRequest_Result
  ...
  void GenerateLicenseRelease(ResultCB generate_license_release_cb) {
    ...
    session_->GenerateLicenseRelease(
        [this](fuchsia::media_m96::drm::LicenseSession_GenerateLicenseRelease_Result
                   result) { ProcessResult(result); });
  }
  ...
  void ProcessLicenseResponse(const std::vector<uint8_t>& response,
    ...
    session_->ProcessLicenseResponse(
        ...
        [this](fuchsia::media_m96::drm::LicenseSession_ProcessLicenseResponse_Result
                   result) { ProcessResult(result); });
  }
 ...
 private:
  ...
  void OnLicenseMessageGenerated(fuchsia::media_m96::drm::LicenseMessage message) {
  ...
  void OnKeyStatesChanged(
      std::vector<fuchsia::media_m96::drm::KeyState> key_states) {
  ...
  fuchsia::media_m96::drm::LicenseSessionPtr session_;
...
FuchsiaCdm::FuchsiaCdm(fuchsia::media_m96::drm::ContentDecryptionModulePtr cdm,
                       ReadyCB ready_cb,
