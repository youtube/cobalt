...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_DEVICE_INFO_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_DEVICE_INFO_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_ANDROID_DEVICE_INFO_H_
