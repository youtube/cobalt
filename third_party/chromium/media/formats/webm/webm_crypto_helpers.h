...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FORMATS_WEBM_WEBM_CRYPTO_HELPERS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FORMATS_WEBM_WEBM_CRYPTO_HELPERS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FORMATS_WEBM_WEBM_CRYPTO_HELPERS_H_
