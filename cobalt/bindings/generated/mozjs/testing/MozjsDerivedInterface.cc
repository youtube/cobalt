...
InterfaceData* CreateCachedInterfaceData() {
  ...
  instance_class->name = "MozjsDerivedInterface";
  ...
  prototype_class->name = "MozjsDerivedInterfacePrototype";
  ...
  interface_object_class->name = "MozjsDerivedInterfaceConstructor";
...
// static
JSObject* MozjsDerivedInterface::CreateInstance(
