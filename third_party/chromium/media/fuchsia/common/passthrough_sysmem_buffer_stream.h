...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_COMMON_PASSTHROUGH_SYSMEM_BUFFER_STREAM_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_COMMON_PASSTHROUGH_SYSMEM_BUFFER_STREAM_H_

#include "third_party/chromium/media/fuchsia/common/sysmem_buffer_stream.h"
#include "third_party/chromium/media/fuchsia/common/sysmem_client.h"
#include "third_party/chromium/media/fuchsia/common/vmo_buffer_writer_queue.h"
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_FUCHSIA_COMMON_PASSTHROUGH_SYSMEM_BUFFER_STREAM_H_