...
#ifndef INTERNAL_STARBOARD_SHARED_UIKIT_KEYBOARD_INPUT_DEVICE_H_
#define INTERNAL_STARBOARD_SHARED_UIKIT_KEYBOARD_INPUT_DEVICE_H_
...
#endif  // INTERNAL_STARBOARD_SHARED_UIKIT_KEYBOARD_INPUT_DEVICE_H_
