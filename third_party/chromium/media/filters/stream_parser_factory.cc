...
#include "third_party/chromium/media/filters/stream_parser_factory.h"
...
#include "third_party/chromium/media/formats/mp4/mp4_stream_parser.h"
#include "third_party/chromium/media/formats/mpeg/adts_stream_parser.h"
#include "third_party/chromium/media/formats/mpeg/mpeg1_audio_stream_parser.h"
#include "third_party/chromium/media/formats/webcodecs/webcodecs_encoded_chunk_stream_parser.h"
#include "third_party/chromium/media/formats/webm/webm_stream_parser.h"
...
#include "third_party/chromium/media/formats/mp2t/mp2t_stream_parser.h"
#endif
#endif
...
static StreamParser* BuildMP2TParser(base::span<const std::string> codecs,
  ...
  return new media_m96::mp2t::Mp2tStreamParser(codecs, has_sbr);
}
  ...
  switch (codec_info->type) {
    ...
    case CodecInfo::VIDEO:
      ...
      if (codec_info->tag == CodecInfo::HISTOGRAM_H264 &&
          !media_m96::HasPlatformDecoderSupport()) {
        return false;
      }
#endif
...
std::unique_ptr<StreamParser> StreamParserFactory::Create(
  ...
  return std::make_unique<media_m96::WebCodecsEncodedChunkStreamParser>(
