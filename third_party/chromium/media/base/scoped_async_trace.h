...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_SCOPED_ASYNC_TRACE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_SCOPED_ASYNC_TRACE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_SCOPED_ASYNC_TRACE_H_
