...
TEST(VideoEncodeAcceleratorSupportedProfile, RoundTrip) {
  ::media_m96::VideoEncodeAccelerator::SupportedProfile input;
  ...
  input.scalability_modes.push_back(::media_m96::SVCScalabilityMode::kL1T3);
  input.scalability_modes.push_back(::media_m96::SVCScalabilityMode::kL3T3Key);

  ::media_m96::VideoEncodeAccelerator::SupportedProfile output;
...
TEST(VideoEncoderInfoStructTraitTest, RoundTrip) {
  ::media_m96::VideoEncoderInfo input;
  input.implementation_name = "FakeVideoEncodeAccelerator";
  // FPS allocation.
  for (size_t i = 0; i < ::media_m96::VideoEncoderInfo::kMaxSpatialLayers; ++i)
    input.fps_allocation[i] = {5, 5, 10};
  // Resolution bitrate limits.
  input.resolution_bitrate_limits.push_back(::media_m96::ResolutionBitrateLimit(
  ...
  ::media_m96::VideoEncoderInfo output = input;
...
TEST(SpatialLayerStructTraitTest, RoundTrip) {
  ::media_m96::VideoEncodeAccelerator::Config::SpatialLayer input_spatial_layer;
  ...
  ::media_m96::VideoEncodeAccelerator::Config::SpatialLayer output_spatial_layer;
...
TEST(VideoEncodeAcceleratorConfigStructTraitTest, RoundTrip) {
  ...
  constexpr ::media_m96::Bitrate kBitrate =
      ::media_m96::Bitrate::ConstantBitrate(kBaseBitrateBps);

  ::media_m96::VideoEncodeAccelerator::Config input_config(
      ::media_m96::PIXEL_FORMAT_NV12, kBaseSize, ::media_m96::VP9PROFILE_PROFILE0,
      ...
      ::media_m96::VideoEncodeAccelerator::Config::ContentType::kCamera,
      input_spatial_layers,
      ::media_m96::VideoEncodeAccelerator::Config::InterLayerPredMode::kOnKeyPic);

  ::media_m96::VideoEncodeAccelerator::Config output_config{};
  ASSERT_TRUE(
...
TEST(VideoEncodeAcceleratorConfigStructTraitTest, RoundTripVariableBitrate) {
  ...
  constexpr ::media_m96::Bitrate kBitrate =
      ::media_m96::Bitrate::VariableBitrate(kBaseBitrateBps, kMaximumBitrate);
  ::media_m96::VideoEncodeAccelerator::Config input_config(
      ::media_m96::PIXEL_FORMAT_NV12, kBaseSize, ::media_m96::VP9PROFILE_PROFILE0,
      kBitrate);
...
TEST(BitstreamBufferMetadataTraitTest, RoundTrip) {
  ...
  output_metadata = ::media_m96::BitstreamBufferMetadata();
  ASSERT_TRUE(
      mojo::test::SerializeAndDeserialize<mojom::BitstreamBufferMetadata>(
          input_metadata, output_metadata));
  EXPECT_EQ(input_metadata, output_metadata);
