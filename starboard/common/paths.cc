...
std::string GetCACertificatesPath() {
  ...
  std::string ca_certificates_path(buffer.data());
  ca_certificates_path.append(std::string(kSbFileSepString) + "app" +
  ...
  if (!SbFileExists(ca_certificates_path.c_str())) {
    ca_certificates_path = buffer.data();
    ca_certificates_path.append(std::string(kSbFileSepString) + "ssl" +
                                kSbFileSepString + "certs");
  }
