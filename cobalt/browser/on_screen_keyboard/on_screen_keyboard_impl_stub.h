...
#ifndef COBALT_BROWSER_ON_SCREEN_KEYBOARD_ON_SCREEN_KEYBOARD_IMPL_STUB_H_
#define COBALT_BROWSER_ON_SCREEN_KEYBOARD_ON_SCREEN_KEYBOARD_IMPL_STUB_H_

#include "cobalt/browser/on_screen_keyboard/on_screen_keyboard_impl_base.h"

namespace on_screen_keyboard {

class OnScreenKeyboardImplStub final : public OnScreenKeyboardImpl {
 private:
...
#endif  // COBALT_BROWSER_ON_SCREEN_KEYBOARD_ON_SCREEN_KEYBOARD_IMPL_STUB_H_
