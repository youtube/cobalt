...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_GPU_TEST_VIDEO_PLAYER_TEST_VDA_VIDEO_DECODER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_GPU_TEST_VIDEO_PLAYER_TEST_VDA_VIDEO_DECODER_H_
...
// The test VDA video decoder translates between the media_m96::VideoDecoder and the
// media_m96::VideoDecodeAccelerator interfaces. This makes it possible to run
// VD-based tests against VDA's.
class TestVDAVideoDecoder : public media_m96::VideoDecoder,
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_GPU_TEST_VIDEO_PLAYER_TEST_VDA_VIDEO_DECODER_H_
