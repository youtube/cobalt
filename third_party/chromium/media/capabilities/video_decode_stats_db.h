...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAPABILITIES_VIDEO_DECODE_STATS_DB_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAPABILITIES_VIDEO_DECODE_STATS_DB_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAPABILITIES_VIDEO_DECODE_STATS_DB_H_
