...
#include "third_party/chromium/media/fuchsia/audio/fuchsia_audio_capturer_source.h"
...
class TestAudioCapturer final
    : public fuchsia::media_m96::testing::AudioCapturer_TestBase {
 public:
  TestAudioCapturer(
      fidl::InterfaceRequest<fuchsia::media_m96::AudioCapturer> request)
  ...
  void SendData(base::TimeTicks timestamp, void* data) {
    ...
    // Send the new packet.
    fuchsia::media_m96::StreamPacket packet;
  ...
  // fuchsia::media_m96::AudioCapturer implementation.
  void SetPcmStreamType(fuchsia::media_m96::AudioStreamType stream_type) override {
    ASSERT_FALSE(stream_type_.has_value());
    ASSERT_EQ(stream_type.sample_format,
              fuchsia::media_m96::AudioSampleFormat::FLOAT);
  ...
  void ReleasePacket(fuchsia::media_m96::StreamPacket packet) override {
 ...
 private:
  fidl::Binding<fuchsia::media_m96::AudioCapturer> binding_;

  zx::vmo buffer_vmo_;
  uint64_t buffer_size_ = 0;
  absl::optional<fuchsia::media_m96::AudioStreamType> stream_type_;
...
class FuchsiaAudioCapturerSourceTest : public testing::Test {
 public:
  FuchsiaAudioCapturerSourceTest() {
    fidl::InterfaceHandle<fuchsia::media_m96::AudioCapturer> capturer_handle;
    test_capturer_ =
