...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CAST_TEST_RECEIVER_AUDIO_DECODER_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CAST_TEST_RECEIVER_AUDIO_DECODER_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CAST_TEST_RECEIVER_AUDIO_DECODER_H_
