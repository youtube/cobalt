...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_LOCALIZED_STRINGS_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_LOCALIZED_STRINGS_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_LOCALIZED_STRINGS_H_
