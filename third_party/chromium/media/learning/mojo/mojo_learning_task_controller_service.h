...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_MOJO_MOJO_LEARNING_TASK_CONTROLLER_SERVICE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_MOJO_MOJO_LEARNING_TASK_CONTROLLER_SERVICE_H_
...
#include "third_party/chromium/media/learning/mojo/public/mojom/learning_task_controller.mojom.h"
...
class COMPONENT_EXPORT(MEDIA_LEARNING_MOJO) MojoLearningTaskControllerService
 ...
 public:
  ...
  explicit MojoLearningTaskControllerService(
      ...
      std::unique_ptr<::media_m96::learning::LearningTaskController> impl);
 ...
 protected:
  ...
  std::unique_ptr<::media_m96::learning::LearningTaskController> impl_;
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_LEARNING_MOJO_MOJO_LEARNING_TASK_CONTROLLER_SERVICE_H_
