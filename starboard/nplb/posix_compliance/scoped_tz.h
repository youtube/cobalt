...
#ifndef STARBOARD_NPLB_POSIX_COMPLIANCE_SCOPED_TZ_H_
#define STARBOARD_NPLB_POSIX_COMPLIANCE_SCOPED_TZ_H_
...
#endif  // STARBOARD_NPLB_POSIX_COMPLIANCE_SCOPED_TZ_H_
