...
#if BUILDFLAG(IS_NATIVE_TARGET_BUILD)
// TODO: b/406511608 - this function definition is copied directly from c25, but
// we should refactor it to share code with the zero parameter definition of
// ProcessSnapshotLinux::InitializeModules().
void ProcessSnapshotLinux::InitializeModules(
    VMAddress evergreen_information_address) {
  for (const ProcessReaderLinux::Module& reader_module :
       process_reader_.Modules()) {
