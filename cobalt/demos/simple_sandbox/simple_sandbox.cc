...
void SimpleSandbox::StartApplication(int argc,
  ...
  SimpleSandbox::GetInstance()->thread()->task_runner()->PostDelayedTask(
      FROM_HERE,
      base::BindOnce(
          [](base::SequencedTaskRunner* main_loop,
            ...
            // Stop after seconds.
            main_loop->PostDelayedTask(FROM_HERE, quit_closure,
                                       base::TimeDelta::FromSeconds(2));
          },
          base::SequencedTaskRunner::GetCurrentDefault(), quit_closure),
