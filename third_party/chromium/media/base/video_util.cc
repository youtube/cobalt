...
VideoPixelFormat ReadbackFormat(const media_m96::VideoFrame& frame) {
  switch (frame.format()) {
...
SkColorType SkColorTypeForPlane(VideoPixelFormat format, size_t plane) {
  switch (format) {
    ...
    case PIXEL_FORMAT_NV12:
      return plane == media_m96::VideoFrame::kYPlane ? kAlpha_8_SkColorType
...
VideoPixelFormatFromSkColorType(SkColorType sk_color_type, bool is_opaque) {
  switch (sk_color_type) {
    case kRGBA_8888_SkColorType:
      return is_opaque ? media_m96::PIXEL_FORMAT_XBGR : media_m96::PIXEL_FORMAT_ABGR;
    case kBGRA_8888_SkColorType:
      return is_opaque ? media_m96::PIXEL_FORMAT_XRGB : media_m96::PIXEL_FORMAT_ARGB;
    default:
