...
#include "third_party/chromium/media/gpu/v4l2/v4l2_image_processor_backend.h"
#include "third_party/chromium/media/gpu/v4l2/v4l2_stateful_workaround.h"
#include "third_party/chromium/media/gpu/v4l2/v4l2_utils.h"
#include "third_party/chromium/media/gpu/v4l2/v4l2_vda_helpers.h"
...
void V4L2VideoDecodeAccelerator::InitializeTask(const Config& config,
  ...
  *result = config_result;
  ...
  base::trace_event::MemoryDumpManager::GetInstance()->RegisterDumpProvider(
      this, "media_m96::V4l2VideoDecodeAccelerator", decoder_thread_.task_runner());
...
V4L2VideoDecodeAccelerator::GetSupportedProfiles() {
  ...
  return device->GetSupportedDecodeProfiles(
      std::size(supported_input_fourccs_), supported_input_fourccs_);
}
