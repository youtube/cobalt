...
SbPlayer SbPlayerCreate(SbWindow window,
  ...
  SbMediaVideoCodec video_codec = creation_param->video_stream_info.codec;
  SbMediaAudioCodec audio_codec = creation_param->audio_stream_info.codec;
  ...
  if (video_codec == kSbMediaVideoCodecNone) {
    SB_LOG(INFO) << "Audio only playback.";
  }
  ...
  //     (video_codec != kSbMediaVideoCodecNone && (video_codec !=
