...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_CDM_CDM_MODULE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_CDM_CDM_MODULE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_CDM_CDM_MODULE_H_
