...
#include "third_party/chromium/media/gpu/vaapi/test/av1_decoder.h"
#include "third_party/chromium/media/gpu/vaapi/test/shared_va_surface.h"
#include "third_party/chromium/media/gpu/vaapi/test/vaapi_device.h"
#include "third_party/chromium/media/gpu/vaapi/test/video_decoder.h"
#include "third_party/chromium/media/gpu/vaapi/test/vp9_decoder.h"
#include "third_party/chromium/media/gpu/vaapi/va_stubs.h"
#include "third_party/abseil-cpp/absl/types/optional.h"
#include "ui/gfx/geometry/size.h"

using media_m96::vaapi_test::Av1Decoder;
using media_m96::vaapi_test::SharedVASurface;
using media_m96::vaapi_test::VaapiDevice;
using media_m96::vaapi_test::VideoDecoder;
using media_m96::vaapi_test::Vp9Decoder;
...
std::unique_ptr<VideoDecoder> CreateDecoder(
    ...
    size_t stream_len) {
  // Set up video parser.
  auto ivf_parser = std::make_unique<media_m96::IvfParser>();
  media_m96::IvfFileHeader file_header{};
