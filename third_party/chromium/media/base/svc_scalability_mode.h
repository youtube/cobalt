...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_SVC_SCALABILITY_MODE_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_SVC_SCALABILITY_MODE_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_SVC_SCALABILITY_MODE_H_
