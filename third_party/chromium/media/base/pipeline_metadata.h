...
#ifndef THIRD_PARTY_CHROMIUM_MEDIA_BASE_PIPELINE_METADATA_H_
#define THIRD_PARTY_CHROMIUM_MEDIA_BASE_PIPELINE_METADATA_H_
...
#endif  // THIRD_PARTY_CHROMIUM_MEDIA_BASE_PIPELINE_METADATA_H_
